...
export const appRoutes: Route[] = [
  {
    ...
    loadChildren: () =>
      loadRemoteModule({
        remoteEntry: `${ENVIRONMENT.WEB_HOST}:4201/remoteAppEntry.js`,
        remoteName: 'login',
  ...
  },
  {
    ...
    loadChildren: () =>
      loadRemoteModule({
        remoteEntry: `${ENVIRONMENT.WEB_HOST}:4202/remoteAppEntry.js`,
        remoteName: 'aga',
        exposedModule: './Module'
  ...
  },
  {
    ...
    loadChildren: () =>
      ...
      loadRemoteModule({
        remoteEntry: `${ENVIRONMENT.WEB_HOST}:4209/remoteAppEntry.js`,
        remoteName: 'agace',
        exposedModule: './Module'
  ...
  },
  {
    ...
    loadChildren: () =>
      loadRemoteModule({
        remoteEntry: `${ENVIRONMENT.WEB_HOST}:4204/remoteAppEntry.js`,
  ...
  },
  {
    ...
    loadChildren: () =>
      loadRemoteModule({
        remoteEntry: `${ENVIRONMENT.WEB_HOST}:4205/remoteAppEntry.js`,
        remoteName: 'se',
        exposedModule: './Module'
  ...
  },
  {
    ...
    loadChildren: () =>
      loadRemoteModule({
        remoteEntry: `${ENVIRONMENT.WEB_HOST}:4206/remoteAppEntry.js`,
        remoteName: 'semarnat',
        exposedModule: './Module'
  ...
  },
  {
    ...
    loadChildren: () =>
        loadRemoteModule({
            remoteEntry: `${ENVIRONMENT.WEB_HOST}:4217/remoteAppEntry.js`,
            remoteName: 'sener',
            exposedModule: './Module'
  ...
  },
  {
    ...
    loadChildren: () =>
        loadRemoteModule({
            remoteEntry: `${ENVIRONMENT.WEB_HOST}:4210/remoteAppEntry.js`,
  ...
  },
  {
    ...
    loadChildren: () =>
      loadRemoteModule({
        remoteEntry: `${ENVIRONMENT.WEB_HOST}:4211/remoteAppEntry.js`,
        remoteName: 'cofepris',
        exposedModule: './Module'
  ...
  loadChildren: () =>
      loadRemoteModule({
          remoteEntry: `${ENVIRONMENT.WEB_HOST}:4212/remoteAppEntry.js`,
          remoteName: 'amecafe',
          exposedModule: './Module'
  ...
  } ,
  {
    ...
    loadChildren: () =>
        loadRemoteModule({
            remoteEntry: `${ENVIRONMENT.WEB_HOST}:4219/remoteAppEntry.js`,
            remoteName: 'sedena',
            exposedModule: './Module'
