...
describe('PasoUnoComponent (Jest)', () => {
  ...
  let solicitudServiceMock: Partial<jest.Mocked<Solocitud130204Service>>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        ...
        { provide: Solocitud130204Service, useValue: solicitudServiceMock },
        ExportacionHidrocarburosService,
      ],
  ...
  it('should call actualizarEstadoFormulario and set esDatosRespuesta', () => {
    component['solocitud130204Service'] = solicitudServiceMock as unknown as Solocitud130204Service;
