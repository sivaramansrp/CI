...
import { Solocitud130204Service } from '../../services/service130204.service';
/**
 ...
 */
   ...
   *
   * @param {PermisoDeHidrocarburosService} exportacionHidrocarburosSvc Servicio para operaciones de permisos de hidrocarburos.
   * @param {Solocitud130204Service} solocitud130204Service Servicio para manipulación de datos del trámite 130204.
   * @param {ConsultaioQuery} consultaQuery Servicio para consultar el estado de la solicitud desde el store.
   * @memberof PasoUnoComponent
   */
    constructor(
      public exportacionHidrocarburosSvc: ExportacionHidrocarburosService,
      private solocitud130204Service: Solocitud130204Service,
    ...
    guardarDatosFormulario(): void {
      this.solocitud130204Service
        ...
        .subscribe((resp) => {
          if (resp) {
            this.esDatosRespuesta = true;
            this.solocitud130204Service.actualizarEstadoFormulario(resp);
          }
        });
    }
