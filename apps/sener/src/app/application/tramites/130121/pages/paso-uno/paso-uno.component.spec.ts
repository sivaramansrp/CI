...
describe('PasoUnoComponent (Jest)', () => {
  ...
  let solicitudServiceMock: Partial<jest.Mocked<Solocitud130121Service>>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        ...
        { provide: Solocitud130121Service, useValue: solicitudServiceMock },
  ...
  it('should call actualizarEstadoFormulario and set esDatosRespuesta', () => {
    component['solocitud130121Service'] = solicitudServiceMock as unknown as Solocitud130121Service;
