...
export class PasoUnoComponent implements OnInit, OnDestroy {
   ...
   * @param {solocitud130201Service} solocitud130201Service Servicio para manipulación de datos del trámite 130121.
   * @param {ConsultaioQuery} consultaQuery Servicio para consultar el estado de la solicitud desde el store.
   * @memberof PasoUnoComponent
   */
    constructor(
      public ExportacionPetroliferosServiceSvc: ExportacionPetroliferosService,
      private solocitud130201Service: Solocitud130201Service,
      ...
      guardarDatosFormulario(): void {
        this.solocitud130201Service
          ...
          .subscribe((resp) => {
            if (resp) {
              this.esDatosRespuesta = true;
              this.solocitud130201Service.actualizarEstadoFormulario(resp);
            }
          });
      }
