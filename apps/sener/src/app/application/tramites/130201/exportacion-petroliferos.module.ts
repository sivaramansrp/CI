...
import { ExportacionPetroliferosRoutingModule } from './exportacion-petroliferos.routing.module';
...
@NgModule({
  declarations: [
    ExportacionPetroliferosComponent,
    PasoUnoComponent,
    SolicitudComponent,
  ...
  imports: [
    ...
    TituloComponent,
    ExportacionPetroliferosRoutingModule,
    WizardComponent,
...
export class ExportacionPetroliferosModule { }
