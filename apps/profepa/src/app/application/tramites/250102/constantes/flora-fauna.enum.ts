...
export const FLORA_FAUNA_ALERT =
  'La solicitud ha quedado registrada con el número temporal 202772663. Éste no tiene validez legal y sirve solamente paraefectos de identificar tu solicitud. Un folio oficial le será asignado a la solicitud al momento en que ésta sea firmada.';