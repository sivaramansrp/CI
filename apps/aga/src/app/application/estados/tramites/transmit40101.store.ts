 ...
 */
export interface Solicitud40101State {
...
export function createInitialState(): Solicitud40101State {
  return {
    regimenMercancia: '',
    clasifiRegimen: '',
    valueTA: '',
...
export class Tramite40101Store extends Store<Solicitud40101State> {
  constructor() {
