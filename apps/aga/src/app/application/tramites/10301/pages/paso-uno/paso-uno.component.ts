...
import {
  DOMICILIO_FISCAL_PERSONA_MORAL_O_FISICA_NACIONAL,PERSONA_MORAL_NACIONAL
} from 'c:/VUCEM_MF/frontend/libs/shared/data-access-user/src/tramites/constantes/solicitante-constantes.enum';
