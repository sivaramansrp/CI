...
export class AvisoUnicoService {
  ...
  obtenerDatosLocalidad(): Observable<unknown> {
    return this.http.get('assets/json/31202/aviso.json').pipe(
  ...
  getSolicitante(): Observable<AvisoValor> {
    return this.http.get<AvisoValor>('assets/json/31202/renovacion.json');
    }
 ...
 /**
  ...
  obtenerRadio(): Observable<PreOperativo[]> {
    return this.http.get<PreOperativo[]>('assets/json/31202/tipoPersonaradio.json');
  }
  ...
  getDatosConsulta(): Observable<RespuestaConsulta> {
    return this.http.get<RespuestaConsulta>('assets/json/31202/consulta_31202.json');
  }
}