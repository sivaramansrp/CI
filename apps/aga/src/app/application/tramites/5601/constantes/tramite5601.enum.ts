...
export const MERCANCIA_DETALLES = [
  ...
  },
  {
    ...
    desactivado: false,
    soloLectura: false,
    validadores: [{ tipo: 'maxlength', valor: 500, mensaje: 'Por favor, no escriba más de 500 caracteres.' }],
    marcadorDePosicion: '',
    valorPredeterminado: '',
    marginTop: 0,
    mostrar: true
  ...
  export const UBICACION_MERCANCIA = [
    {
      ...
      desactivado: false,
      soloLectura: false,
      validadores: [{ tipo: 'required' }, { tipo: 'maxlength', valor: 822, mensaje: 'Por favor, no escriba más de 822 caracteres.' }],
      marcadorDePosicion: '',
      valorPredeterminado: '',
      marginTop: 0,
      habilitado: true
    },
    {
      ...
      desactivado: false,
      soloLectura: false,
      validadores: [{ tipo: 'required' }, { tipo: 'maxlength', valor: 30, mensaje: 'Por favor, no escriba más de 30 caracteres.' }],
      marcadorDePosicion: '',
      valorPredeterminado: '',
      marginTop: 0,
      habilitado: true
    },
    {
      ...
      desactivado: false,
      soloLectura: false,
      validadores: [{ tipo: 'required' }, { tipo: 'maxlength', valor: 40, mensaje: 'Por favor, no escriba más de 40 caracteres.' }],
      marcadorDePosicion: '',
      valorPredeterminado: '',
      marginTop: 0,
      habilitado: true
    },
    {
      ...
      desactivado: false,
      soloLectura: false,
      validadores: [{ tipo: 'required' }, { tipo: 'maxlength', valor: 500, mensaje: 'Por favor, no escriba más de 500 caracteres.' }],
      marcadorDePosicion: '',
      valorPredeterminado: '',
      marginTop: 0,
      habilitado: true
