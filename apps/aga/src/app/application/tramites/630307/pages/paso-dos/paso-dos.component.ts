...
export class PasoDosComponent implements OnInit, OnDestroy {
   ...
   * @param RetornoImportacionTemporalService Servicio para gestionar las operaciones relacionadas con prestadores de servicio.
   */
  constructor(
  ...
  obtenerDocumentosSeleccionados(): void {
    this.retornoImportacionTemporalService.obtenerDocumentosSeleccionados()
      .pipe(takeUntil(this.destruirNotificador$))
      .subscribe({
        next: (result) => {
