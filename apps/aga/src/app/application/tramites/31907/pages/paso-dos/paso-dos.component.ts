...
import { CadenaOriginal31907Service } from '../../services/cadenaOriginal.service';
...
import { Firma31907Service } from '../../services/firma.service';
...
export class PasoDosComponent implements OnInit, OnDestroy {
  ...
  public estadoSolicitud!: EstadoSolicitud31907;
  folio!: string;
  ...
  constructor(
    ...
    private tramiteQuery: Tramite31907Query,
    private cadenaService: CadenaOriginal31907Service,
    private firmaService: Firma31907Service
  ) {
