...
export const AGENTES_TABLA_DATOS = [
    {
      encabezado: 'Nombre(s)',
      clave: (item: AgentesTabla):string => item.nombres ,
      orden: 1,
    },
    {
    ...
    },
    {
      ...
      clave: (item: AgentesTabla):string => item.numeroPatente,
      orden: 4,
    },
  ];
...
export const REGISTRO_VEHICULOS = [
    ...
    },
    {
      ...
      clave: (item: RegistroVehiculos):string => item.direccionVehiculo.calleVehiculo,
      orden: 5,
    },
    {
      encabezado: 'Número Exterior',
      clave: (item: RegistroVehiculos):string => item.direccionVehiculo.numExteriorVehiculo,
      orden: 6,
    },
    {
      encabezado: 'Número Interior',
      clave: (item: RegistroVehiculos):string => item.direccionVehiculo.numInteriorVehiculo,
      orden: 7,
    },
    {
      encabezado: 'Entidad Vehículo',
      clave: (item: RegistroVehiculos):string => item.direccionVehiculo.comboEntidadVehiculo,
      orden: 8,
    },
    {
      encabezado: 'Delegación Vehículo',
      clave: (item: RegistroVehiculos):string => item.direccionVehiculo.comboDelegacionVehiculo,
      orden: 9,
    },
    {
      encabezado: 'Colonia Vehículo',
      clave: (item: RegistroVehiculos):string => item.direccionVehiculo.comboColoniaVehiculo,
      orden: 10,
    },
    {
      encabezado: 'Localidad Vehículo',
      clave: (item: RegistroVehiculos):string => item.direccionVehiculo.localidadVehiculo,
      orden: 11,
    },
    {
      encabezado: 'Código Postal Vehículo',
      clave: (item: RegistroVehiculos):string => item.direccionVehiculo.codigoPostalVehiculo,
      orden: 12,
    },
    {
      encabezado: 'Aduana Vehículo',
      clave: (item: RegistroVehiculos):string => item.direccionVehiculo.comboAduanaVehiculo,
      orden: 13,
    },
    {
      encabezado: 'Nombre',
