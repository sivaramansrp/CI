...
export class UnicoStore extends Store<UnicoState> {
  ...
  /**
   * @method
   * @name setmapTipoTramite
   * @description
   * Actualiza el campo `mapTipoTramite` en el estado.
   * @param {string} mapTipoTramite Nueva modalidad.
   */
  ...
  /**
   * @method
   * @name setmapDeclaracionSolicitud
   * @description
   * Actualiza el campo `mapDeclaracionSolicitud` en el estado.
   * @param {string} mapDeclaracionSolicitud Nueva protesta de verdad.
   */
