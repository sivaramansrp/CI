import { AlertComponent, AnexarDocumentosComponent, BtnContinuarComponent, ConsultaioState, DatosPasos, ListaPasosWizard, PASOS, TituloComponent, WizardComponent } from '@ng-mf/data-access-user';
