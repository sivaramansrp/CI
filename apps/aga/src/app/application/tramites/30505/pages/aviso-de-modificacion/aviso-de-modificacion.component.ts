...
/**
 * @description
 * Representa la estructura de una acción de botón con su nombre y valor asociado.
 *
 * @interface
 * @author
 * @since 1.0.0
 *
 * @property {string} accion - Nombre o identificador de la acción del botón.
 * @property {number} valor - Valor numérico asociado a la acción.
 */
