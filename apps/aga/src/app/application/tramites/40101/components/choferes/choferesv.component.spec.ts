...
describe('ChoferesComponent', () => {
  ...
  it('should run #ngOnInit()', async () => {
    ...
    component.chofer40101Query.getchoferesextranjero$ =
  ...
  it('should run #extranjeroGuardars()', async () => {
    ...
    component.chofer40101Store = component.chofer40101Store || {};
    component.chofer40101Store.update = jest.fn().mockReturnValue([
      {
        pagoDerechosLista: {},
      },
    ]);
    component.chofer40101Store.getValue = jest.fn();
  ...
  it('should run #fetchChoferes()', async () => {
    component.chofer40101Service = component.chofer40101Service || {};
    component.chofer40101Service.getChoferNacionalData = jest
      .fn()
      .mockReturnValue(observableOf({}));
  ...
  it('should run #loadMunicipios()', async () => {
    component.chofer40101Service = component.chofer40101Service || {};
    component.chofer40101Service.getMunicipios = jest
      .fn()
      .mockReturnValue(observableOf({}));
  ...
  it('should run #loadColonias()', async () => {
    component.chofer40101Service = component.chofer40101Service || {};
    component.chofer40101Service.getColonias = jest
      .fn()
      .mockReturnValue(observableOf({}));
  ...
  it('should run #paisEmisorData()', async () => {
    component.chofer40101Service = component.chofer40101Service || {};
    component.chofer40101Service.getPaisOrigenChn = jest
      .fn()
      .mockReturnValue(observableOf({}));
  ...
  it('should run #delegacionChnData()', async () => {
    component.chofer40101Service = component.chofer40101Service || {};
    component.chofer40101Service.getDelegacionChn = jest
      .fn()
      .mockReturnValue(observableOf({}));
  ...
  it('should run #coloniaChnData()', async () => {
    component.chofer40101Service = component.chofer40101Service || {};
    component.chofer40101Service.getColoniaChn = jest
      .fn()
      .mockReturnValue(observableOf({}));
  ...
  it('should run #nacionaliDadChe()', async () => {
    component.chofer40101Service = component.chofer40101Service || {};
    component.chofer40101Service.getNacionaliDadChe = jest
      .fn()
      .mockReturnValue(observableOf({}));
