...
import { Chofer40103Service } from './chofer40103.service';
...
describe('Chofer40103Service', () => {
  let service: Chofer40103Service;
  let httpMock: HttpTestingController;
  let storeMock: jest.Mocked<Chofer40103Store>;
  ...
  beforeEach(() => {
    ...
    storeMock = {
      update: jest.fn()
    } as unknown as jest.Mocked<Chofer40103Store>;

    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule],
      providers: [
        Chofer40103Service,
        { provide: Chofer40103Store, useValue: storeMock }
      ]
    });

    service = TestBed.inject(Chofer40103Service);
  ...
  describe('Constructor', () => {
    it('should initialize with data from localStorage', () => {
      ...
      const newService = new Chofer40103Service(storeMock, TestBed.inject(HttpClient));
    ...
    it('should handle malformed JSON in localStorage', () => {
      ...
      expect(() => {
        new Chofer40103Service(storeMock, TestBed.inject(HttpClient));
      }).toThrow();
    });
  });
  ...
  describe('HTTP GET Methods', () => {
    ...
    it('should get pais emisor', () => {
      ...
      const req = httpMock.expectOne('/assets/json/40103/pais-catalogo.json');
      expect(req.request.method).toBe('GET');
      req.flush(mockCatalogo);
    });
    ...
    it('should get color AGA', () => {
      ...
      const req = httpMock.expectOne('/assets/json/40103/color-catalogo.json');
      expect(req.request.method).toBe('GET');
      req.flush(mockCatalogo);
    });
    ...
    it('should get pais origen CHN', () => {
      ...
      const req = httpMock.expectOne('/assets/json/40103/pais-origen.json');
      expect(req.request.method).toBe('GET');
      req.flush(mockCatalogo);
    });
    ...
    it('should get delegacion CHN', () => {
      ...
      const req = httpMock.expectOne('/assets/json/40103/municipio.json');
      expect(req.request.method).toBe('GET');
      req.flush(mockCatalogo);
    });
    ...
    it('should get estado', () => {
      ...
      const req = httpMock.expectOne('/assets/json/40103/estado.json');
      expect(req.request.method).toBe('GET');
      req.flush(mockCatalogo);
    });
    ...
    it('should get colonias por municipio', () => {
      ...
      const req = httpMock.expectOne('/assets/json/40103/colonia.json');
      expect(req.request.method).toBe('GET');
      req.flush(mockCatalogo);
    });
    ...
    it('should get nacionalidad CHE', () => {
      ...
      const req = httpMock.expectOne('/assets/json/40103/nacionalidad.json');
      expect(req.request.method).toBe('GET');
      req.flush(mockCatalogo);
    });
    ...
    it('should get chofer data', () => {
      ...
      const req = httpMock.expectOne('/assets/json/40103/chofer.json');
      expect(req.request.method).toBe('GET');
      req.flush(mockCatalogo);
    });
    ...
    it('should get director general data', () => {
      ...
      const req = httpMock.expectOne('../../../../../assets/json/40103/director-general-mockdata.json');
      expect(req.request.method).toBe('GET');
    ...
    it('should get tabla datos with generic type', () => {
      ...
      const req = httpMock.expectOne(`../../../../../assets/json/40103/${fileName}`);
      expect(req.request.method).toBe('GET');
  ...
  describe('URL Construction', () => {
    ...
    it('should construct correct URLs for asset JSON files', () => {
      service.getPaisEmisor().subscribe();
      const req = httpMock.expectOne('/assets/json/40103/pais-catalogo.json');
      expect(req.request.url).toBe('/assets/json/40103/pais-catalogo.json');
      req.flush([]);
    });
  ...
  describe('Data Types and Generics', () => {
    it('should handle generic types in obtenerTablaDatos', () => {
      ...
      const req = httpMock.expectOne('../../../../../assets/json/40103/custom-data.json');
  ...
  describe('State Management', () => {
    it('should maintain separate state for different chofer types', () => {
      // Test that different update methods affect different state properties
      service.updateDatosDelChoferNacional(mockChoferNacionalData);
      service.updateDatosDelChoferExtranjero(mockChoferExtranjeroData);
