...
describe('modificarTerrestreService', () => {
  ...
  describe('obtenerTipoDeVehiculo', () => {
    it('should return observable with CatalogoLista data', () => {
      ...
      expect(req.request.url).toBe('assets/json/40103/tipo-vehiculo-arrastre.json');
    ...
    it('should handle multiple consecutive calls', () => {
      ...
      const requests = httpMock.match('assets/json/40103/tipo-vehiculo-arrastre.json');
  ...
  describe('obtenerPedimentoTabla', () => {
    it('should return observable with VehiculoTabla data', () => {
      ...
      expect(req.request.method).toBe('GET');
      expect(req.request.url).toBe('assets/json/40103/vahiculo-dummy.json');
    ...
    it('should handle concurrent requests correctly', () => {
      ...
      // Fulfill both requests
      const requests = httpMock.match('assets/json/40103/vahiculo-dummy.json');
      expect(requests.length).toBe(2);
  ...
  describe('Service Integration Tests', () => {
    it('should handle mixed successful and error responses', () => {
      ...
      // Fulfill requests
      const catalogoReq = httpMock.expectOne('assets/json/40103/tipo-vehiculo-arrastre.json');
      catalogoReq.flush(mockCatalogoLista);

      const vehiculoReq = httpMock.expectOne('assets/json/40103/vahiculo-dummy.json');
