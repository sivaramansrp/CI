...
@Component({
  selector: 'app-chofere-modification-de-choferes',
  templateUrl: './chofere.modification.de.choferes.component.html',
  styleUrls: ['./chofere.modification.de.choferes.component.scss'],
  standalone: true,
  imports: [
    TablaDinamicaComponent, 
...
export class ChofereModificationDeChoferesComponent implements OnInit, OnDestroy {
      ...
      .pipe(
        ...
        map((data) => {
          ...
          if (this.datosDelChoferExtranjeros.length === 0) {
            ...
            this.datosDelChoferExtranjeros = [...(data?.datosDelChoferExtranjerosModification ?? [])];
          }
        })
      )
      .subscribe();
  ...
  agregarModal(data: ChoferesExtranjeros): void {
    ...
    this.chofer40103Service.updateDatosDelChoferExtranjeroModification(this.datosDelChoferExtranjeros);
