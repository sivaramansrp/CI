...
@Component({
  selector: 'app-chofere-retirada-de-choferes',
  templateUrl: './chofere.retirada.de.choferes.component.html',
  styleUrls: ['./chofere.retirada.de.choferes.component.scss'],
  standalone: true,
  imports: [
    TablaDinamicaComponent, 
...
export class ChofereRetiradaDeChoferesComponent implements OnInit, OnDestroy {
