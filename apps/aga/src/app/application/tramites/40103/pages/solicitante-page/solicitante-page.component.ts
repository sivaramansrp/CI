...
export class SolicitantePageComponent implements OnInit, OnDestroy {
   ...
   *
   * @type {Choferesnacionales40103State}
   */
   ...
   *
   * @param {Chofer40103Query} chofer40103Query - Servicio para consultar el estado del store.
   * @param {Chofer40103Store} chofer40103Store - Servicio para manejar el estado del store.
   */
  constructor(
