...
describe('#ngOnInit', () => {
  ...
  it('should call guardarDatosFormulario if consultaDatos.update is true', () => {
    chofer40103ServiceMock.guardarDatosFormulario.mockReturnValue(observableOf({}));
    chofer40103ServiceMock.getDirectorGeneralData.mockReturnValue(observableOf({}));
    chofer40103ServiceMock.obtenerTablaDatos.mockReturnValue(observableOf([]));
