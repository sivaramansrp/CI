...
describe('DatosDeChoferesExtranjerosDialogComponent', () => {
  ...
  describe('buscarChoferNacional', () => {
    ...
    it('should fetch chofer data and update form when CURP is provided', async () => {
      ...
      expect(mockChofer40102Service.obtenerTablaDatos).toHaveBeenCalledWith('mock-data-choferes-extranjero.json');
      expect(updateListsDataSpy).toHaveBeenCalledWith(mockChoferData);
    ...
    it('should handle service errors gracefully', async () => {
      mockChofer40102Service.obtenerTablaDatos.mockReturnValue(throwError(() => new Error('Service error')));
  ...
  describe('Edge Cases', () => {
    it('should handle empty paisList on initialization', async () => {
      mockChofer40102Service.getPaisEmisor.mockReturnValue(of([]));
    ...
    it('should handle null response from service', async () => {
      mockChofer40102Service.getPaisEmisor.mockReturnValue(of(null as any));
