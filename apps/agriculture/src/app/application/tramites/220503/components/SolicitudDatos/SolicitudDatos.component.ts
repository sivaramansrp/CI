import { CargarDatosIniciales,CarrosDeFerrocarril, DatosDeMercancias, HistorialInspeccionFisica } from '../../models/solicitud-pantallas.model';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, SolicitudDatosTabComponent, DatosDelTramiteARealizarComponent, ResponsableInspeccionEnPuntoComponent, MedioTransporteComponent],
