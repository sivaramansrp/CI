...
export const PERMISO_DEFINITIVO_TITULO = [
  240119, 240118, 240107, 240106, 240108, 240308,240117, 240121, 240405, 240111, 240407
];
 ...
 */
export const OCULTAR_BOTONES = [240121, 240107, 240407];
...
export const PERIODO_SEMESTRE_HABILITADO = [
  240119, 240108, 240107, 240114, 240106, 240308, 240117, 240121, 240405, 240111, 240407
];
 ...
 */
export const PERMISO_JUSTIFICACION = [240308, 240405, 240407];
