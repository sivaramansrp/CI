...
export const PERIODO_SEMESTRE_HABILITADO = [
  240119, 240108, 240107, 240114, 240106, 240308, 240117, 240121, 240405, 240111,240305, 240311, 240411
];
 ...
 */
export const PERMISO_JUSTIFICACION = [240308, 240405,240305, 240411];
