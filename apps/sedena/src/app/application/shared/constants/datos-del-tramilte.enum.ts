...
export const PERMISO_DEFINITIVO_TITULO = [
  240119, 240118, 240107, 240106, 240108, 240308,240117, 240121, 240405, 240111, 240311, 240411, 240122, 240321
];
 ...
 */
export const OCULTAR_BOTONES = [240121, 240107,240311,240321];
...
export const PERIODO_SEMESTRE_HABILITADO = [
  240119, 240108, 240107, 240114, 240106, 240308, 240117, 240121, 240405, 240111, 240311, 240411,240321
];
 ...
 */
export const FETCHA_PAGO = [240107, 240106];
 ...
 */
export const PERMISO_JUSTIFICACION = [240308, 240405, 240411,240321];
