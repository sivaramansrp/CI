...
export const PERMISO_DEFINITIVO_TITULO = [
  240119, 240118, 240107, 240106, 240108, 240308,240117, 240121,240311
];
 ...
 */
export const PUEDE_MOSTRAR_LA_LISTA_CRUZADA_FOR_MERCANCIA = [240108, 240107, 240117, 240121,240311];
...
export const PERIODO_SEMESTRE_HABILITADO = [
  240119, 240108, 240107, 240114, 240106, 240308, 240117, 240121,240311
];
