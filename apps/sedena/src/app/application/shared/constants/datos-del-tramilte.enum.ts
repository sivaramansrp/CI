...
export const PERMISO_DEFINITIVO_TITULO = [
  240119, 240118, 240107, 240106, 240108, 240308,240117, 240121, 240405, 240111, 240122
];
 ...
 */
export const PUEDE_MOSTRAR_LA_LISTA_CRUZADA_FOR_MERCANCIA = [240108, 240107, 240117, 240121, 240111, 240122];
