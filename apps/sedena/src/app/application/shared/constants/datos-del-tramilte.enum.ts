 ...
 */
export const PERMISO_DEFINITIVO_TITULO = [240119, 240118, 240107, 240106, 240111];
 ...
 */
export const PERIODO_SEMESTRE_HABILITADO = [240119, 240108, 240107, 240114, 240106, 240111];
