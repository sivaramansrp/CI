import { Tramite240311State, Tramite240311Store } from './tramite240311Store.store';
import { Injectable } from '@angular/core';
import { Query } from '@datorama/akita';

/**
 * Servicio que permite consultar (leer) el estado del Trámite 240311
 * usando el patrón de Akita para manejo de estado.
 */

@Injectable({ providedIn: 'root' })
export class Tramite240311Query extends Query<Tramite240311State> {
  /**
   * Constructor que inicializa el query con el store correspondiente.
   *
   * @param {Tramite240311Store} store - Instancia del store para el Trámite 240311.
   */
  constructor(protected override store: Tramite240311Store) {
    super(store);
  }
   ...
   *
   * @property {Observable<Tramite240311State>} selectTramiteState$
   */
