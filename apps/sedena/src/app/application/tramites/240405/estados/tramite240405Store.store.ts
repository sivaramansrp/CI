...
/**
 * Interfaz que representa el estado completo del trámite 240405.
 *
...
*/
export interface Tramite240405State {
...
/**
 * Crea el estado inicial para el trámite 240405.
 *
 * @function createInitialState
 * @returns {Tramite240405State} El estado inicial del store.
 */
export function createInitialState(): Tramite240405State {
  return {
    tabSeleccionado: 1,
...
/**
 * Store que maneja el estado del trámite 240405.
 * Utiliza Akita para el control reactivo del estado.
 */
@Injectable({
  providedIn: 'root',
})
@StoreConfig({ name: 'tramite240405', resettable: true })
export class Tramite240405Store extends Store<Tramite240405State> {
  constructor() {
