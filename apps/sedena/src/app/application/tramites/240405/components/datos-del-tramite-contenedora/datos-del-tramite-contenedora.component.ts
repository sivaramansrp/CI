 ...
 */
   ...
   * En este caso, corresponde al trámite 240405.
   */
  idProcedimiento: number = NUMERO_TRAMITE.TRAMITE_240405;
  ...
  */
   ...
   *
   * @method constructor
   * @param {Tramite240405Query} tramiteQuery - Query de Akita para obtener el estado actual del trámite.
   * @param {Tramite240405Store} tramiteStore - Store de Akita para actualizar el estado del trámite.
   * @returns {void}
   */
  constructor(
