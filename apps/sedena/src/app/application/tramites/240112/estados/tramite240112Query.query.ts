import {
    Tramite240112State,
    Tramite240112Store,
  } from './tramite240112Store.store';
  import { Injectable } from '@angular/core';
  import { Query } from '@datorama/akita';
  
  /**
   * Servicio que permite consultar (leer) el estado del Trámite 240111
   * usando el patrón de Akita para manejo de estado.
   */
  
  @Injectable({ providedIn: 'root' })
  export class Tramite240112Query extends Query<Tramite240112State> {
    /**
     * Constructor que inicializa el query con el store correspondiente.
     *
     * @param {Tramite240112Store} store - Instancia del store para el Trámite 240111.
     */
    constructor(protected override store: Tramite240112Store) {
      super(store);
    }
     ...
     *
     * @property {Observable<Tramite240111State>} selectTramiteState$
     */
