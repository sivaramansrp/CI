...
export class PasoDosComponent implements OnInit, OnDestroy {
  ...
  public TEXTOS = TEXTOS_REQUISITOS;
     ...
     * @description Notificador utilizado para desuscribirse de los observables cuando el componente se destruye.
    ...
    /**
     * @constructor
     * @param catalogosServices Servicio para obtener datos de catálogos necesarios en el formulario.
     */
     ...
     * Actualiza la lista `catalogoDocumentos` si tiene éxito.
     * @returns {void}
     */
