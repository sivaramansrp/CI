import {
  Tramite240108State,
  Tramite240108Store,
} from './tramite240108Store.store';
import { Injectable } from '@angular/core';
import { Query } from '@datorama/akita';

/**
 * Servicio que permite consultar (leer) el estado del Trámite 240108
 * usando el patrón de Akita para manejo de estado.
 */

@Injectable({ providedIn: 'root' })
export class Tramite240108Query extends Query<Tramite240108State> {
  /**
   * Constructor que inicializa el query con el store correspondiente.
   *
   * @param {Tramite240108Store} store - Instancia del store para el Trámite 240108.
   */
  constructor(protected override store: Tramite240108Store) {
    super(store);
  }
   ...
   *
   * @property {Observable<Tramite240108State>} selectTramiteState$
   */
