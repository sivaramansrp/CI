...
describe('ConsultaDatosService', () => {
  ...
  let tramiteStore: MockTramite240108Store;
  ...
  beforeEach(() => {
    ...
    tramiteStore = TestBed.inject(Tramite240108Store) as any;
  });
  ...
  it('should fetch datos de la solicitud', () => {
    ...
    const req = httpMock.expectOne('assets/json/240108/consulta-datos.json');
