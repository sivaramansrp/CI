...
export class PagoDeDerechosContenedoraComponent implements OnInit, OnDestroy {
 ...
 /**
   ...
   *
   * @method constructor
   * @param {Tramite240305Query} tramiteQuery - Query para obtener el estado actual del pago de derechos.
   * @param {Tramite240305Store} tramiteStore - Store que administra el estado del pago de derechos.
   * @returns {void}
   */
  constructor(
   ...
   */
  ngOnInit(): void {
    this.tramite240305Query.getPagoDerechos$
  ...
  updatePagoDerechos(event: PagoDerechosFormState): void {
    this.tramite240305Store.updatePagoDerechosFormState(event);
  }
}
