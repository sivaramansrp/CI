...
export class PagoDeDerechosContenedoraComponent implements OnInit, OnDestroy {
   ...
   *
   * @method constructor
   * @param {Tramite240123Query} tramiteQuery - Query para obtener el estado actual del pago de derechos.
   * @param {Tramite240123Store} tramiteStore - Store que administra el estado del pago de derechos.
   * @returns {void}
   */
  constructor(
