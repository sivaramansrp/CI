 ...
 */
export const API_POST_OPCIONES_EVALUACION = `sat-t${TRAMITE}/${NUMFOLIOTRAMITE}/evaluar/opciones-evaluacion-capturista`;
 ...
 */
export const API_POST_INICIAR_REQUERIMIENTO = `sat-t${TRAMITE}/tramite/${NUMFOLIOTRAMITE}/requerimiento/generar/iniciar`;
 ...
 */
export const API_POST_GUARDAR_REQUERIMIENTO_MOSTRAR_FIRMA = `sat-t${TRAMITE}/tramite/${NUMFOLIOTRAMITE}/requerimiento/generar/mostrar-firmar`;
