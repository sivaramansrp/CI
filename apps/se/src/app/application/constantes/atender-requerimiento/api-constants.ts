 ...
 */
export const API_GET_INICIAR_ATENDER_REQUERIMIENTO = `tramite/${NUMFOLIOTRAMITE}/requerimiento/atender/iniciar`;
 ...
 */
export const API_POST_MOSTRAR_FIRMAR = `tramite/${NUMFOLIOTRAMITE}/requerimiento/atender/mostrar-firma`;
 ...
 */
export const API_POST_FIRMAR = `tramite/${NUMFOLIOTRAMITE}/requerimiento/atender/firmar`;
