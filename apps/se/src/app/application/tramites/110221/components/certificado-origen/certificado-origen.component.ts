...
export class CertificadoOrigenComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.tramite110221Query.selectSolicitud$
      .pipe(
  ...
  busqueda_rfc(): void {
    ...
    this.tramite110221Store.setRfcImportExport(rfcImportExport);
    this.tramite110221Store.setNombreImportExport(nombreImportExport);
  }
  ...
  tipoSolicitudSeleccion(): void {
    ...
    this.tramite110221Store.setTipoSolicitud(tipoSolicitud);
  }
  ...
  /**
   * Establece los valores en el store de tramite110221.
   *
   ...
   * @returns {void}
   */
  setValoresStore(form: FormGroup, campo: string, metodoNombre: keyof Tramite110221Store): void {
    const valor = form.get(campo)?.value;
    (this.tramite110221Store[metodoNombre] as (value: any) => void)(valor);
  }
