...
import { Solicitud110221State, Tramite110221Store } from './Tramite110221.store';
...
export class Tramite110221Query extends Query<Solicitud110221State> {
   ...
   * @param store Instancia de la tienda `Tramite110221Store` que contiene el estado del trámite.
   */
