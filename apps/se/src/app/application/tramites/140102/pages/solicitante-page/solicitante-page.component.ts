...
/**
 * Componente principal para la gestión de la página del solicitante en el trámite 140102.
 * 
...
export class SolicitantePageComponent implements OnDestroy {
   ...
   * ```
   */
  @ViewChild('datosComponent', { static: false }) datosComponent: PantallasComponent | undefined;
 ...
 /**
   ...
   * @param tramite140102Store - Store de Akita para gestionar el estado del trámite 140102.
   * @param tramite140102Query - Query de Akita para consultar el estado del trámite 140102.
          ...
          next: (respuesta: BaseResponse<{ id_solicitud: number }>) => {
            if (respuesta.codigo !== '00') {
              ...
              if (respuesta.datos?.id_solicitud) {
                ...
                this.tramite140102Store.setIdSolicitud(respuesta.datos.id_solicitud);
              }
  ...
  /**
   * Guarda la solicitud del trámite 140102 (Cancelación de Programa IMMEX/PROSEC).
   * 
   ...
   */
      onGuardar(): Observable<BaseResponse<{ id_solicitud: number }>> {
        return this.tramite140102Query.selectSolicitud$.pipe(
