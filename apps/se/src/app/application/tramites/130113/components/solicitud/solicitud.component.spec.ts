...
describe('SolicitudComponent', () => {
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        FormBuilder,
        { provide: Tramite130113Store, useValue: mockStore },
        { provide: Tramite130113Query, useValue: mockQuery },
        { provide: ImportacionEquipoAnticontaminanteService, useValue: mockService },
      ],
    }).compileComponents();
  });
