...
@Component({
  selector: 'app-cancelacion-de-certificate',
  standalone: true,
   imports: [CommonModule,TituloComponent,OficioComponent,TablaDinamicaComponent,CatalogoSelectComponent,FormsModule,ReactiveFormsModule],
  templateUrl: './cancelacion-de-certificate.component.html',
  styleUrl: './cancelacion-de-certificate.component.css',
})
/**
 ...
 */
export class CancelacionDeCertificateComponent {
   ...
   * @type {Catalogo[]}
   */
  public regime: Catalogo[] = cancelcatalog.regime;
   ...
   * @type {Catalogo[]}
   */
  public nombrede: Catalogo[] = cancelcatalog.nombrede;
   ...
   * @type {Catalogo[]}
   */
  public nombredel: Catalogo[] = cancelcatalog.nombredel;
