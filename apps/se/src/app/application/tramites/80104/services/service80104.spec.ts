...
import { Solocitud80104Service } from './service80104.service';
...
describe('Solocitud80104Service', () => {
  let service: Solocitud80104Service;
  ...
  beforeEach(() => {
    ...
    service = TestBed.inject(Solocitud80104Service);
