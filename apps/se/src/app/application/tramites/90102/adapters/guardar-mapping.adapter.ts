...
export class GuardarMappingAdapter {
  ...
  static toFormPayload(state: ProsecState): unknown {
    ...
    "plantas": state.prosecDatos.map((item) => 
        {
            return {
                ...
                "empresaDto": {
                    ...
                    "domicilioCompleto": item.domicilioFiscalDelSolicitante,
                    "numeroPrograma": null,
                    "tiempoPrograma": null,
                ...
                "domicilioDto": {
                    "idDomicilio": null,
                    "calle": item.calle,
                    "numExterior": item.numeroExterior,
                    "numInterior": item.numeroInterior,
                    ...
                    "delegacionMunicipio": {
                        "cveDelegMun": "29005",
                        "cveEntidad": null,
                        "nombre": item.municipioOAlcaldia,
                        "fechaCaptura": null,
                        "fechaInicioVigencia": null,
                        "fechaFinVigencia": null,
                        "satMunicopality": null,
    ...
    "sectores": state.sectorDatos.map((item) => 
        {
            return {
            "sector":item.sectorLista,
            "cvSectorCatalogo":item.sectorClave,
            "descripcionTestado": null,
            "cveSector": null,
            "idConfProgramaSE": 50,
            "testadoSector": false,
    ...
    // "planlas": state.prosecDatos,
    // "sectores": state.sectorDatos,
