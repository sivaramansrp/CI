/**
 * Conjunto de rutas de la API para el procedimiento 130115.
 */
 ...
 */
const PROCEDURE = '/sat-t130115';

/**
 * Rutas de la API para el procedimiento 130115
 */
export const PROC_130115 = {
