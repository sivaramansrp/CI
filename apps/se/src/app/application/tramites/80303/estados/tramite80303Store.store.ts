...
export class Tramite80303Store extends Store<Tramite80303State> {
   ...
   */
     ...
     * @returns {void}
     */
    public updateAnexoExportacionTablaDatos(anexoExportacionTablaDatos: AnexoExportacion[]): void {
      this.update((state) => ({
     ...
     * @returns {void}
     */
    public updateAnexoImportacionTablaDatos(anexoImportacionTablaDatos: AnexoImportacion[]): void {
      this.update((state) => ({
        ...state,
        anexoImportacionTablaDatos,
      }));
     ...
     * @returns {void}
     */
    public updateAccionistasTablaDatos(accionistasTablaDatos: DatosContribuyente[]): void {
      this.update((state) => ({
        ...state,
        accionistasTablaDatos,
      }));
     ...
     * @returns {void}
     */
    public updateFederatariosTablaDatos(federatariosTablaDatos: Federatario[]): void {
      this.update((state) => ({
        ...state,
        federatariosTablaDatos,
      }));
     ...
     * @returns {void}
     */
    public updatePlantasIMMEXDatos(plantasIMMEXDatos: FederatarioRealizaranLasOperaciones[]): void {
      this.update((state) => ({
        ...state,
        plantasIMMEXDatos,
      }));
     ...
     * @returns {void}
     */
    public updateEmpresasSubmanufacturerasTablaDatos(empresasSubmanufacturerasTablaDatos: DatosEmpresaSubmanufacturera[]): void {
      this.update((state) => ({
        ...state,
        empresasSubmanufacturerasTablaDatos,
      }));
     ...
     * @returns {void}
     */
    public updatePlantasManufacturerasTablaDatos(plantasManufacturerasTablaDatos: DatosPlantaManufacturera[]): void {
      this.update((state) => ({
        ...state,
        plantasManufacturerasTablaDatos,
      }));
     ...
     * @returns {void}
     */
    public updateServiciosImmexTablaDatos(serviciosImmexTablaDatos: ServicioImmex[]): void {
      this.update((state) => ({
        ...state,
        serviciosImmexTablaDatos,
      }));
