import { AnexoExportacion, AnexoImportacion, Sensible } from '../../models/complementaria.model';
import { CONFIGURACION_ANEXO_EXPORTACION, CONFIGURACION_ANEXO_IMPORTACION, CONFIGURACION_SENSIBLES } from '../../constants/complementaria.enum';
...
export class AnexoUnoPestanaComponent {
  ...
  public configuracionAnexoExportacionTabla: ConfiguracionColumna<AnexoExportacion>[] = CONFIGURACION_ANEXO_EXPORTACION;

  public anexoExportacionTablaDatos: AnexoExportacion[] = [];

  public anexoExportacionTablaSeleccionada: AnexoExportacion[] = [];

  public configuracionAnexoImportacionTabla: ConfiguracionColumna<AnexoImportacion>[] = CONFIGURACION_ANEXO_IMPORTACION;
  ...
  constructor(public modificacionProgramaImmexBajaSubmanufactureraService: ModificacionProgramaImmexBajaSubmanufactureraService) {
    this.modificacionProgramaImmexBajaSubmanufactureraService.obtenerRespuestaPorUrl(this, 'anexoExportacionTablaDatos', '/80303/anexoExportacion.json');
    this.modificacionProgramaImmexBajaSubmanufactureraService.obtenerRespuestaPorUrl(this, 'anexoImportacionTablaDatos', '/80303/anexoImportacion.json');
    this.modificacionProgramaImmexBajaSubmanufactureraService.obtenerRespuestaPorUrl(this, 'sensiblesTablaDatos', '/80303/sensible.json');
  }
