...
/**
 * Crea el estado inicial para el store de Tramites120602.
 * Este estado contiene los datos generales de los socios,
 * los datos de la solicitud y la representación federal.
 * @returns Tramites120602State Estado inicial del trámite.
 */
...
/**
 * Store para manejar el estado del trámite 120602.
 * Este store utiliza Akita para gestionar el estado de la aplicación.
 */
@Injectable({
  providedIn: 'root',
})
@StoreConfig({ name: 'tramites120602', resettable: true })
export class Tramite120602Store extends Store<Tramites120602State> {
  /**
