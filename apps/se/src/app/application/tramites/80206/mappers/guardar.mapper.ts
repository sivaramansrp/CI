...
"mercanciaImportacion": solicitudState.datosImportacion?.map((item, index) => ({
    ...
    "testado": 0,
    "tipoFraccion": item.tipo || "string",
    "visible": true,
    "fraccionPadre": item.fraccionArancelaria || "string",
    "blnFraccionSeleccionada": 0,
    "claveFraccionPadre": item.fraccionArancelaria || "string",
    "fraccionCompuesta": item.fraccionArancelaria || "string",
    "descripcionTestado": "string",
    ...
    "valorProduccionAnualSolicitada": "string",
    "categoria": item.categoria || "string",
    "mensaje": "string",
    "umt": item.umt || "string",
    "claveCategoria": item.categoria || "string",
    "descripcionUsuario": item.descripcionComercialImportacion || "string",
    "descripcionFraccionPadre": item.descripcionComercial || "string",
    "idProductoPadre": item.fraccion || "string",
    "idProducto": `${index + 1}`,
    "permisoPadre": "string",
    "fraccionArancelaria": {
        "fraccionPadre": item.fraccionArancelaria || "string",
        ...
        "claveFraccionPadre": item.fraccionArancelaria || "string",
        "unidadMedida": item.umt || "string",
        "fraccionConcatenada": item.fraccionArancelariaImportacion || "string",
        "descripcionTestado": "string",
        "testado": true,
        "tipoOperacion": "IMPORTACION",
        "valorMonedaMensual": item.valorMensual || "string",
        ...
        "valorProduccionAnualSolicitada": "string",
        "claveCategoria": item.categoria || "string",
        "descripcionCategoria": item.categoria || "string",
        "mensaje": "string",
        "descripcionUsuario": item.descripcionComercialImportacion || "string",
        "umt": item.umt || "string",
        "idFraccion": `${index + 1}`,
        ...
        "descripcionServicio": "string",
        "rowID": `${index + 1}`,
        "cveFraccion": item.fraccionArancelariaImportacion || "61032301",
        "capitulo": "string",
        "partida": "string",
        "subPartida": "string",
        "descripcion": item.descripcionComercialImportacion || "string",
