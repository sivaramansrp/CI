...
import { ALERT} from '../../constantes/modificacion.enum';
...
import { TEXTOS } from '../../constantes/modificacion.enum';
...
export class RegistroPageComponent implements OnInit, OnDestroy {
   ...
   */
  ngOnInit(): void {
    this.ampliacionServiciosService.deberiaMostrar$.pipe(takeUntil(this.destroyNotifier$)).subscribe(res => {
