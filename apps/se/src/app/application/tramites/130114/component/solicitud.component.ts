...
/**
  ...
  ngOnInit(): void {
    ...
    this.tramite130114Query.select(state => state.tableBodyData)
  ...
  onPartidaModificada(partida: PartidasDeLaMercanciaModelo): void {
    ...
    this.tramite130114Store.actualizarEstado({ tableBodyData: this.tableBodyData });
  ...
  const CURRENT_TABLE = this.tramite130114Query.getValue().tableBodyData || [];
