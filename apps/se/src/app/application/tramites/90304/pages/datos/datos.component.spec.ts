...
describe('DatosComponent', () => {
  ...
  it('should render modificación tab when indice is 2', () => {
    component.indice = 2;
    fixture.detectChanges();
    const MODIFICACION = fixture.nativeElement.querySelector('app-modificacion');
    expect(MODIFICACION).toBeTruthy();
  });

  it('should render bitácora tab when indice is 3', () => {
    component.indice = 3;
    fixture.detectChanges();
    const BITACORA = fixture.nativeElement.querySelector('app-bitacora');
