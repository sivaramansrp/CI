 ...
 */
   ...
   * @param {ValidarInicialmenteCertificadoService} validarInicialmenteCertificadoService - Servicio para gestionar datos relacionados con el Certificado de Origen.
   * @param {Tramite110214Store} store - Store para gestionar el estado del trámite 110214.
   * @param {Tramite110214Query} tramiteQuery - Query para consultar el estado del trámite 110214.
 ...
 */
   ...
   * @param {keyof Tramite110214Store} metodoNombre - El nombre del método en el store que se debe invocar.
   */
 ...
 */
   ...
   * 
   * Este método obtiene las opciones de tratado desde el servicio `validarInicialmenteCertificadoService` y las asigna a `optionsTratado`.
   */
  cargarTratado(): void {
   ...
   * 
   * Este método obtiene las opciones de países desde el servicio `validarInicialmenteCertificadoService` y las asigna a `optionsPais` y `optionsTipoFactura`.
   */
  cargarPais(): void {
    this.validarInicialmenteCertificadoService
      .obtenerPais()
   ...
   * 
   * Este método obtiene las mercancías disponibles desde el servicio `validarInicialmenteCertificadoService` y las asigna a `mercanciaDisponsiblesTablaDatos`.
   */
   ...
   * 
   * Este método obtiene las mercancías seleccionadas desde el servicio `validarInicialmenteCertificadoService` y las asigna a `mercanciaSeleccionadasTablaDatos`.
   */
