 ...
 */
export const API_POST_SOLICITUD = 'sat-t110219/solicitud/guardar';

/**
 * Rutas de la API para el procedimiento 110219
 */
export const PROC_110219 = {
  GET_FORM_DATA: `${BASE_URL}${API}${API_VERSION}${PROCEDURE}${SOLICITUD}/acuse`,
  BUSCAR_CERTIFICADOS: `${BASE_URL}${API}${PROCEDURE}/solicitud/mostrar-certificados`,
  BUSCAR_LISTA_CERTIFICADOS: `${BASE_URL}${API}${PROCEDURE}/solicitud/buscar-lista-certificados`,
