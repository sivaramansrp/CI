...
import { AlertComponent, AnexarDocumentosComponent, CATALOGOS_ID, Catalogo, CatalogosService, PeximService, TEXTOS, TituloComponent } from '@ng-mf/data-access-user';
/**
