 ...
 * for the ampliacion servicios trámite 80211.
 */
import { Injectable } from '@angular/core';
import type { Tramites80211State } from '../estados/tramites80211.store';
...
export class AmpliacionServiciosAdapter {
   ...
   */
  static toFormPayload(state: Tramites80211State): AmpliacionServiciosPayload {
