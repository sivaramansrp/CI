/**
 * Conjunto de rutas de la API para el procedimiento 130111.
 */
 ...
 */
const PROCEDURE = '/sat-t130111';

/**
 * Rutas de la API para el procedimiento 130111
 */
export const PROC_130111 = {
