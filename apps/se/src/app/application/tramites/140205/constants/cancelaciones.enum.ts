 ...
 * 
 * Define las propiedades de la fecha de vencimiento, como el nombre de la etiqueta, si es requerida y si está habilitada.
 */
export const TABLA_DE_DATOS_CUPOS = {
  encabezadas: [
    {
      encabezado: 'Cupo',
...
/**
 * Configuración para la tabla de datos disponibles.
 * 
 * Define las propiedades de la tabla, incluyendo los encabezados y los datos que se mostrarán.
 */
export const TABLA_DE_DATOS_DISPONIBLES = {
  encabezadas: [
    {
