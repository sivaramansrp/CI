...
@Component({
  selector: 'app-130106solicitante',
  standalone: true,
  imports: [CommonModule,TituloComponent,ReactiveFormsModule],
  templateUrl: './solicitante.component.html',
  styleUrl: './solicitante.component.scss',
})
export class Solicitante130106Component {
  ...
  public establecerValoresDeFormulario(): void {
    ...
    this.solicitudForm.get('denominacion')?.setValue('INTEGRADORA DE URBANIZACIONES SIGNUM S DE RL DE CV');
    this.solicitudForm.get('actividadEconomica')?.setValue('Siembra, cultivo y cosecha de otros cultivos');
    this.solicitudForm.get('correoElectronico')?.setValue('vucem2.5@hotmail.com');
  }
