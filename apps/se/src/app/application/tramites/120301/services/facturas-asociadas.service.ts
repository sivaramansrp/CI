import { API_DELETE_FACTURAS_TPL_ELIMINAR, API_GET_FACTURAS_TPL, API_GET_FACTURAS_TPL_ASOCIADAS, API_GET_FACTURAS_TPL_TOTAL_UNIDAD, API_POST_FACTURAS_TPL_ASOCIAR, IDEXPEDICION } from '../server/api-router';
