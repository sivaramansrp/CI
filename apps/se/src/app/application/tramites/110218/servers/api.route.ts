/**
 * Conjunto de rutas de la API para el procedimiento 110218.
 */
 ...
 */
const PROCEDURE = '/sat-t110218';

/**
 * Rutas de la API para el procedimiento 110218.
 * Incluye las rutas para guardar la solicitud y para obtener el catálogo de tipo de factura.
 */
export const PROC_110218 = {
