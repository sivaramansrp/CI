...
describe('CertificadoValidacionService', () => {
  ...
  const endpoints: { method: ServiceMethod; url: string }[] = [
    ...
    { method: 'obtenerIdioma', url: 'assets/json/110202/idioma.json' },
    { method: 'obtenerEntidadFederativa', url: 'assets/json/110202/entidad-federativa.json' },
    { method: 'obtenerRepresentacionFederal', url: 'assets/json/110202/representacion-federal.json' },
