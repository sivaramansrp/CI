...
import { PartidasLista, ArancelariaLista, SolicitudLista, MercanciaLista, MercanciaTablaLista } from '../models/modificacion-descripcion.model';
...
describe('ModificacionDescripcionService', () => {
  ...
  it('should fetch the list of partidas', () => {
    const mockResponse: PartidasLista = { datos: [{ 
        "id": 1,
        "cantidad": "100",
  ...
  it('should fetch the list of arancelarias', () => {
    const mockResponse: ArancelariaLista = { datos: [{
        "id": 1,
  ...
  it('should fetch the list of solicitudes', () => {
    const mockResponse: SolicitudLista = { datos: { 
  ...
  it('should fetch the list of mercancías', () => {
    const mockResponse: MercanciaLista = { datos: { 
  ...
  it('should fetch the data for the mercancía table', () => {
    const mockResponse: MercanciaTablaLista = { datos: [{ 
        "id": 1,
        "cantidad": "100",
