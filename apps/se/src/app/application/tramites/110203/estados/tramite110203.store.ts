...
export class Tramite110203Store extends Store<Solicitud110203State> {
  ...
  /**
   * **Actualiza el nombres en el estado**
   *
   * Modifica la propiedad `nombres` dentro del estado de la tienda.
   *
   * @param nombres - Nuevo valor del nombres.
   */
  public setNombre(nombres: string): void {
    this.update((state) => ({
      ...state,
      nombres,
    }));
