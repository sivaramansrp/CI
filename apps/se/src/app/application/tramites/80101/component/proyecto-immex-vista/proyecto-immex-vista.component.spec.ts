...
import { ProyectoImmexEncabezado, PoryectoDatos } from '../../../../shared/models/nuevo-programa-industrial.model';
...
describe('ProyectoImmexVistaComponent', () => {
  ...
  it('should update proyectoImmexTablaLista on obtenerProyectoTablaDevolverLaLlamada', () => {
    const mockData: ProyectoImmexEncabezado[] = [{ id: 1, descripcion: 'test' }];
