...
export const ANEXO_I_SERVICIO = [
  ...
  },
  {
    ...
    clave: (ele: AnexoUnoEncabezado): string =>
      ele.ENCABEZADO_FRACCION_ARANCELARIA,
    orden: 2,
  },
  {
    encabezado: 'Descripción comercial',
    clave: (ele: AnexoUnoEncabezado): string =>
      ele.ENCABEZADO_DESCRIPCION_COMERCIAL,
    orden: 3,
  },
  {
    encabezado: 'Anexo II',
...
export const ANEXO_IMPORTACION_SERVICIO = [
  {
    encabezado: 'Fracción',
    clave: (ele: AnexoImportacionEncabezado): string => ele.ENCABEZADO_FRACCION,
    orden: 1,
  },
  {
    encabezado: 'Fracción arancelaria del producto de exportación',
    clave: (ele: AnexoImportacionEncabezado): string =>
      ele.ENCABEZADO_FRACCION_EXPORTACION,
    orden: 2,
  },
  {
    encabezado: 'Descripción comercial',
  ...
  },
  {
    ...
    clave: (ele: AnexoImportacionEncabezado): string =>
      ele.ENCABEZADO_FRACCION_IMPORTACION,
    orden: 4,
  },
];
...
export const PROYECTO_IMMEX_CONFIG = [
  ...
  },
  {
    ...
    clave: (ele: ProyectoImmexEncabezado): string =>
      ele.ENCABEZADO_TIPO_DOCUMENT,
    orden: 2,
  },
  {
    encabezado: 'Descripción otro',
    clave: (ele: ProyectoImmexEncabezado): string =>
      ele.ENCABEZADO_DESCRIPCION_OTRO,
    orden: 3,
  },
  {
