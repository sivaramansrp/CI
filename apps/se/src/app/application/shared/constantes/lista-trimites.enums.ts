...
export const LISTA_TRIMITES: AccuseComponentes[] = [
  ...
  },
  {
        ...
        listaComponentes: [{
            id: 'solicitud',
            componentPath: () => import('../../tramites/80102/pages/paso-uno/paso-uno.component').then(m => m.PasoUnoComponent),
            componentName: 'PasoUnoComponent',
  ...
  },
  {
  ...
  },
   {
    ...
    },
    {
        ...
        listaComponentes: [{
            id: 'solicitud',
            componentPath: () => import('../../tramites/130119/pages/paso-uno/paso-uno.component').then(m => m.PasoUnoComponent),
            componentName: 'PasoUnoComponent',
    ...
    },
    {
      ...
      listaComponentes: [{
        id: 'solicitud',
        componentPath: () => import('../../tramites/80210/pages/paso-uno/paso-uno.component').then(m => m.PasoUnoComponent),
        componentName: 'PasoUnoComponent',
      }]
    }
];
