...
export const CRITERIO_PARA_CONFERIR_ORIGEN_IDS = [
  110205, 110212, 110201, 110202, 110207, 110208, 110217, 110216, 110223
];
...
export const TIPO_DE_FACTURA_IDS = [
  110204, 110205, 110212, 110201, 110202, 110207, 110208, 110217, 110216, 110221, 110223, 110211
];
 ...
 * @type {number[]}
 */
export const MARCA_IDS = [110207, 110208, 110202];
 ...
 */
export const MARCA_BRUTA_IDS = [110202];
 ...
 * Estos valores se emplean para validar o asociar mercancías con su unidad de medida de masa bruta.
 */
export const UMC_MARCA_BRUTA_IDS = [110202];
/**
 * @description
 ...
 */
export const REQUIRED_FECHA_FACTURA: number[] = [110204, 110205, 110212, 110201, 110202, 110223, 110208];

/**
 * IDs de procedimientos en los que el campo “Cantidad” es obligatorio.
 */
export const REQUIRED_CANTIDAD: number[] = [110204, 110205, 110212, 110201, 110202, 110222, 110211, 110208, 110207, 110223];
...
export const REQUIRED_VALOR_MERCANCIA: number[] = [
  110204, 110205, 110212,110201,110202, 110222,110208, 110207, 110223
];
...
export const REQUIRED_COMPLEMENTO_DESCRIPCION: number[] = [
  110204, 110205, 110212,110201,110202, 110222, 110211, 110208, 110207, 110223
];

/**
 * IDs de procedimientos en los que el campo “Número de factura” es obligatorio.
 */
export const REQUIRED_NUMERO_FACTURA: number[] = [110212,110201,110202, 110211, 110208, 110207, 110223];
 ...
 */
export const MERCANCIA_SELECCIONADAS_REQUIRED = [110207,110212,110201,110202, 110211, 110223];