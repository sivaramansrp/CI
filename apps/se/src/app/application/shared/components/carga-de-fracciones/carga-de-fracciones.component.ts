...
import { TABLA_DATOS, TEXTOS } from '../../constantes/carga-de-fracciones.enum';
import { CommonModule } from '@angular/common';
import { TituloComponent } from '@libs/shared/data-access-user/src';

@Component({
  selector: 'app-carga-de-fracciones',
  standalone: true,
  imports: [CommonModule, TituloComponent],
  templateUrl: './carga-de-fracciones.component.html',
  styleUrl: './carga-de-fracciones.component.scss'
})
export class CargaDeFraccionesComponent {
