...
export class Tramite110223Store extends Store<Solicitud110223State> {
   ...
   * @param valorContenidoRegional Cadena que representa el nombre en inglés.
   */
  public setvalorContenidoRegional(valorContenidoRegional: string) {
    this.update((state) => ({
      ...state,
      valorContenidoRegional,
    }));
  ...
  /**
   * Establece el nombre en inglés de la mercancía.
   * @param otrasInstancias Cadena que representa el nombre en inglés.
   */
  public setotrasInstancias(otrasInstancias: string) {
    this.update((state) => ({
      ...state,
      otrasInstancias,
    }));
   ...
   * @param criterioParaPreferencial Cadena que representa el criterio para conferir origen.
   */
  public setcriterioparapreferencial(criterioParaPreferencial: string) {
    this.update((state) => ({
      ...state,
      criterioParaPreferencial,
    }));
  ...
  public setNFactura(numeroFactura: string) {
    ...
    /**
   * Establece el número de factura.
   * @param numeroSerie Cadena que representa el número de factura.
   */
