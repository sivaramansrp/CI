/**
 * Tramite130107Store
 * Este módulo define el `Store` de Akita para gestionar el estado del trámite con ID 130107.
...
/**
 * Tramite130107State
 * Interfaz que define la estructura del estado del trámite 130107.
 */
export interface Tramite130107State {
  /**
...
/**
 * createInitialState
 * Función que define y retorna el estado inicial para el `Tramite130107State`.
 ...
 *
 * El estado inicial del trámite 130107.
 */
export function createInitialState(): Tramite130107State {
  return {
    idSolicitud: 0,
    filaSeleccionada: [],
    mostrarTabla: false,
...
/**
 * Clase que representa el `Store` de Akita para el trámite 130107.
...
@StoreConfig({ name: 'tramite130107' })
export class Tramite130107Store extends Store<Tramite130107State> {
  constructor() {
   ...
   */
  public actualizarEstado(valores: Partial<Tramite130107State>): void {
    this.update((state) => ({
      ...state,
      ...valores,
    }));
