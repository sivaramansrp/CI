import {
  DatosModificacion,
  DatosSolicitante,
} from '../../tramites/80314/estados/models/datos-tramite.model';
import { Injectable } from '@angular/core';
import { Store } from '@datorama/akita';
import { StoreConfig } from '@datorama/akita';

/**
 * Creacion del estado inicial para la interfaz de tramite 80314
 * @returns Solicitud80314
 */

/**
 * Representa el estado de la solicitud 80314.
 */
export interface Solicitud80314State {
  /**
...
@StoreConfig({ name: 'tramite80314', resettable: true })
export class Tramite80314Store extends Store<Solicitud80314State> {
  constructor() {
   ...
   */
  public setCasillaDeVerificacionindividual(
    casillaDeVerificacionindividual: []
  ): void {
    this.update((state) => ({
      ...state,
