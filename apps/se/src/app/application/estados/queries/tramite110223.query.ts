...
import { Solicitud110223State, Tramite110223Store } from '../tramites/Tramite110223.store';

/**
 * Clase que proporciona consultas reactivas para el estado del trámite 110223.
 * Permite seleccionar partes específicas del estado almacenado en la tienda.
 */
@Injectable({ providedIn: 'root' })
export class Tramite110223Query extends Query<Solicitud110223State> {
  /**
   * Constructor de la clase.
   * @param store Instancia de la tienda `Tramite110223Store` que contiene el estado del trámite.
   */
