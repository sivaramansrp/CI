...
export enum Solicitud31802Enum {
     ...
     */
    MODALIDAD_SOCIO_COMERCIAL = 'Modalidad Socio Comercial Certificado',
  
    /**
     * Texto para el rubro de mensajería y paquetería.
     * Representa la categoría de servicios de mensajería y paquetería.
     */
    RUBRO_MENSAJERIA = 'Rubro Mensajeria y Paqueteria',
     ...
     */
    DATOS_REGISTRO = 'Datos en que se otorgó su Registro en el Esquema de Certificación de Empresas o, en su caso, de la última Renovación',
