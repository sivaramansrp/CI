...
export class PasoDosComponent implements OnInit, OnDestroy {
   ...
   * @param renovacionService Servicio para gestionar las operaciones relacionadas con renovacion de servicio.
   */
  constructor(
  ...
  obtenerDocumentosSeleccionados(): void {
    this.renovacionService.obtenerDocumentosSeleccionados()
      .pipe(takeUntil(this.destruirNotificador$))
      .subscribe({
        next: (result) => {
