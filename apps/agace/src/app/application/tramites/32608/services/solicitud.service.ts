import { ApiResponse, BuscarRfcResponse, InstalacionesInterface, RubroTextil } from '../models/oea-textil-registro.model';
 ...
 * de la solicitud 32608 a partir de archivos JSON locales.
 */
@Injectable({
  providedIn: 'root',
})
...
export class SolicitudService {
  ...
  conseguirRecibirNotificaciones(): Observable<RecibirNotificaciones[]> {
    return this.http.get<RecibirNotificaciones[]>(
      'assets/json/32608/recibir-notificaciones.json'
    );
  }
  ...
  conseguirEnlaceOperativoDatos(): Observable<EnlaceOperativo[]> {
    return this.http.get<EnlaceOperativo[]>(
      'assets/json/32608/enlace-operativo-datos.json'
    );
  }
  ...
  conseguirRepresentanteLegalDatos(): Observable<RepresentanteLegal> {
    return this.http.get<RepresentanteLegal>(
      'assets/json/32608/representante-legal-datos.json'
    );
  }
  ...
  conseguirOpcionDeRadio(): Observable<SolicitudRadioLista> {
    return this.http.get<SolicitudRadioLista>(
      'assets/json/32608/solicitud-radio-lista.json'
    );
  }
  ...
  conseguirSolicitudCatologoSelectLista(): Observable<SolicitudCatologoSelectLista> {
    return this.http.get<SolicitudCatologoSelectLista>(
      'assets/json/32608/solicitud-catologo-select-lista.json'
    );
  }
  ...
  conseguirSeccionSubcontratados(): Observable<SeccionSubcontratados> {
    return this.http.get<SeccionSubcontratados>(
      'assets/json/32608/seccion-subcontratados.json'
    );
  }
  ...
  conseguirInventarios(): Observable<Inventarios[]> {
    return this.http.get<Inventarios[]>(
      'assets/json/32608/inventarios-datos.json'
    );
  }
  ...
  guardarDatosFormulario(): Observable<GuardarDatosFormulario> {
    return this.http.get<GuardarDatosFormulario>(
      'assets/json/32608/guardar-datos-formulario.json'
    );
  }
  ...
  conseguirDatosPorRFC(_rfc: string): Observable<{ [key: string]: RFCEnlaceOperativo }> {
    return this.http.get<{ [key: string]: RFCEnlaceOperativo }>('assets/json/32608/rfc-datos.json');
  }
  /**
  ...
  /**
 * Actualiza el estado completo de la solicitud 32608 en el store.
 ...
 */
  actualizarEstado(DATOS: Solicitud32608State): void {
    this.solicitud32608Store.actualizarEstado(DATOS);
  }
  /**
 ...
 * 
 * returns Observable que emite el estado completo de la solicitud 32608
 */
   obtenerDatos(): Observable<Solicitud32608State> {
    return this.http.get<Solicitud32608State>('assets/json/32608/datos.json');
  }
   /**
 ...
 /**
  ...
  getDatosrubroTextil(): Observable<RubroTextil> {
    return this.http.get<RubroTextil>('assets/json/32608/rubro-IVA-textil-datos.json');
  }
