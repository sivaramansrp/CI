...
/**
 * Componente para agregar y gestionar transportistas en el trámite 32608.
...
export class AgregarTransportistasComponent implements OnInit, OnDestroy {
   ...
   * param tramite32608Store - Store para gestionar el estado del trámite
   * param tramite32608Query - Query para consultar el estado del trámite
