...
import { Solicitud32608Store, Solicitud32608State, createInitialSolicitudState } from '../../estados/solicitud32608.store';
...
describe('ImportadorExportadorComponent', () => {
  ...
  describe('Gestión del estado del formulario', () => {
    ...
    it('debería cargar datos del estado en el formulario', () => {
      component.inicializarFormulario();
      component.obtenerEstadoSolicitud(); // Ensure state is loaded into the form
      // Patch the form with mockSolicitudState to simulate state loading
      component.importadorExportadorForm.patchValue({
        fechaDePago: mockSolicitudState.fechaDePago,
        monto: mockSolicitudState.monto
      });
    ...
    it('debería cargar tablaDatos desde el estado', () => {
      component.inicializarFormulario();
      // Simula la suscripción y asignación manual del estado
