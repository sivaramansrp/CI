...
import { ENLACE_OPERATIVO_TABLA, PANELS_CONFIGURACION } from '../../enums/oea-textil-registro.enum';
...
import { TablaEnlaceOperativo } from '../../modelos/oea-textil-registro.model';
...
export class EnlaceOperativoComponent implements OnInit, OnDestroy {
   ...
   * @param {Tramite32609Query} tramite32609Query - Query para consultar el estado del trámite
   * @param {ConsultaioQuery} consultaioQuery - Query para consultar el estado de solo lectura
   */
  constructor(
    private fb: FormBuilder,
    @Inject(Tramite32609Store) private tramite32609Store: Tramite32609Store,
