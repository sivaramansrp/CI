...
describe('CTPATComponent', () => {
  ...
  let mockSolicitudService: jest.Mocked<OeaTextilRegistroService>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        FormBuilder,
        { provide: OeaTextilRegistroService, useValue: mockSolicitudService },
  ...
  describe('Obtención del estado de la solicitud', () => {
    ...
    it('debería suscribirse a selectTramite32609$ del query', () => {
      const spy = jest.spyOn(mockTramite32609Query.selectTramite32609$, 'pipe');
  ...
  describe('Casos edge y manejo de errores', () => {
    it('debería manejar el caso cuando el estado de la solicitud es null', () => {
      mockTramite32609Query.selectTramite32609$ = of(null as any);
