...
@Component({
  ...
  providers: [OeaTextilRegistroService,BsModalService],
...
export class CTPATComponent implements OnInit, OnDestroy {
  ...
  solicitud32605State: Tramites32609State = {} as Tramites32609State;
  ...
  constructor(
    ...
    public solicitud32605Store: Tramite32609Store,
    public solicitud32605Query: Tramite32609Query,
   ...
   * `selectTramite32609$` para escuchar actualizaciones del estado y aplicar los valores
  ...
  obtenerEstadoSolicitud(): void {
    this.solicitud32605Query.selectTramite32609$?.pipe(takeUntil(this.destroy$))
  ...
  setValoresStore(form: FormGroup | null, campo: string): void {
    ...
    if (CONTROL && CONTROL.value !== null && CONTROL.value !== undefined) {
      this.solicitud32605Store.establecerDatos({ [campo]: CONTROL.value });
    }
  }
    /**
