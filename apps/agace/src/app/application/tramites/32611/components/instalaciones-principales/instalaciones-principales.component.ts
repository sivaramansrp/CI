...
export class InstalacionesPrincipalesComponent implements OnInit, OnDestroy {
  ...
  /**
   * Inicializa el formulario `instalacionesPrincipalesForm` con los datos del estado actual `solicitud32611State`.
   *
  ...
  inicializarFormulario(): void {
    this.instalacionesPrincipalesForm = this.fb.group({
      principales: [
        this.solicitud32611State.principales,
        [Validators.required],
      ],
      municipio: [this.solicitud32611State.municipio],
      tipoDeInstalacion: [
        this.solicitud32611State.tipoDeInstalacion,
        [Validators.required],
      ],
      entidadFederativa: [this.solicitud32611State.entidadFederativa],
      registroSESAT: [this.solicitud32611State.entidadFederativa],
      descripcion: [this.solicitud32611State.descripcion],
      codigoPostal: [this.solicitud32611State.codigoPostal],
      procesoProductivo: [
        this.solicitud32611State.procesoProductivo,
        [Validators.required],
      ],
      goceDelInmueble: [
        this.solicitud32611State.goceDelInmueble,
        [Validators.required],
      ],
      empresa: [this.solicitud32611State.empresa],
      comercioExterior: [
        this.solicitud32611State.comercioExterior,
        [Validators.required],
      ],
      mutuo: [this.solicitud32611State.mutuo, [Validators.required]],
    });
      ...
      .pipe(
        ...
        map((respuesta: Solicitud32611State) => {
          ...
          this.instalacionesPrincipalesForm.patchValue({
            principales: this.solicitud32611State.principales,
            municipio: this.solicitud32611State.municipio,
            tipoDeInstalacion: this.solicitud32611State.tipoDeInstalacion,
            entidadFederativa: this.solicitud32611State.entidadFederativa,
            registroSESAT: this.solicitud32611State.registroSESAT,
            descripcion: this.solicitud32611State.descripcion,
            codigoPostal: this.solicitud32611State.codigoPostal,
            procesoProductivo: this.solicitud32611State.procesoProductivo,
            goceDelInmueble: this.solicitud32611State.goceDelInmueble,
            empresa: this.solicitud32611State.empresa,
            comercioExterior: this.solicitud32611State.comercioExterior,
            mutuo: this.solicitud32611State.mutuo,
          });
        })
      )
      .subscribe();
  ...
  actualizarPrincipales(valor: string | number): void {
    this.solicitud32611Store.actualizarPrincipales(valor);
  }
  ...
  actualizarMunicipio(valor: Event): void {
    ...
    this.solicitud32611Store.actualizarMunicipio(VALOR);
  }
  ...
  actualizarTipoDeInstalacion(evento: Catalogo): void {
    this.solicitud32611Store.actualizarTipoDeInstalacion(evento.id);
  }
  ...
  actualizarEntidadFederativa(valor: Event): void {
    const VALOR = (valor.target as HTMLInputElement).value;
    this.solicitud32611Store.actualizarEntidadFederativa(VALOR);
  }
  ...
  actualizarRegistroSESAT(valor: Event): void {
    const VALOR = (valor.target as HTMLInputElement).value;
    this.solicitud32611Store.actualizarRegistroSESAT(VALOR);
  }
  ...
  actualizarDescripcion(valor: Event): void {
    const VALOR = (valor.target as HTMLInputElement).value;
    this.solicitud32611Store.actualizarDescripcion(VALOR);
  }
  ...
  actualizarCodigoPostal(valor: Event): void {
    const VALOR = (valor.target as HTMLInputElement).value;
    this.solicitud32611Store.actualizarCodigoPostal(VALOR);
  }
  ...
  actualizarProcesoProductivo(valor: string | number): void {
    this.solicitud32611Store.actualizarProcesoProductivo(valor);
  }
  ...
  actualizarGoceDelInmueble(valor: string | number): void {
    this.solicitud32611Store.actualizarGoceDelInmueble(valor);
  }
  ...
  actualizarEmpresa(valor: string | number): void {
    this.solicitud32611Store.actualizarEmpresa(valor);
  }
  ...
  actualizarComercioExterior(valor: string | number): void {
    this.solicitud32611Store.actualizarComercioExterior(valor);
  }
  ...
  actualizarMutuo(valor: string | number): void {
    this.solicitud32611Store.actualizarMutuo(valor);
  }
