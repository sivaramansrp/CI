...
export class SeccionSubcontratadosComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    /** Store para gestionar el estado de la solicitud 32611 */
    public solicitud32611Store: Solicitud32611Store,

    /** Query para obtener datos del store de solicitud 32611 */
    ...
    this.solicitud32611Query.selectSolicitud$
      .pipe(
        ...
        map((respuesta: Solicitud32611State) => {
          this.solicitud32611State = respuesta; // Asigna el estado a la variable
          this.subcontratadosForm.patchValue({
            subcontrataRFCBusqueda:
              this.solicitud32611State.subcontrataRFCBusqueda,
            subcontrataRFC: this.solicitud32611State.subcontrataRFC,
            subcontrataRazonSocial:
              this.solicitud32611State.subcontrataRazonSocial,
            subcontrataEmpleados: this.solicitud32611State.subcontrataEmpleados,
            subcontrataBimestre: this.solicitud32611State.subcontrataBimestre,
          });
        })
      )
      .subscribe();
    ...
    this.solicitudService
      ...
      .subscribe({
        next: (respuesta: SeccionSubcontratados) => {
          ...
          this.solicitud32611Store.actualizarSubcontrataRFC(
            respuesta.subcontrataRFC
          );
          this.solicitud32611Store.actualizarSubcontrataRazonSocial(
