...
describe('TercerosRelacionadosComponent', () => {
  ...
  beforeEach(async () => {
    ...
    } as unknown as jest.Mocked<Solicitud32611Query>;
    ...
    solicitud32611QueryMock.selectSolicitud$ = of({
      idPersonaSolicitud: 'test',
      rfcTercero: 'test',
      rfc: 'test',
      nombre: 'test',
  ...
  it('should update store on actualizarRfcTercero', () => {
    ...
    expect(solicitud32611StoreMock.actualizarRfcTercero).toHaveBeenCalledWith(
      'RFC789'
    );
  });
  ...
  it('should update store on actualizarTelefono', () => {
    ...
    expect(solicitud32611StoreMock.actualizarTelefono).toHaveBeenCalledWith(
      '9876543210'
    );
  });
  ...
  it('should update store on actualizarCorreoElectronico', () => {
    ...
    expect(
      solicitud32611StoreMock.actualizarCorreoElectronico
  ...
  it('should add a new enlace operativo and pedimento, open modal, and update store when agregarEnlaceOperativo is called', () => {
    ...
    const actualizarEnlaceOperativosListaSpy = jest.spyOn(solicitud32611StoreMock, 'actualizarEnlaceOperativosLista');
  ...
  it('should not call store update methods if rfcTercero does not exist in buscarTerceroNacionalIDC', () => {
    ...
    expect(solicitud32611StoreMock.actualizarRfc).not.toHaveBeenCalled();
    expect(solicitud32611StoreMock.actualizarNombre).not.toHaveBeenCalled();
    expect(solicitud32611StoreMock.actualizarApellidoPaterno).not.toHaveBeenCalled();
    expect(solicitud32611StoreMock.actualizarApellidoMaterno).not.toHaveBeenCalled();
    expect(solicitud32611StoreMock.actualizarTelefono).not.toHaveBeenCalled();
    expect(solicitud32611StoreMock.actualizarCorreoElectronico).not.toHaveBeenCalled();
  });
