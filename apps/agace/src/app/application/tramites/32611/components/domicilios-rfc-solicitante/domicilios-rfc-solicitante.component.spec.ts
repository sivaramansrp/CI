...
describe('DomiciliosRfcSolicitanteComponent', () => {
  ...
  describe('Obtención de catálogos', () => {
    ...
    it('debería cargar catálogos de domicilios y tipos de instalación', () => {
      ...
      expect(mockSolocitud32611Service.getDomiciliosRegistrados).toHaveBeenCalled();
      expect(mockSolocitud32611Service.getTipoInstalacion).toHaveBeenCalled();
    ...
    it('debería manejar errores al obtener catálogos', () => {
      ...
      mockSolocitud32611Service.getDomiciliosRegistrados.mockReturnValue(throwError(() => error));
