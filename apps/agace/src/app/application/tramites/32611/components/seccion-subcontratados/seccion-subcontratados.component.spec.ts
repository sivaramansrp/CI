...
describe('SeccionSubcontratadosComponent', () => {
  ...
  it('should update store on actualizarSubcontrataRFCBusqueda', () => {
    ...
    expect(
      solicitud32611StoreMock.actualizarSubcontrataRFCBusqueda
  ...
  it('should update store on actualizarSubcontrataRFC', () => {
    ...
    expect(
      solicitud32611StoreMock.actualizarSubcontrataRFC
  ...
  it('should update store on actualizarSubcontrataRazonSocial', () => {
    ...
    expect(
      solicitud32611StoreMock.actualizarSubcontrataRazonSocial
  ...
  it('should update store on actualizarSubcontrataEmpleados', () => {
    ...
    expect(
      solicitud32611StoreMock.actualizarSubcontrataEmpleados
    ).toHaveBeenCalledWith('20');
  });

  it('should update store on actualizarSubcontrataBimestre', () => {
    solicitud32611StoreMock.actualizarSubcontrataBimestre(2);
    expect(
      solicitud32611StoreMock.actualizarSubcontrataBimestre
    ).toHaveBeenCalledWith(2);
  });

  it('should update store on actualizarCatseleccionados', () => {
    solicitud32611StoreMock.actualizarCatseleccionados = jest.fn();
    const catalogo: Catalogo = { id: 5 } as Catalogo;
    solicitud32611StoreMock.actualizarCatseleccionados(catalogo.id);
    expect(solicitud32611StoreMock.actualizarCatseleccionados).toHaveBeenCalledWith(5);
  });

  it('should update store on actualizarServicio', () => {
    solicitud32611StoreMock.actualizarServicio = jest.fn();
    const catalogo: Catalogo = { id: 7 } as Catalogo;
    solicitud32611StoreMock.actualizarServicio(catalogo.id);
    expect(solicitud32611StoreMock.actualizarServicio).toHaveBeenCalledWith(7);
  });

  it('should update store on actualizar190', () => {
    solicitud32611StoreMock.actualizar190 = jest.fn();
    solicitud32611StoreMock.actualizar190('valor190');
    expect(solicitud32611StoreMock.actualizar190).toHaveBeenCalledWith('valor190');
    solicitud32611StoreMock.actualizar190(190);
    expect(solicitud32611StoreMock.actualizar190).toHaveBeenCalledWith(190);
  });

  it('should update store on actualizar191', () => {
    solicitud32611StoreMock.actualizar191 = jest.fn();
    solicitud32611StoreMock.actualizar191('valor191');
    expect(solicitud32611StoreMock.actualizar191).toHaveBeenCalledWith('valor191');
    solicitud32611StoreMock.actualizar191(191);
    expect(solicitud32611StoreMock.actualizar191).toHaveBeenCalledWith(191);
  });

  it('should update store on actualizar199', () => {
    solicitud32611StoreMock.actualizar199 = jest.fn();
    solicitud32611StoreMock.actualizar199('valor199');
    expect(solicitud32611StoreMock.actualizar199).toHaveBeenCalledWith('valor199');
    solicitud32611StoreMock.actualizar199(199);
    expect(solicitud32611StoreMock.actualizar199).toHaveBeenCalledWith(199);
  });

  it('should update store on actualizarEmpleados', () => {
    solicitud32611StoreMock.actualizarEmpleados = jest.fn();
    const event = { target: { value: '33' } } as unknown as Event;
    const value = (event.target as HTMLInputElement | null)?.value;
    solicitud32611StoreMock.actualizarEmpleados(value);
    expect(solicitud32611StoreMock.actualizarEmpleados).toHaveBeenCalledWith('33');
  });

  it('should update store on actualizarBimestre', () => {
    solicitud32611StoreMock.actualizarBimestre = jest.fn();
    const catalogo: Catalogo = { id: 2 } as Catalogo;
    solicitud32611StoreMock.actualizarBimestre(catalogo.id);
    expect(solicitud32611StoreMock.actualizarBimestre).toHaveBeenCalledWith(2);
  });

  it('should update store on actualizar2034', () => {
    solicitud32611StoreMock.actualizar2034 = jest.fn();
    solicitud32611StoreMock.actualizar2034('valor2034');
    expect(solicitud32611StoreMock.actualizar2034).toHaveBeenCalledWith('valor2034');
    solicitud32611StoreMock.actualizar2034(2034);
    expect(solicitud32611StoreMock.actualizar2034).toHaveBeenCalledWith(2034);
  });

  it('should update store on actualizar236', () => {
    solicitud32611StoreMock.actualizar236 = jest.fn();
    solicitud32611StoreMock.actualizar236('valor236');
    expect(solicitud32611StoreMock.actualizar236).toHaveBeenCalledWith('valor236');
    solicitud32611StoreMock.actualizar236(236);
    expect(solicitud32611StoreMock.actualizar236).toHaveBeenCalledWith(236);
  });

  it('should update store on actualizar237', () => {
    solicitud32611StoreMock.actualizar237 = jest.fn();
    solicitud32611StoreMock.actualizar237('valor237');
    expect(solicitud32611StoreMock.actualizar237).toHaveBeenCalledWith('valor237');
    solicitud32611StoreMock.actualizar237(237);
