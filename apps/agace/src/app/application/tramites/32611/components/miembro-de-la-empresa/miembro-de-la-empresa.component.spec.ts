...
describe('MiembroDeLaEmpresaComponent', () => {
  ...
  let solicitud32611Store: Solicitud32611Store;
  let solicitud32611Query: Solicitud32611Query;
  ...
  beforeEach(async () => {
    ...
    solicitud32611Store = TestBed.inject(Solicitud32611Store);
    solicitud32611Query = TestBed.inject(Solicitud32611Query);
  ...
  it('should call actualizarMiembroCaracterDe with correct value', () => {
    const spy = jest.spyOn(solicitud32611Store, 'actualizarMiembroCaracterDe');
  ...
  it('should call actualizarMiembroRFC with correct value', () => {
    const spy = jest.spyOn(solicitud32611Store, 'actualizarMiembroRFC');
  ...
  it('should call actualizarMiembroTipoPersonaMuestra with correct value and set seleccionarTipoDePersona', () => {
    const spy = jest.spyOn(solicitud32611Store, 'actualizarMiembroTipoPersonaMuestra');
  ...
  it('should call actualizarMiembroNombre with correct value', () => {
    const spy = jest.spyOn(solicitud32611Store, 'actualizarMiembroNombre');
  ...
  it('should call actualizarMiembroApellidoPaterno with correct value', () => {
    const spy = jest.spyOn(solicitud32611Store, 'actualizarMiembroApellidoPaterno');
  ...
  it('should call actualizarMiembroApellidoMaterno with correct value', () => {
    const spy = jest.spyOn(solicitud32611Store, 'actualizarMiembroApellidoMaterno');
  ...
  it('should call actualizarMiembroNombreEmpresa with correct value', () => {
    const spy = jest.spyOn(solicitud32611Store, 'actualizarMiembroNombreEmpresa');
