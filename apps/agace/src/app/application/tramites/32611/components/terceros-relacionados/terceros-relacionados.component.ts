...
export class TercerosRelacionadosComponent implements OnInit, OnDestroy {
   ...
   * @param solicitud32611Store Almacena el estado de la solicitud
   * @param solicitud32611Query Consulta el estado de la solicitud
   */
  constructor(
  ...
  inicializarFormulario(): void {
    this.tercerosRelacionadosForm = this.fb.group({
      idPersonaSolicitud: [this.solicitud32611State.idPersonaSolicitud],
      rfcTercero: [this.solicitud32611State.rfcTercero, [Validators.required]],
      rfc: [{ value: this.solicitud32611State.rfc, disabled: true }],
      nombre: [{ value: this.solicitud32611State.nombre, disabled: true }],
      apellidoPaterno: [
      ...
      telefono: [this.solicitud32611State.telefono, [Validators.required]],
      correoElectronico: [
      ...
      .pipe(
        ...
        map((respuesta: Solicitud32611State) => {
          ...
          this.tercerosRelacionadosForm.patchValue({
            idPersonaSolicitud: this.solicitud32611State.idPersonaSolicitud,
            rfcTercero: this.solicitud32611State.rfcTercero,
            rfc: this.solicitud32611State.rfc,
            nombre: this.solicitud32611State.nombre,
            apellidoPaterno: this.solicitud32611State.apellidoPaterno,
            apellidoMaterno: this.solicitud32611State.apellidoMaterno,
            telefono: this.solicitud32611State.telefono,
            correoElectronico: this.solicitud32611State.correoElectronico,
          });
          this.enlaceOperativosLista =
            this.solicitud32611State.enlaceOperativosLista;
        })
      )
      .subscribe();
  }
    ...
    if (this.tercerosRelacionadosForm.get('rfcTercero')?.value) {
      this.solicitudService
        ...
        .subscribe((respuesta: RepresentanteLegal) => {
          this.solicitud32611Store.actualizarRfc(respuesta.rfc);
          this.solicitud32611Store.actualizarNombre(respuesta.nombre);
          this.solicitud32611Store.actualizarApellidoPaterno(
            respuesta.apellidoPaterno
          );
          this.solicitud32611Store.actualizarApellidoMaterno(
            respuesta.apellidoMaterno
          );
          this.solicitud32611Store.actualizarTelefono(respuesta.telefono);
          this.solicitud32611Store.actualizarCorreoElectronico(
  ...
  agregarEnlaceOperativo(evento: EnlaceOperativo): void {
    ...
    this.solicitud32611Store.actualizarEnlaceOperativosLista(
      this.enlaceOperativosLista
    );
  }
