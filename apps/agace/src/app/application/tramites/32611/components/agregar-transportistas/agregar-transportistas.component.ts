...
export class AgregarTransportistasComponent implements OnInit, OnDestroy {
  ...
  inicializarFormulario(): void {
    this.transportistaCertificacionForm = this.fb.group({
      transportistaRFC: [
        this.solicitud32611State.transportistaRFC,
        [Validators.required, Validators.maxLength(13)],
      ],
      transportistaRFCModifTrans: [
        {
          value: this.solicitud32611State.transportistaRFCModifTrans,
          disabled: true,
        },
      ...
      transportistaRazonSocial: [
        {
          value: this.solicitud32611State.transportistaRazonSocial,
          disabled: true,
        },
      ...
      transportistaDomicilio: [
        {
          value: this.solicitud32611State.transportistaDomicilio,
          disabled: true,
        },
        [Validators.maxLength(300)],
      ],
      transportistaCaat: [
        { value: this.solicitud32611State.transportistaCaat, disabled: true },
        [Validators.maxLength(254)],
      ],
      transportistaIdDomicilio: [
        this.solicitud32611State.transportistaIdDomicilio,
      ],
      transportistaIdRFC: [this.solicitud32611State.transportistaIdRFC],
      transportistaIdRazonSocial: [
        this.solicitud32611State.transportistaIdRazonSocial,
      ],
      transportistaIdCaat: [this.solicitud32611State.transportistaIdCaat],
    });
  ...
  actualizarTransportistaRFC(evento: Event): void {
    ...
    this.solicitud32611Store.actualizarTransportistaRFC(VALOR);
  }
  ...
  actualizarTransportistaRFCModifTrans(evento: Event): void {
    const VALOR = (evento.target as HTMLInputElement).value;
    this.solicitud32611Store.actualizarTransportistaRFCModifTrans(VALOR);
  }
  ...
  actualizarTransportistaRazonSocial(evento: Event): void {
    const VALOR = (evento.target as HTMLInputElement).value;
    this.solicitud32611Store.actualizarTransportistaRazonSocial(VALOR);
  }
  ...
  actualizarTransportistaDomicilio(evento: Event): void {
    const VALOR = (evento.target as HTMLInputElement).value;
    this.solicitud32611Store.actualizarTransportistaDomicilio(VALOR);
  }
  ...
  actualizarTransportistaCaat(evento: Event): void {
    const VALOR = (evento.target as HTMLInputElement).value;
    this.solicitud32611Store.actualizarTransportistaCaat(VALOR);
  }
    ...
    this.solicitudService
      ...
      .subscribe({
        next: (respuesta: TransportistasTable[]) => {
          this.solicitud32611Store.actualizarTransportistaRazonSocial(
            respuesta[0].razonSocial
          );
          this.solicitud32611Store.actualizarTransportistaDomicilio(
            respuesta[0].domicilio
          );
          this.solicitud32611Store.actualizarTransportistaCaat(
            respuesta[0].caat
          );
        },
      });
