...
export class AgregarEnlaceOperativoComponent implements OnInit, OnDestroy {
   ...
   * @param solicitud32611Store - Store de Akita para el estado de la solicitud 32611.
   * @param solicitud32611Query - Consulta (query) de Akita para acceder al estado de la solicitud 32611.
   */
  constructor(
   ...
   * del estado `solicitud32611State`.
   *
  ...
  inicializarFormulario(): void {
    this.agregarEnlaceOperativoForm = this.fb.group({
      agregarEnlaceRfcTercero: [
        this.solicitud32611State.rfcTercero,
        [Validators.required],
      ],
      agregarEnlaceRfc: [
        { value: this.solicitud32611State.rfc, disabled: true },
      ],
      agregarEnlaceNombre: [
        { value: this.solicitud32611State.nombre, disabled: true },
      ],
      agregarEnlaceApellidoPaterno: [
        { value: this.solicitud32611State.apellidoPaterno, disabled: true },
      ],
      agregarEnlaceApellidoMaterno: [
        { value: this.solicitud32611State.apellidoMaterno, disabled: true },
      ],
      agregarEnlaceCiudadEstado: [
        {
          value: this.solicitud32611State.agregarEnlaceCiudadEstado,
          disabled: true,
        },
      ],
      agregarEnlaceCargo: [this.solicitud32611State.agregarEnlaceCargo],
      agregarEnlaceTelefono: [
        this.solicitud32611State.telefono,
        [Validators.required, Validators.pattern(REGEX_TELEFONO_DIGITOS)],
      ],
      agregarEnlaceCorreoElectronico: [
        this.solicitud32611State.correoElectronico,
        [Validators.required, Validators.email],
      ],
      agregarEnlaceSuplente: [this.solicitud32611State.agregarEnlaceSuplente],
    });
      ...
      .pipe(
        ...
        map((respuesta: Solicitud32611State) => {
          ...
          this.agregarEnlaceOperativoForm.patchValue({
            agregarEnlaceRfcTercero: this.solicitud32611State.rfcTercero,
            agregarEnlaceRfc: this.solicitud32611State.rfc,
            agregarEnlaceNombre: this.solicitud32611State.nombre,
            agregarEnlaceApellidoPaterno:
              this.solicitud32611State.apellidoPaterno,
            agregarEnlaceApellidoMaterno:
              this.solicitud32611State.apellidoMaterno,
            agregarEnlaceCiudadEstado:
              this.solicitud32611State.agregarEnlaceCiudadEstado,
            agregarEnlaceCargo: this.solicitud32611State.agregarEnlaceCargo,
            agregarEnlaceTelefono: this.solicitud32611State.telefono,
            agregarEnlaceCorreoElectronico:
              this.solicitud32611State.correoElectronico,
            agregarEnlaceSuplente:
              this.solicitud32611State.agregarEnlaceSuplente,
          });
        })
      )
      .subscribe();
    ...
    if (this.agregarEnlaceOperativoForm.get('rfcTercero')?.value) {
      this.solicitudService
        ...
        .subscribe((respuesta: RepresentanteLegal) => {
          this.solicitud32611Store.actualizarEnlaceRfc(respuesta.rfc);
          this.solicitud32611Store.actualizarEnlaceNombre(respuesta.nombre);
          this.solicitud32611Store.actualizarEnlaceApellidoPaterno(
            respuesta.apellidoPaterno
          );
          this.solicitud32611Store.actualizarEnlaceApellidoMaterno(
            respuesta.apellidoMaterno
          );
          this.solicitud32611Store.actualizarEnlaceTelefono(respuesta.telefono);
          this.solicitud32611Store.actualizarEnlaceCorreoElectronico(
  ...
  actualizarEnlaceSuplente(evento: Event): void {
    ...
    this.solicitud32611Store.actualizarEnlaceSuplente(VALOR);
  }
