...
export class MiembroDeLaEmpresaComponent implements OnInit, OnDestroy {
  ...
  /** Estado actual de la solicitud 32611 */
  ...
  constructor(
    ...
    public solicitud32611Store: Solicitud32611Store, // /** Estado de la solicitud */
    public solicitud32611Query: Solicitud32611Query, // /** Consultas sobre la solicitud */
  ...
  /**
   * Inicializa el formulario `miembroEmpresaForm` con los datos del estado actual `solicitud32611State`.
   *
  ...
  inicializarFormulario(): void {
    this.miembroEmpresaForm = this.fb.group({
      ...
      miembroCaracterDe: [
        { value: this.solicitud32611State.miembroCaracterDe, disabled: false },
        [Validators.required],
      ],
      /** Indica si el miembro está obligado a tributar en México */
      miembroTributarMexico: [
        {
          value: this.solicitud32611State.miembroTributarMexico,
          disabled: false,
        },
        [Validators.required],
      ],
      ...
      miembroNacionalidad: [
        {
          value: this.solicitud32611State.miembroNacionalidad,
          disabled: false,
        },
        [Validators.required],
      ],
      /** RFC del miembro */
      miembroRfc: [
        { value: this.solicitud32611State.miembroRfc, disabled: false },
        [Validators.required],
      ],
      /** Registro federal del miembro */
      miembroRegistroFederal: [
        {
          value: this.solicitud32611State.miembroRegistroFederal,
          disabled: true,
        },
        [Validators.required],
      ],
      ...
      miembroNombreCompleto: [
        {
          value: this.solicitud32611State.miembroNombreCompleto,
          disabled: true,
        },
        [Validators.required],
      ],
      ...
      miembroTipoPersonaMuestra: [
        {
          value: this.solicitud32611State.miembroTipoPersonaMuestra,
          disabled: false,
        },
        [Validators.required],
      ],
      /** Nombre del miembro */
      miembroNombre: [
        { value: this.solicitud32611State.miembroNombre, disabled: false },
        [Validators.required],
      ],
      /** Apellido paterno del miembro */
      miembroApellidoPaterno: [
        {
          value: this.solicitud32611State.miembroApellidoPaterno,
          disabled: false,
        },
        [Validators.required],
      ],
      ...
      miembroApellidoMaterno: [
        {
          value: this.solicitud32611State.miembroApellidoMaterno,
          disabled: false,
        },
        [Validators.required],
      ],
      ...
      miembroNombreEmpresa: [
        {
          value: this.solicitud32611State.miembroNombreEmpresa,
          disabled: false,
        },
        [Validators.required],
      ],
      ...
      .pipe(
        ...
        map((respuesta: Solicitud32611State) => {
          ...
          this.miembroEmpresaForm.patchValue({
            miembroCaracterDe: this.solicitud32611State.miembroCaracterDe,
            miembroTributarMexico:
              this.solicitud32611State.miembroTributarMexico,
            miembroNacionalidad: this.solicitud32611State.miembroNacionalidad,
            miembroRfc: this.solicitud32611State.miembroRfc,
            miembroRegistroFederal:
              this.solicitud32611State.miembroRegistroFederal,
            miembroNombreCompleto:
              this.solicitud32611State.miembroNombreCompleto,
            miembroTipoPersonaMuestra:
              this.solicitud32611State.miembroTipoPersonaMuestra,
            miembroNombre: this.solicitud32611State.miembroNombre,
            miembroApellidoPaterno:
              this.solicitud32611State.miembroApellidoPaterno,
            miembroApellidoMaterno:
              this.solicitud32611State.miembroApellidoMaterno,
            miembroNombreEmpresa: this.solicitud32611State.miembroNombreEmpresa,
          });
        })
      )
      .subscribe();
  ...
  actualizarMiembroCaracterDe(evento: Catalogo): void {
    this.solicitud32611Store.actualizarMiembroCaracterDe(evento.id);
  }
  ...
  actualizarMiembroTributarMexico(evento: number | string): void {
    ...
    this.solicitud32611Store.actualizarMiembroTributarMexico(evento);
  }
  ...
  actualizarMiembroNacionalidad(evento: Catalogo): void {
    this.solicitud32611Store.actualizarMiembroNacionalidad(evento.id);
  }
  ...
  actualizarMiembroRFC(evento: Event): void {
    ...
    this.solicitud32611Store.actualizarMiembroRFC(VALOR);
  }
  ...
  actualizarMiembroTipoPersonaMuestra(evento: Catalogo): void {
    this.solicitud32611Store.actualizarMiembroTipoPersonaMuestra(evento.id);
  ...
  actualizarMiembroNombre(evento: Event): void {
    const VALOR = (evento.target as HTMLInputElement).value;
    this.solicitud32611Store.actualizarMiembroNombre(VALOR);
  }
  ...
  actualizarMiembroApellidoPaterno(evento: Event): void {
    const VALOR = (evento.target as HTMLInputElement).value;
    this.solicitud32611Store.actualizarMiembroApellidoPaterno(VALOR);
  }
  ...
  actualizarMiembroApellidoMaterno(evento: Event): void {
    const VALOR = (evento.target as HTMLInputElement).value;
    this.solicitud32611Store.actualizarMiembroApellidoMaterno(VALOR);
  }
  ...
  actualizarMiembroNombreEmpresa(evento: Event): void {
    const VALOR = (evento.target as HTMLInputElement).value;
    this.solicitud32611Store.actualizarMiembroNombreEmpresa(VALOR);
  }
  ...
  buscarRFCDatos(): void {
    ...
    if (VALOR) {
      this.solicitud32611Store.actualizarMiembroRegistroFederal(
        'MAVL621207C95'
      );
      this.solicitud32611Store.actualizarMiembroNombreCompleto(
