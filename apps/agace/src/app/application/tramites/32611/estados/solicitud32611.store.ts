import { AgregarMiembroEmpresaTabla, ControlInventariosTabla, DomiciliosRfcSolicitanteTabla, EmpresaDelGrupo, NumeroEmpleadosTabla, TransportistasTable } from '../models/oea-textil-registro.model';
...
representanteRegistro: string;
  ...
  /**
   * Valor asociado al código autotransporteDosAnios.
   */
  autotransporteDosAnios: number | string;
/**
   * Valor asociado al código numeroRegistroCAAT.
   */
  numeroRegistroCAAT: string;
   /**
   * Valor asociado al código permisoVigenteSCT.
   */
  permisoVigenteSCT: number | string;

   /**
   * Valor asociado al código numeroUnidadesPropias.
   */
  numeroUnidadesPropias: string;

  /**
   * Valor asociado al código numeroUnidadesArrendadas.
   */
  numeroUnidadesArrendadas: string;

  /**
   * Valor asociado al código reconocimientoMuto.
   */
  reconocimientoMuto: number | string;

  /**
   * Valor asociado al código socioComercialRFCListado.
   */ 
  socioComercialRFCListado: number | string;
  /**
   * Valor asociado al código socioComercialNombre.
   */
  socioComercialNombre: number | string;

  /**
   * Valor asociado al código direccionFiscal.
   */
  direccionFiscal: number | string;

  /**
   * Página electrónica asociada a la solicitud.
   */
  paginaElectronica: number | string;

  /**
   * URL de la página electrónica asociada a la solicitud.
   */
  paginaElectronicaURL: string;
  /**
   * Valor asociado al código correoElectronicoContacto.
   */
  correoElectronicoContacto: number | string;
  /**
   * Correo electrónico de contacto asociado a la solicitud.
   */
  correoElectronicoContactoEmail: string;

  /**
   * Teléfono de contacto asociado a la solicitud.
   */
  telefonoContacto: string;


  /**
   * Valor asociado al código clasificacionInformacionEmpresa.
   */
 clasificacionInformacionEmpresa: number | string;

   /**
   * Valor asociado al código llave.
   */
 llave: string;
  ...
  /**
   * Lada del primer teléfono asociado a la solicitud.
   */
  lada1: string;

  /**
   * Lada del segundo teléfono asociado a la solicitud.
   */
  lada2: string;

  /**
   * Lada del tercer teléfono asociado a la solicitud.
   */
  lada3: string;

  /**
   * Teléfono del primer contacto asociado a la solicitud.
   */
  telefono1: string;

  /**
   * Teléfono del segundo contacto asociado a la solicitud.
   */
  telefono2: string;

  /**
   * Teléfono del tercer contacto asociado a la solicitud.
   */
  telefono3: string;

  /**
   * Banco asociado a la solicitud.
   */
  banco: string;
  ...
  /**
   * Fecha de vigencia asociada a la solicitud.
   */
  fechaVigencia: string;

  /**
   * Valor asociado al código sistemasRastreo.
   */
  sistemasRastreo: string | number;

/**
   * Valor asociado al código seguridadPerfilTransportista.
   */
 seguridadPerfilTransportista: string | number;
  /**
  ...
  /**
   * Valor asociado con el código cumplimiento (puede ser un número o una cadena).
   */
  cumplimiento: string | number;

  /**
   * Valor asociado con el código autorizacion (puede ser un número o una cadena).
   */
  autorizacion: string | number;

  /**
   * Valor asociado con el código retencionIsr (puede ser un número o una cadena).
   */
  retencionIsr: string | number;

 /**
   * Valor asociado con el código subcontratacion (puede ser un número o una cadena).
   */
  subcontratacion: string | number;
 /**
   * Valor asociado con el código cuotasPatronales (puede ser un número o una cadena).
   */
  cuotasPatronales: string | number;

  /**
   * Valor asociado con el código registroLft (puede ser un número o una cadena).
   */
  registroLft: string | number;

    /**
   * Valor asociado con el código registroLft (puede ser un número o una cadena).
   */
  listadoSatArticulo69B : string | number;

  /**
   * Valor asociado con el código 192 (puede ser un número o una cadena).
   */
  '192': string | number;

  /**
   * Valor asociado con el código 193 (puede ser un número o una cadena).
   */
  '193': string | number;

  /**
   * Valor asociado con el código 194 (puede ser un número o una cadena).
   */
  '194': string | number;

  /**
   * Valor asociado con el código empleadosImss (puede ser un número o una cadena).
   */
  empleadosImss: string | number;
  ...
  /**
   * Valor asociado con el código enListadoSAT  (puede ser un número o una cadena).
   */
  enListadoSAT: string | number;

  /**
   * Valor asociado con el código enListadoSAT  (puede ser un número o una cadena).
   */
  articulo69BBis: string | number;

   /**
   * Valor asociado con el código infraccionArticulo17HBis  (puede ser un número o una cadena).
   */
  infraccionArticulo17HBis: string | number;

  /**
   * Valor asociado con el código enListadoSAT  (puede ser un número o una cadena).
   */
  certificadosVigentes: string | number;
  ...
  /**
   * Valor asociado con el código mediosContactoBuzonTributario (puede ser un número o una cadena).
   */
mediosContactoBuzonTributario: string | number;
   ...
   */
  denunciaPenalSAT: string | number;
   ...
   */
  informacionContableMensualSAT: string | number;

  /**
   * Valor asociado con el código 251 (puede ser un número o una cadena).
   */
 sociosEmpresasCanceladas: string | number;
...
export function createInitialSolicitudState(): Solicitud32611State {
  ...
  suspensionCancelacionCBP: '',
    ...
    permisoVigenteSCT: 0,
    numeroRegistroCAAT:'3CID',
    numeroUnidadesPropias:'',
    numeroUnidadesArrendadas: '',
    clasificacionInformacionEmpresa: 0,
    llave: '',
    ...
    reconocimientoMuto: 0,
    socioComercialRFCListado: 0,
    socioComercialNombre: 0,
    direccionFiscal: 0,
    paginaElectronica: 0,
    paginaElectronicaURL: '',
    correoElectronicoContacto: 0,
    ...
    infraccionArticulo17HBis: 0,
    '243': 0,
    '244': 0,
    '245': 0,
    indiqueTodos: 0,
    mediosContactoBuzonTributario: 0,
    file1: '',
    file2: '',
    '247': 0,
    denunciaPenalSAT: 0,
    ...
    lugarDeRadicacion: '',
    '249': 0,
     informacionContableMensualSAT: 0,
    sociosEmpresasCanceladas: 0,
    checkbox1: false,
    checkbox2: false,
    checkbox3: false,
    actualmente2: '',
...
export class Solicitud32611Store extends Store<Solicitud32611State> {
  ...
  /**
   * Actualiza el valor del campo `cumplimiento` en el estado.
   *
   * @param valor - El nuevo valor para el campo `cumplimiento`.
   */
  // actualizar190(valor: string | number): void {
  //   this.update((state) => ({ ...state, 'cumplimiento': valor }));
  // }

  /**
   * Actualiza el valor del campo `autorizacion` en el estado.
   *
   * @param valor - El nuevo valor para el campo `autorizacion`.
   */
  // actualizar191(valor: string | number): void {
  //   this.update((state) => ({ ...state, 'autorizacion': valor }));
  // }

  /**
   * Actualiza el valor del campo `empleadosImss` en el estado.
   *
   * @param valor - El nuevo valor para el campo `empleadosImss`.
   */
  // actualizar199(valor: string | number): void {
  //   this.update((state) => ({ ...state, 'empleadosImss': valor }));
  // }
  ...
  /**
   * Actualiza el valor del campo `enListadoSAT ` en el estado.
   *
   * @param valor - El nuevo valor para el campo `enListadoSAT `.
   */
  actualizarenListadoSAT (valor: string | number): void {
    this.update((state) => ({ ...state, 'enListadoSAT ': valor }));
  }
   ...
   */
  // actualizar(valor: string | number): void {
 ...
 *
 * @param {Partial<Solicitud32611State>} values - Objeto que contiene las propiedades a actualizar en el estado.
 *
 * @example
 * // Ejemplo de uso:
 ...
 * @returns {void}
 */
public establecerDatos(values: Partial<Solicitud32611State>): void {  
  this.update((state) => ({
    ...state,
    ...values,
  }));
