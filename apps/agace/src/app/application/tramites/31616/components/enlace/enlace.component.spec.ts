...
import { Tramite31616TercerosStore } from '../../../../estados/tramites/tramite31616_terceros.store';

describe('EnlaceComponent', () => {
  let component: EnlaceComponent;
  let fixture: ComponentFixture<EnlaceComponent>;
  let tramite31616QueryMock: Partial<Tramite31616TercerosQuery>;
  let tramite31616StoreMock: Partial<Tramite31616TercerosStore>;

  beforeEach(async () => {
    tramite31616QueryMock = {
      selectSolicitud$: of({
        resigtro: '12345',
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        FormBuilder,
        { provide: Tramite31616TercerosQuery, useValue: tramite31616QueryMock },
        { provide: Tramite31616TercerosStore, useValue: tramite31616StoreMock },
      ],
    }).compileComponents();
  ...
  it('should set values in the store', () => {
    ...
    expect(tramite31616StoreMock.setResigtroFedral).toHaveBeenCalledWith('67890');
  });
