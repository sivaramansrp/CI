 ...
 */
export const TEXTOS_ESTATICOS_PLANEACION = {
    paraca1: 'La empresa de mensajería y paquetería debe elaborar políticas y procedimientos documentados para llevar a cabo un análisis que le permita la identificación de riesgos y debilidades en su cadena de suministros con el objetivo de que la alta dirección de la empresa implemente estrategias que ayuden a mitigar el riesgo en las operaciones de su organización.Asimismo, para construir un programa sólido de seguridad de la cadena de suministros, la empresa debe de contar con un Comité de Seguridad que incorpore representantes de todos los departamentos relevantes, formando un equipo multifuncional que identifique áreas de oportunidad y proponga acciones de mejora continua a lo largo de la cadena de suministros e instalaciones de la compañía.',
    encabezamiento1: '1.1 Análisis de riesgo',
    paraca2: 'La empresa de mensajería y paquetería debe establecer medidas para identificar, analizar y mitigar los riesgos de seguridad que podrían derivar en alteraciones de mercancía de comercio exterior durante su manejo, guardado, custodia y traslado en su cadena de suministro y sus instalaciones, bajo el lineamiento de un procedimiento documentado. Dicho análisis debe estar basado en el modelo de su organización (ejemplo: ubicaciones de las instalaciones, tipo de actividad, volumen y país de destino de clientes, proveedores, rutas, tipo de información, características de personal, clasificación y manejo de documentos, Tecnologías de la Información, amenazas potenciales, etcétera) y debe realizarse periódicamente para implementar medidas de seguridad apropiadas.',
    paraca3: 'Anexe la matriz de riesgo, así como el procedimiento documentado para identificar riesgos en la cadena de suministro y las instalaciones de su empresa, asegúrese de incluir los siguientes puntos:',
    encabezamiento2: '1.2 Políticas de seguridad',
    paraca4: 'La empresa debe contar con una política orientada a prevenir, asegurar y reconocer amenazas en la seguridad de la cadena de suministros e instalaciones de la compañía, como lo son el tráfico de drogas, lavado de dinero, tráfico de armas, contrabando de personas, mercancías prohibidas y actos de terrorismo.',
    paraca5: 'Para promover una cultura de seguridad, las compañías deben demostrar su compromiso con la seguridad de la cadena de suministro y el Programa Operador Económico Autorizado a través de una declaración que resalte la importancia de proteger el flujo del comercio nacional e internacional de actividades delictivas, establecida por medio de la política de seguridad.',
    paraca6: 'Los altos funcionarios o directivos de la empresa que deben respaldar y firmar la política de seguridad, pueden ser el presidente de la compañía, el director ejecutivo, el gerente general o personal con cargo homólogo con facultad para toma de decisiones.',
    encabezamiento3: '1.3 Auditorías internas en la cadena de suministros',
    paraca7: 'Además del monitoreo de rutina en control y seguridad, es necesario programar y realizar auditorías periódicas, que permitan evaluar todos los procesos en materia de seguridad en la cadena de suministros de una manera más crítica y profunda, así como garantizar que sus empleados sigan los procedimientos de seguridad de la empresa. Las auditorías deben ser realizadas por el Comité de Seguridad de la compañía.',
    encabezamiento4: '1.4 Planes de contingencia y/o emergencia relacionados con la seguridad de la cadena de suministros',
    paraca8: 'Debe existir un plan de contingencia y/o emergencia documentado, dicho plan debe de abordar la gestión de crisis, los planes de recuperación de la seguridad y la reanudación del negocio para asegurar la continuidad del negocio en caso de afectación al desarrollo normal de las actividades y las operaciones de comercio exterior de la empresa en su cadena de suministro (durante el traslado, manejo, guardado y custodia de mercancía de comercio exterior conforme a su proceso logístico) Una crisis o contingencia puede incluir la interrupción del movimiento de datos comerciales debido a un ataque cibernético, un incendio, el secuestro de un conductor de transporte por personas armadas, cierre de aduanas, una amenaza de bomba, la detección de paquetes sospechosos, el corte de energía eléctrica, el robo y/o daño de mercancías, amenazas o extorsiones, bloqueos o cierre de carreteras, entre otros. La empresa de mensajería y paquetería deberá demostrar con personal autorizado los planes de contingencia y/o emergencia, así como realizar pruebas, ejercicios prácticos y simulacros anuales a dichos planes de contingencia y emergencia para constatar su efectividad, mismos de los que se deberá mantener un registro debidamente registrado y firmado (por ejemplo: reportes de resultados, análisis de lecciones aprendidas, grabaciones de videograbaciones, fotografías, etcétera, que demuestren su ejecución). El plan de contingencia y/o emergencia deberá actualizarse según sea necesario, en función de los cambios en las operaciones y el nivel de riesgo de la organización.'
  };
  
  /**
   * Constante que contiene los textos estáticos para la sección de seguridad física de instalaciones.
   * 
   * - `paraca1`: Requisitos para control de acceso a instalaciones.
   * - `encabezamiento1`: Título de la sección de instalaciones.
   * - `paraca2`: Especificaciones para construcción y mantenimiento.
   * - `etiqueta`: Solicitud para indicar materiales de construcción.
   * - `encabezamiento2`: Título de la sección de accesos.
   * - `encabezamiento3`: Título de la sección de bardas perimetrales.
   * - `paraca3`: Requisitos para bardas y barreras periféricas.
   * - `encabezamiento4`: Título de la sección de estacionamientos.
   * - `paraca4`: Normas para control de estacionamientos.
   * - `encabezamiento5`: Título de la sección de control de llaves.
   * - `paraca5`: Procedimientos para manejo de llaves y dispositivos.
   * - `paraca6`: Instrucciones para adjuntar procedimientos documentados.
   * - `encabezamiento6`: Título de la sección de alumbrado.
   * - `paraca7`: Requisitos para sistemas de iluminación.
   * - `paraca8`: Pregunta sobre verificación de iluminación.
   * - `encabezamiento7`: Título de la sección de comunicación.
   * - `paraca9`: Requisitos para sistemas de comunicación.
   * - `etiqueta2`: Pregunta sobre dispositivos de comunicación disponibles.
   * - `encabezamiento8`: Título de la sección de CCTV.
   * - `paraca10` a `paraca12`: Detalles sobre sistemas de CCTV.
  ...
  /**
   * Constante que contiene los textos estáticos para la sección de seguridad de la información.
   * 
   * - `paraca1`: Medidas para mantener confidencialidad e integridad de la información.
   * - `paraca2`: Requisitos para políticas de protección de sistemas de TI.
   * - `encabezamiento1`: Título de la sección de manejo de documentos.
   * - `paraca3`: Procedimientos para clasificación y manejo de documentos.
   * - `encabezamiento2`: Título de la sección de seguridad tecnológica.
   * - `paraca4`: Protección contra amenazas cibernéticas.
   * - `paraca5`: Requisitos para cuentas individuales y acceso remoto.
   * - `paraca6`: Procedimientos para protección de sistemas de TI.
   * - `paraca7`: Recuperación ante pérdida de datos.
   * - `paraca8`: Instrucciones para adjuntar procedimiento de recuperación.
   * - `paraca9` a `paraca12`: Detalles sobre protección de sistemas de TI.
