...
import { RespuestaTabla, InstalacionesPrincipalesRespuestaTabla, PersonaRespuestaTabla } from '@libs/shared/data-access-user/src/core/models/31616/dato-comunes.model';
...
describe('SolicitudDeRegistroInvocarService', () => {
  ...
  it('should fetch data for obtenerTablaDatos', () => {
    ...
    const req = httpMock.expectOne('assets/json/31616/mercancias-tabla.json');
  ...
  it('should fetch data for obtenerInstalacionesPrincipalesTablaDatos', () => {
    ...
    const req = httpMock.expectOne('assets/json/31616/instalacionesPrincipales-tabla.json');
    expect(req.request.method).toBe('GET');
    req.flush(mockResponse);
  });
  ...
  it('should fetch data for obtenerPersonaTablaDatos', () => {
    ...
    const req = httpMock.expectOne('assets/json/31616/personapara.json');
    expect(req.request.method).toBe('GET');
    req.flush(mockResponse);
  });
