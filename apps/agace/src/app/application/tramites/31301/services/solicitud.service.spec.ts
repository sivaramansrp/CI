...
describe('SolicitudService', () => {
  ...
  describe('SolicitudService', () => {
    ...
    it('should fetch regimen aduanero', () => {
      ...
      const req = httpMock.expectOne('assets/json/31301/regimen-aduanero.json');
      expect(req.request.method).toBe('GET');
      req.flush(mockData);
    });
    ...
    it('should fetch domicilios', () => {
      ...
      const req = httpMock.expectOne('assets/json/31301/domicilios.json');
      expect(req.request.method).toBe('GET');
      req.flush(mockData);
    });

    it('should fetch datos generales de la solicitud datos', () => {
      const mockData = {
        tipoDeEndoso: '',
        tipoDeGarantia: 1,
