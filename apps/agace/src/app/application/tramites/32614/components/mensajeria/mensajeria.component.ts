...
export class MensajeriaComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  @ViewChild('tablaDosModal', { static: false })
  public tablaDosModal!: ElementRef;
   ...
   * @param tramite32614Store Store del trámite 32614
   * @param tramite32614Query Query del trámite 32614
   */
  constructor(
    private fb: FormBuilder,
    private service: SolicitudDeRegistroInvocarService,
    private tramite32614Store: Tramite32614MensajeriaStore,
    private tramite32614Query: Tramite32614MensajeriaQuery,
  ...
  crearFormulario(): void {
    ...
    this.lasEmpresasForm = this.fb.group({
      rfcLasEmpresas: [
        this.solicitudState?.rfcLasEmpresas,
        Validators.required,
      ],
      denominacionRazonSocial: [{ value: '', disabled: true }],
      domicilio: [{ value: '', disabled: true }],
    ...
    this.isLaSolicitante =
      parseInt(this.solicitudState?.laSolicitante, 10) === 1;
