...
import { PERSONAS_TABLA, PersonasInfo } from '@libs/shared/data-access-user/src/core/models/32614/dato-comunes.model';
...
/**
 * Componente que muestra una tabla dinámica con información de personas relacionadas al trámite 32614.
 *
 * @export
