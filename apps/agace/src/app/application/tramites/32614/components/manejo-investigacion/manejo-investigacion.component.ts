  ...
  crearFormularioDeGestión(): void {
    this.manejo = this.fb.group({
      relacionadosSeguridad: [
        this.solicitudState?.relacionadosSeguridad,
        Validators.required,
      ],
      reportarIncidentes: [
        this.solicitudState?.reportarIncidentes,
        Validators.required,
      ],
      actividadesSospechosas: [
        this.solicitudState?.actividadesSospechosas,
        Validators.required,
      ],
      brevementeSonsiste: [
        this.solicitudState?.brevementeSonsiste,
        Validators.required,
      ],
      incidenteSeguridad: [
        this.solicitudState?.incidenteSeguridad,
        Validators.required,
      ],
      caboInvestigacion: [
        this.solicitudState?.caboInvestigacion,
        Validators.required,
      ],
      operacionCaboInvestigacion: [
        this.solicitudState?.operacionCaboInvestigacion,
        Validators.required,
      ],
    });
  }
