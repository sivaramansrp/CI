import { ALERTA_COM, OPCIONES_DE_BOTON_DE_RADIO } from '@libs/shared/data-access-user/src/tramites/constantes/32614/datos-comunes.enum';
...
import { INSTALACIONES_PRINCIPALES_TABLA, InstalacionesPrincipalesTablaInfo, MERCANCIA_TABLA, MercanciasInfo } from '@libs/shared/data-access-user/src/core/models/32614/dato-comunes.model';
...
import { Tramite32614Query } from '../../estados/queries/tramite32614.query';
import productivo from '@libs/shared/theme/assets/json/32614/productivo.json';
import serviciosAgace from '@libs/shared/theme/assets/json/32614/serviciosAgace.json';

/**
 * Componente para manejar los datos comunes del trámite 32614
 * 
 * Este componente se encarga de gestionar los formularios y tablas relacionadas
 * con la información común requerida para el trámite 32614.
 */
@Component({
...
export class DatoComunesComponent implements OnInit, OnDestroy, AfterViewInit {
   ...
   */
  public solicitudState!: Solicitud32614State;
...
/**
   ...
   * @param tramite32614Store Store para el trámite 32614
   * @param tramite32614Query Query para el trámite 32614
   */
  constructor(
    private fb: FormBuilder,
    private service: SolicitudDeRegistroInvocarService,
    private tramite32614Store: Tramite32614Store,
    private tramite32614Query: Tramite32614Query,
...
/**
  ...
  setValoresStore(
    form: FormGroup,
    campo: string,
    metodoNombre: keyof Tramite32614Store,
