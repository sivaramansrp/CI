 ...
 * del trámite 32614. Administra la visibilidad de múltiples secciones temáticas relacionadas
...
import { FECHA_DE_PAGO } from '../../constants/perfiles.enum';
...
/**
 * Componente principal para la sección de perfiles de mensajería del trámite 32614.
 *
...
export class PerfilesMensajeriaComponent implements OnInit, OnDestroy {
   ...
   */
  private solicitudState!: Solicitud32614PerfilesMensajeriaState;
...
/**
   ...
   * @param {keyof Tramite32614PerfilesMensajeriaStore} metodoNombre - Método del store que se debe invocar.
   */
  ...
  actualizarAntiguedad(): void {
    ...
    this.tramite32614Store.setAntiguedad(ANTIGUEDAD);
  }
  ...
  actualizarProductos(): void {
    ...
    this.tramite32614Store.setProductos(PRODUCTOS);
  }
  ...
  actualizarEmbarquesExp(): void {
    ...
    this.tramite32614Store.setEmbarquesExp(EMBARQUES_EXP);
  }
  ...
  actualizarEmbarquesImp(): void {
    ...
    this.tramite32614Store.setEmbarquesImp(EMBARQUES_IMP);
  }
  ...
  actualizarEmpleados(): void {
    ...
    this.tramite32614Store.setEmpleados(EMPLEADOS);
  }
  ...
  actualizarSuperficie(): void {
    ...
    this.tramite32614Store.setSuperficie(SUPERFICIE);
  }
  ...
  seleccionarVigenciaUno(evento: string): void {
    this.tramite32614Store.setVigencia(evento);
  }
  ...
  seleccionarVigenciaDos(evento: string): void {
    this.tramite32614Store.setVigenciaDos(evento);
  }
  ...
  seleccionarVigenciaTres(evento: string): void {
    this.tramite32614Store.setVigenciaTres(evento);
  }
