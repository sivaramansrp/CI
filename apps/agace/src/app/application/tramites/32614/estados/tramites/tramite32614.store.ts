...
/**
 * Función para crear el estado inicial de Solicitud32614.
 * @returns {Solicitud32614State} El estado inicial de Solicitud32614.
 */
export function createInitialState(): Solicitud32614State {
    return {
        /**
         * El valor de sectorProductivo.
         */
 ...
 */
@StoreConfig({ name: 'tramite32614', resettable: true })

export class Tramite32614Store extends Store<Solicitud32614State>{
    /**
