 ...
 */
export interface Solicitud32614MensajeriaState {
    /**
...
/**
 * Función para crear el estado inicial de Solicitud32614Mensajeria.
 * @returns {Solicitud32614MensajeriaState} El estado inicial de Solicitud32614Mensajeria.
 */
export function createInitialState(): Solicitud32614MensajeriaState {
    return {
        /**
         * El valor de laSolicitante.
         */
 ...
 */
@StoreConfig({ name: 'tramite32614Mensajeria', resettable: true })

export class Tramite32614MensajeriaStore extends Store<Solicitud32614MensajeriaState>{
    /**
