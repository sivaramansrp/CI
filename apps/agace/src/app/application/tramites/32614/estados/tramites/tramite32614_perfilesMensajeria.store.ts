 ...
 */
export interface Solicitud32614PerfilesMensajeriaState {
  /**
...
/**
 * Función para crear el estado inicial de Solicitud32614PerfilesMensajeria.
 * @returns {Solicitud32614PerfilesMensajeriaState} El estado inicial de Solicitud32614PerfilesMensajeria.
 */
export function createInitialState(): Solicitud32614PerfilesMensajeriaState {
  return {
    /**
     * El valor de describaProcedimiento.
     */
 ...
 */
@StoreConfig({ name: 'tramite32614PerfilesMensajeria', resettable: true })
export class Tramite32614PerfilesMensajeriaStore extends Store<Solicitud32614PerfilesMensajeriaState> {
  /**
