...
/**
 * Representa el estado de la solicitud para perfiles del formulario 32614.
 */
export interface Solicitud32614PerfilesState {
...
/**
 * Crea el estado inicial del formulario `Solicitud32614PerfilesState`.
 * Todos los campos se inicializan como cadenas vacías.
 *
 * @returns El estado inicial con todos los campos del formulario vacíos.
 */
export function createInitialState(): Solicitud32614PerfilesState {
  return {
...
/**
 * Servicio que gestiona el estado de la solicitud 32614 para los perfiles.
 ...
 * @StoreConfig: Configura el almacenamiento del estado para la solicitud 32614.
 * El nombre del estado es `tramite32614Perfiles` y se establece como reseteable.
 */
@Injectable({
  providedIn: 'root', // Proporciona el servicio a nivel de toda la aplicación.
})
@StoreConfig({ name: 'tramite32614Perfiles', resettable: true }) // Configuración del estado en la tienda
export class Tramite32614PerfilesStore extends Store<Solicitud32614PerfilesState> {
  /**
