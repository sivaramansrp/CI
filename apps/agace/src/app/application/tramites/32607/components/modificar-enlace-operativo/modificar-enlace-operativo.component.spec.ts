...
import { of } from 'rxjs';
import { ModificarEnlaceOperativoComponent } from './modificar-enlace-operativo.component';
...
describe('ModificarEnlaceOperativoComponent', () => {
  let component: ModificarEnlaceOperativoComponent;
  let fixture: ComponentFixture<ModificarEnlaceOperativoComponent>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      imports: [
        ModificarEnlaceOperativoComponent,
        CommonModule,
        ReactiveFormsModule,
        TituloComponent,
    ...
    fixture = TestBed.createComponent(ModificarEnlaceOperativoComponent);
  ...
  it('should initialize the form with default values', () => {
    expect(component.modificarEnlaceOperativoForm.value).toEqual({
  ...
  it('should disable the form if esFormularioSoloLectura is true in guardarDatosFormulario', () => {
    ...
    component.inicializarFormulario = jest.fn(() => {
      component.modificarEnlaceOperativoForm = component['fb'].group({
    ...
    expect(component.modificarEnlaceOperativoForm.disabled).toBe(true);
  });
  ...
  it('should enable the form if esFormularioSoloLectura is false in guardarDatosFormulario', () => {
    ...
    component.guardarDatosFormulario();
    expect(component.modificarEnlaceOperativoForm.enabled).toBe(true);
  });

  it('noEsValido should return true if control is invalid and touched', () => {
    component.modificarEnlaceOperativoForm.get('agregarEnlaceTelefono')?.markAsTouched();
    component.modificarEnlaceOperativoForm.get('agregarEnlaceTelefono')?.setValue('');
  ...
  it('should call solicitudService.conseguirRepresentanteLegalDatos on buscarTerceroNacionalIDC', () => {
    component.modificarEnlaceOperativoForm.get('rfcTercero')?.setValue('RFC123');
