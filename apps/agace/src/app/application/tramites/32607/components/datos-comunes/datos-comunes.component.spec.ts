...
// Remove Jasmine globals, use Jest's describe/it/expect
...
describe('DatosComunesComponent', () => {
    ...
    beforeEach(async () => {
        solicitudServiceMock = {
            conseguirOpcionDeRadio: jest.fn().mockReturnValue(of({ requisitos: { id: 1, nombre: 'Sí' } })),
            ...
            conseguirInventarios: jest.fn().mockReturnValue(of([{ nombre: 'Inv1', lugarRadicacion: 'Lugar1', anexo24: true }]))
        };
    ...
    it('should remove inventarios on eliminarInventariosDatos', () => {
        ...
        component.seleccionarInventarios = [{ nombre: 'A', lugarRadicacion: 'B', anexo24: true }] as any;
    ...
    it('should remove empleados on eliminarNumeroDeEmpleadosDato', () => {
        ...
        component.seleccionarNumeroDeEmpleadosLista = [{ numeroDeEmpleados: 1 }] as any;
    ...
    it('should call store actualizarEmpleados with value from event', () => {
        ...
        expect(solicitud32607StoreMock.actualizarEmpleados).toHaveBeenCalledWith('123');
    });
    ...
    it('should call store actualizarIdentificacion with value from event', () => {
        ...
        expect(solicitud32607StoreMock.actualizarIdentificacion).toHaveBeenCalledWith('ID123');
    });
    ...
    it('should call store actualizarLugarDeRadicacion with value from event', () => {
        ...
        expect(solicitud32607StoreMock.actualizarLugarDeRadicacion).toHaveBeenCalledWith('LugarX');
    });
    ...
    it('should call store actualizarActualmente2 with value from event', () => {
        ...
        expect(solicitud32607StoreMock.actualizarActualmente2).toHaveBeenCalledWith('val2');
    });
    ...
    it('should call store actualizarActualmente1 with value from event', () => {
        ...
        expect(solicitud32607StoreMock.actualizarActualmente1).toHaveBeenCalledWith('val1');
    });
