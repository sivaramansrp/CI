...
describe('DatosComunesComponent', () => {
  ...
  it('should update listaSeccionSociosIC when eventoActualizarMiembro is called', () => {
    ...
    expect(
      solicitud32607StoreMock.actualizarListaSeccionSociosIC
  ...
  it('should update domiciliosDatos when instalacionesPrincipales is called', () => {
    ...
    expect(
      solicitud32607StoreMock.actualizarDomiciliosDatos
  ...
  it('should update numeroDeEmpleadosLista when seccionSubcontratados is called', () => {
    ...
    expect(
      solicitud32607StoreMock.actualizarNumeroDeEmpleadosLista
  ...
  it('should call actualizarCatseleccionados with correct id', () => {
    ...
    solicitud32607StoreMock.actualizarCatseleccionados(mockCatalogo.id);
    expect(solicitud32607StoreMock.actualizarCatseleccionados).toHaveBeenCalledWith(123);
  });

  it('should call actualizarServicio with correct id', () => {
    const mockCatalogo = { id: 456 } as any;
    solicitud32607StoreMock.actualizarServicio(mockCatalogo.id);
    expect(solicitud32607StoreMock.actualizarServicio).toHaveBeenCalledWith(456);
  });

  it('should call actualizar190 with correct value', () => {
    component.actualizar190('test190');
    expect(solicitud32607StoreMock.actualizar190).toHaveBeenCalledWith('test190');
  });
  ...
  it('should call actualizarEmpleados with correct value from event', () => {
    ...
    expect(solicitud32607StoreMock.actualizarEmpleados).toHaveBeenCalledWith('10');
  });
  ...
  it('should call actualizar237 with correct value', () => {
    ...
    it('should call actualizar240 with correct value', () => {
      ...
      expect(solicitud32607StoreMock.actualizar240).toHaveBeenCalledWith('valor240');
    });

    it('should call actualizar243 with correct value', () => {
      component.actualizar243(243);
      expect(solicitud32607StoreMock.actualizar243).toHaveBeenCalledWith(243);
    });

    it('should call actualizar244 with correct value', () => {
      component.actualizar244('valor244');
      expect(solicitud32607StoreMock.actualizar244).toHaveBeenCalledWith('valor244');
    });

    it('should call actualizar245 with correct value', () => {
      component.actualizar245(245);
      expect(solicitud32607StoreMock.actualizar245).toHaveBeenCalledWith(245);
    });

    it('should call actualizarIndiqueTodos with correct id', () => {
      const mockCatalogo = { id: 7 } as any;
      solicitud32607StoreMock.actualizarIndiqueTodos(mockCatalogo.id);
      expect(solicitud32607StoreMock.actualizarIndiqueTodos).toHaveBeenCalledWith(7);
    });

    it('should call actualizar246 with correct value', () => {
      component.actualizar246('valor246');
      expect(solicitud32607StoreMock.actualizar246).toHaveBeenCalledWith('valor246');
    });
    ...
    it('should call actualizarFile1 with correct value from event', () => {
      ...
      expect(solicitud32607StoreMock.actualizarFile1).toHaveBeenCalledWith('file1.pdf');
    });
    ...
    it('should call actualizarFile2 with correct value from event', () => {
      ...
      expect(solicitud32607StoreMock.actualizarFile2).toHaveBeenCalledWith('file2.pdf');
    });

    it('should call actualizar247 with correct value', () => {
      component.actualizar247(247);
      expect(solicitud32607StoreMock.actualizar247).toHaveBeenCalledWith(247);
    });

    it('should call actualizar248 with correct value', () => {
      component.actualizar248('valor248');
      expect(solicitud32607StoreMock.actualizar248).toHaveBeenCalledWith('valor248');
    });
    ...
    it('should call actualizarIdentificacion with correct value from event', () => {
      ...
      expect(solicitud32607StoreMock.actualizarIdentificacion).toHaveBeenCalledWith('identificacion123');
    });
    ...
    it('should call actualizarLugarDeRadicacion with correct value from event', () => {
      ...
      expect(solicitud32607StoreMock.actualizarLugarDeRadicacion).toHaveBeenCalledWith('CDMX');
    });

    it('should call actualizar249 with correct value', () => {
      component.actualizar249(249);
      expect(solicitud32607StoreMock.actualizar249).toHaveBeenCalledWith(249);
    });

    it('should call actualizar250 with correct value', () => {
      component.actualizar250('valor250');
      expect(solicitud32607StoreMock.actualizar250).toHaveBeenCalledWith('valor250');
    });

    it('should call actualizar251 with correct value', () => {
      component.actualizar251(251);
      expect(solicitud32607StoreMock.actualizar251).toHaveBeenCalledWith(251);
    });
    ...
    it('should call actualizarCheckbox1 with correct checked value', () => {
      ...
      expect(solicitud32607StoreMock.actualizarCheckbox1).toHaveBeenCalledWith(true);
    });
    ...
    it('should call actualizarCheckbox2 with correct checked value', () => {
      ...
      expect(solicitud32607StoreMock.actualizarCheckbox2).toHaveBeenCalledWith(false);
    });

    it('should call actualizarCheckbox3 with correct checked value', () => {
      const mockEvent = { target: { checked: true } } as any as Event;
      component.actualizarCheckbox3(mockEvent);
      expect(solicitud32607StoreMock.actualizarCheckbox3).toHaveBeenCalledWith(true);
    });
    ...
    it('should call actualizarActualmente2 with correct value from event', () => {
      ...
      expect(solicitud32607StoreMock.actualizarActualmente2).toHaveBeenCalledWith('actualmente2');
    });
    ...
    it('should call actualizarActualmente1 with correct value from event', () => {
      ...
      expect(solicitud32607StoreMock.actualizarActualmente1).toHaveBeenCalledWith('actualmente1');
    });
