...
import { ProveedorExtranjeroComponent } from './proveedor-extranjero.component';
...
describe('ProveedorExtranjeroComponent', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [ FormsModule, ReactiveFormsModule,ProveedorExtranjeroComponent,HttpClientTestingModule ],
      declarations: [
    ...
    }).overrideComponent(ProveedorExtranjeroComponent, {
  ...
  it('should run #fileValidator()', async () => {

    component.fileValidator = jest.fn();
    const file = new File([''], 'filename.txt', { type: 'text/plain' });
    const result = component.fileValidator(file);
  ...
  it('should run #cargarArchivoAjax()', async () => {
    component.proveedorXtranjForm = component.proveedorXtranjForm || {};
    component.proveedorXtranjForm.valid = 'valid';
    component.proveedorXtranjForm.value = 'value';
    component.store = component.store || {};
    component.store.setRegistrosProveedoresExtranjeros = jest.fn();
    component.openCargaExtranjeroModel = jest.fn();
