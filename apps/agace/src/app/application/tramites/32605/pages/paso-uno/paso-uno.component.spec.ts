...
describe('PasoUnoComponent', () => {
  ...
  beforeEach(async () => {
    ...
    component.datosComunesComponent = mockDatosComunesComponent as DatosComunesComponent;
    component.tercerosRelacionadosComponent = mockTercerosRelacionadosComponent as TercerosRelacionadosComponent;
    component.importadorExportadorComponent = mockImportadorExportadorComponent as ImportadorExportadorComponent;
  ...
  describe('guardarDatosFormulario', () => {
    it('debe llamar obtenerDatos y actualizarEstado cuando la respuesta es válida', () => {
      ...
      (mockSolicitudService.obtenerDatos as jest.Mock).mockReturnValue(of(mockResponse));
      (mockSolicitudService.actualizarEstado as jest.Mock).mockReturnValue(undefined);
      ...
      expect(mockSolicitudService.actualizarEstado).toHaveBeenCalledWith(mockResponse);
    ...
    it('no debe actualizar estado cuando la respuesta es undefined', () => {
      (mockSolicitudService.obtenerDatos as jest.Mock).mockReturnValue(of(undefined));
      (mockSolicitudService.actualizarEstado as jest.Mock).mockReturnValue(undefined);
    ...
    it('debe manejar errores del servicio obtenerDatos', () => {
      (mockSolicitudService.obtenerDatos as jest.Mock).mockReturnValue(throwError(() => new Error('Service error')));
  ...
  describe('validarFormularios', () => {
    beforeEach(() => {
      (mockDatosComunesComponent.validarFormulario as jest.Mock).mockReturnValue(true);
      (mockTercerosRelacionadosComponent.validarFormulario as jest.Mock).mockReturnValue(true);
      (mockImportadorExportadorComponent.validarFormulario as jest.Mock).mockReturnValue(true);
    ...
    it('debe retornar true cuando todos los formularios son válidos', () => {
      ...
      expect(mockImportadorExportadorComponent.validarFormulario).toHaveBeenCalled();
    ...
    it('debe retornar false cuando el formulario solicitante es inválido', () => {
      ...
      const markAllAsTouchedSpy = jest.spyOn(mockSolicitanteComponent.form!, 'markAllAsTouched');
    ...
    it('debe retornar false cuando validarFormulario de datosComunesComponent retorna false', () => {
      (mockDatosComunesComponent.validarFormulario as jest.Mock).mockReturnValue(false);
    ...
    it('debe retornar false cuando validarFormulario de tercerosRelacionadosComponent retorna false', () => {
      (mockTercerosRelacionadosComponent.validarFormulario as jest.Mock).mockReturnValue(false);
    ...
    it('debe retornar false cuando validarFormulario de importadorExportadorComponent retorna false', () => {
      (mockImportadorExportadorComponent.validarFormulario as jest.Mock).mockReturnValue(false);
  ...
  describe('ngOnInit', () => {
    ...
    it('debe llamar guardarDatosFormulario cuando consultaState.update es true', () => {
      const mockState = {
        procedureId: '1',
        parameter: 'param',
        department: 'AGACE',
