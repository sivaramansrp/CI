...
/**
  ...
  obtenerEstadoSolicitud(): void {
    this.tramite32605Query.selectSolicitud$?.pipe(takeUntil(this.destroyNotifier$))
   ...
   */
    ...
    this.profileForm = this.fb.group({
      antiguedad: [{value:PERFILES.antiguedad || '', disabled: this.esFormularioSoloLectura}, [Validators.required, Validators.pattern(REGEX_VALORES_NUMERICOS)]],
      productos: [{value:PERFILES.productos || '', disabled: this.esFormularioSoloLectura}, [Validators.required, Validators.pattern(REGEX_VALORES_NUMERICOS)]],
      embarquesExp: [{value:PERFILES.embarquesExp || '', disabled: this.esFormularioSoloLectura}, [Validators.required, Validators.pattern(REGEX_VALORES_NUMERICOS)]],
      embarquesImp: [{value:PERFILES.embarquesImp || '', disabled: this.esFormularioSoloLectura}, [Validators.required, Validators.pattern(REGEX_VALORES_NUMERICOS)]],
      empleados: [{value:PERFILES.empleados || '', disabled: this.esFormularioSoloLectura}, [Validators.required, Validators.pattern(REGEX_VALORES_NUMERICOS)]],
      superficie: [{value:PERFILES.superficie || '', disabled: this.esFormularioSoloLectura}, [Validators.required, Validators.pattern(REGEX_VALORES_NUMERICOS)]],
      blCtpat: [{value:PERFILES.blCtpat ?? '', disabled: this.esFormularioSoloLectura}, [Validators.required]],
      niverCertificado: [{value:PERFILES.niverCertificado || '', disabled: this.esFormularioSoloLectura}],
      ctpatAccountNumber: [{value:PERFILES.ctpatAccountNumber || '', disabled: this.esFormularioSoloLectura}],
      codigoMid: [{value:PERFILES.codigoMid, disabled: this.esFormularioSoloLectura}],
      fecUltimaCtapt: [{value:null, disabled: this.esFormularioSoloLectura}],
      blnPip: [{value:PERFILES.blnPip, disabled: this.esFormularioSoloLectura}, [Validators.required]],
      numRegistroPip: [{value:PERFILES.numRegistroPip, disabled: this.esFormularioSoloLectura}],
      blnOea: [{value:PERFILES.blnOea, disabled: this.esFormularioSoloLectura}, [Validators.required]],
      nomProgramapaisOea: [{value:PERFILES.nomProgramapaisOea, disabled: this.esFormularioSoloLectura}],
      numRegistroOea: [{value:PERFILES.numRegistroOea, disabled: this.esFormularioSoloLectura}],
      blnOtrosProgramasSegu: [{value:PERFILES.blnOtrosProgramasSegu, disabled: this.esFormularioSoloLectura}, [Validators.required]],
      nombreProgramaOtros: [{value:PERFILES.nombreProgramaOtros, disabled: this.esFormularioSoloLectura}],
      numRegistroOtros: [{value:PERFILES.numRegistroOtros, disabled: this.esFormularioSoloLectura}],
      fechaVigenciaOtros: [{value:null, disabled: this.esFormularioSoloLectura}],
      nombre: [{value:PERFILES.nombre || '', disabled: this.esFormularioSoloLectura}, [Validators.required]],
      categoria: [{value:PERFILES.categoria || '', disabled: this.esFormularioSoloLectura}, [Validators.required]],
      vigencia: [{value:PERFILES.vigencia || '', disabled: this.esFormularioSoloLectura}, [Validators.required]],
      nombre2: [{value:PERFILES.nombre2 || '', disabled: this.esFormularioSoloLectura}, [Validators.required]],
      categoria2: [{value:PERFILES.categoria2 || '', disabled: this.esFormularioSoloLectura}, [Validators.required]],
      vigencia2: [{value:PERFILES.vigencia2 || '', disabled: this.esFormularioSoloLectura}, [Validators.required]],
      nombre3: [{value:PERFILES.nombre3 || '', disabled: this.esFormularioSoloLectura}, [Validators.required]],
      categoria3: [{value:PERFILES.categoria3 || '', disabled: this.esFormularioSoloLectura}, [Validators.required]],
      vigencia3: [{value:PERFILES.vigencia3 || '', disabled: this.esFormularioSoloLectura}, [Validators.required]],
    });
  }
  ...
  actualizarAntiguedad(): void {
    ...
    this.tramite32605Store.actualizarEstado({ perfiles: { antiguedad: ANTIGUEDAD } });
  }
  ...
  actualizarProductos(): void {
    ...
    this.tramite32605Store.actualizarEstado({ perfiles: { productos: PRODUCTOS } });
  }
  ...
  actualizarEmbarquesExp(): void {
    ...
    this.tramite32605Store.actualizarEstado({ perfiles: { embarquesExp: EMBARQUES_EXP } });
  }
  ...
  actualizarEmbarquesImp(): void {
    ...
    this.tramite32605Store.actualizarEstado({ perfiles: { embarquesImp: EMBARQUES_IMP } });
  }
  ...
  actualizarEmpleados(): void {
    ...
    this.tramite32605Store.actualizarEstado({ perfiles: { empleados: EMPLEADOS } });
  }
  ...
  actualizarSuperficie(): void {
    ...
    this.tramite32605Store.actualizarEstado({ perfiles: { superficie: SUPERFICIE } });
  }
  ...
  seleccionarVigenciaUno(evento: string): void {
    this.tramite32605Store.actualizarEstado({ perfiles: { vigencia: evento } });
  }
  ...
  seleccionarVigenciaDos(evento: string): void {
    this.tramite32605Store.actualizarEstado({ perfiles: { vigencia2: evento } });
  }
  ...
  seleccionarVigenciaTres(evento: string): void {
    this.tramite32605Store.actualizarEstado({ perfiles: { vigencia3: evento } });
  }
