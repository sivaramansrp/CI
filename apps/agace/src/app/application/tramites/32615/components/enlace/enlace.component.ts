...
/**
 * Componente encargado de gestionar la información del enlace del trámite 32615.
 */
@Component({
  selector: 'app-enlace',
  standalone: true,
...
export class EnlaceComponent implements OnInit, OnDestroy {
   ...
   * @param tramite32615Store Store para modificar el estado del trámite.
   * @param tramite32615Query Query para consultar el estado del trámite.
   */
  constructor(
   ...
   */
  public setValoresStore(form: FormGroup, campo: string, metodoNombre: keyof Tramite32615TercerosStore): void {
