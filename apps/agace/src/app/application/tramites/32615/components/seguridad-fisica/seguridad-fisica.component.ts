...
export class SeguridadFisicaComponent implements OnInit, OnDestroy {
  ...
  public crearFormularioSeguridadFisica(): void {
    this.seguridadFisicaForm = this.fb.group({
      ...
      detalleSuUbicacion: [
        this.solicitudState?.detalleSuUbicacion,
        Validators.required,
      ],
      describaDetalleSuUbicacion: [
        this.solicitudState?.describaDetalleSuUbicacion,
        Validators.required,
      ],
      describaMantenimiento: [
        this.solicitudState?.describaMantenimiento,
        Validators.required,
      ],
      procedimientoDocumentadoMencionar: [ this.solicitudState?.procedimientoDocumentadoMencionar, Validators.required],
      encargado: [ this.solicitudState?.encargado, Validators.required]
    });
  }
