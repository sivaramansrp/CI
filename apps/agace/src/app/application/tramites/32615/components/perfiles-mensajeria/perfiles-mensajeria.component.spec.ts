...
describe('PerfilesMensajeriaComponent', () => {
  ...
  let store: Tramite32615PerfilesMensajeriaStore;
  let query: Tramite32615PerfilesMensajeriaQuery;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      providers: [
        FormBuilder,
        {
          provide: Tramite32615PerfilesMensajeriaStore,
          useValue: {
        ...
        {
          provide: Tramite32615PerfilesMensajeriaQuery,
          useValue: {
            selectSolicitud$: of({
    ...
    store = TestBed.inject(Tramite32615PerfilesMensajeriaStore);
    query = TestBed.inject(Tramite32615PerfilesMensajeriaQuery);
