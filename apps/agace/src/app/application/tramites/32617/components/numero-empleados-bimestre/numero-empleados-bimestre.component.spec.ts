...
import { NumeroEmpleadosTabla, BuscarRfcResponse } from '../../modelos/oea-tercerizacion-logistica-registro.model';
import { 
...
describe('NumeroEmpleadosBimestreComponent - Pruebas unitarias', () => {
  ...
  describe('🔍 Búsqueda de RFC', () => {
    ...
    it('✅ debería manejar errores en la búsqueda de RFC', () => {
      ...
      mockOeaTercerizacionLogisticaRegistroService.getRFCDetails.mockReturnValue(
