...
describe('ControlInventariosComponent - Pruebas unitarias', () => {
  ...
  describe('🚨 Casos de error y estados límite', () => {
    ...
    it('✅ debería manejar errores en suscripciones', () => {
      ...
      mockTramite32617Query.selectTramite32617$ = errorObservable.asObservable() as any as import('../../estados/tramites32617.store').Tramites32617State extends infer T ? import('rxjs').Observable<T> : never;
