...
import { PANELS1, TRANSPORTISTAS_CONFIGURACION } from '../../enums/oea-tercerizacion-logistica-registro.enum';
import { Subject, map } from 'rxjs';
import { Tramite32617Store, Tramites32617State } from '../../estados/tramites32617.store';
import { TransportistasListaInterface, TransportistasTable } from '../../modelos/oea-tercerizacion-logistica-registro.model';
...
import { TRANSPORTISTAS_PANELS } from '../../constants/datos-comunes.enum';
import { Tramite32617Query } from '../../estados/tramites32617.query';
import { Validators } from '@angular/forms';
import { takeUntil } from 'rxjs';

/**
 * Componente para agregar y gestionar transportistas en el trámite 32617.
...
export class AgregarTransportistasComponent implements OnInit, OnDestroy {
   ...
   * param tramite32617Store - Store para gestionar el estado del trámite
   * param tramite32617Query - Query para consultar el estado del trámite
  ...
  actualizarTransportistasListaEnStore(): void {
    this.tramite32617Store.establecerDatos({ transportistasLista: this.transportistasLista });
  }
