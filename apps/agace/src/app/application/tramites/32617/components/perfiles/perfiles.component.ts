...
export class PerfilesComponent implements OnInit, OnDestroy {
  ...
  obtenerEstadoSolicitud(): void {
    this.tramite32617Query.selectTramite32617$?.pipe(takeUntil(this.destroyNotifier$))
  ...
  actualizarAntiguedad(): void {
    ...
    this.tramite32617Store.establecerDatos({ perfiles: { antiguedad: ANTIGUEDAD } });
  }
  ...
  actualizarProductos(): void {
    ...
    this.tramite32617Store.establecerDatos({ perfiles: { productos: PRODUCTOS } });
  }
  ...
  actualizarEmbarquesExp(): void {
    ...
    this.tramite32617Store.establecerDatos({ perfiles: { embarquesExp: EMBARQUES_EXP } });
  }
  ...
  actualizarEmbarquesImp(): void {
    ...
    this.tramite32617Store.establecerDatos({ perfiles: { embarquesImp: EMBARQUES_IMP } });
  }
  ...
  actualizarEmpleados(): void {
    ...
    this.tramite32617Store.establecerDatos({ perfiles: { empleados: EMPLEADOS } });
  }
  ...
  actualizarSuperficie(): void {
    ...
    this.tramite32617Store.establecerDatos({ perfiles: { superficie: SUPERFICIE } });
  }
  ...
  seleccionarVigenciaUno(evento: string): void {
    this.tramite32617Store.establecerDatos({ perfiles: { vigencia: evento } });
  }
  ...
  seleccionarVigenciaDos(evento: string): void {
    this.tramite32617Store.establecerDatos({ perfiles: { vigencia2: evento } });
  }
  ...
  seleccionarVigenciaTres(evento: string): void {
    this.tramite32617Store.establecerDatos({ perfiles: { vigencia3: evento } });
  }
