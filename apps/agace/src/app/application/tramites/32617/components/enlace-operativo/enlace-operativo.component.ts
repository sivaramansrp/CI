import { CategoriaMensaje, ConfiguracionColumna, Notificacion, NotificacionesComponent, REGEX_RFC, TablaDinamicaComponent, TablaSeleccion, TipoNotificacionEnum } from '@libs/shared/data-access-user/src';
import { Component, ElementRef, Inject, OnDestroy, OnInit, ViewChild } from '@angular/core';
import { ENLACE_OPERATIVO_TABLA, PANELS_CONFIGURACION } from '../../enums/oea-tercerizacion-logistica-registro.enum';
...
import { TablaEnlaceOperativo } from '../../modelos/oea-tercerizacion-logistica-registro.model';
...
export class EnlaceOperativoComponent implements OnInit, OnDestroy {
   ...
   * @param {Tramite32617Query} tramite32617Query - Query para consultar el estado del trámite
   * @param {ConsultaioQuery} consultaioQuery - Query para consultar el estado de solo lectura
   */
  constructor(
    private fb: FormBuilder,
    @Inject(Tramite32617Store) private tramite32617Store: Tramite32617Store,
  ...
  crearFormulario(): void {
    ...
    this.enlaceOperativoForm = this.fb.group({
      registro: ['', [Validators.required,Validators.pattern(REGEX_RFC)]],
