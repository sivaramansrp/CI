...
describe('DomiciliosRfcSolicitanteComponent - Pruebas unitarias', () => {
  ...
  describe('Obtención de catálogos', () => {
    ...
    it('debería cargar catálogos de domicilios y tipos de instalación', () => {
      ...
      expect(mockOeaTercerizacionLogisticaRegistroService.getDomiciliosRegistrados).toHaveBeenCalled();
      expect(mockOeaTercerizacionLogisticaRegistroService.getTipoInstalacion).toHaveBeenCalled();
    ...
    it('debería manejar errores al obtener catálogos', () => {
      ...
      mockOeaTercerizacionLogisticaRegistroService.getDomiciliosRegistrados.mockReturnValue(throwError(() => error));
