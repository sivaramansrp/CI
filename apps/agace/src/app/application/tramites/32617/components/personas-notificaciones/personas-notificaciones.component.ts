...
import { PANELS_PRINCIPALES, PERSONAS_NOTIFICACIONES_TABLA } from '../../enums/oea-tercerizacion-logistica-registro.enum';
import { PersonaRespuestaTabla, TablaPersonasNotificaciones } from '../../modelos/oea-tercerizacion-logistica-registro.model';
...
export class PersonasNotificacionesComponent implements OnInit, OnDestroy {
   ...
   */
  constructor(
    private readonly solicitudDeRegistroInvocarService: OeaTercerizacionLogisticaRegistroService,
