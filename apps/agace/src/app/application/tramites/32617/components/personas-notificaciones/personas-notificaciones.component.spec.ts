...
import { PERSONAS_NOTIFICACIONES_TABLA, PANELS_PRINCIPALES } from '../../enums/oea-tercerizacion-logistica-registro.enum';

describe('PersonasNotificacionesComponent', () => {
  let component: PersonasNotificacionesComponent;
  let solicitudDeRegistroInvocarServiceMock: jest.Mocked<OeaTercerizacionLogisticaRegistroService>;
