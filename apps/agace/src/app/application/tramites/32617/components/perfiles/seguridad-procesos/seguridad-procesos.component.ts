...
import { TEXTOS_ESTATICOS_SEGURIDAD_PROCESOS } from '../../../constants/texto-estatico-tres.enum';
...
export class SeguridadProcesosComponent implements OnInit, OnDestroy {
   ...
   * @param {Tramite32617Store} tramite32617Store - Store para gestionar el estado de la solicitud.
