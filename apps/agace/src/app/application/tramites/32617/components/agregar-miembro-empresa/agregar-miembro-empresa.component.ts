...
import { EMPRESA_MIEMBRO_TABLA_DATOS, MENSAJE_DE_VALIDACION, NOTA, OPCIONES_DE_BOTON_DE_RADIO } from '../../enums/oea-tercerizacion-logistica-registro.enum';
import { FormBuilder, FormGroup, ReactiveFormsModule, Validators } from '@angular/forms';
import { Subject, map, takeUntil} from 'rxjs';
import { Tramite32617Store, Tramites32617State } from '../../estados/tramites32617.store';
import { AgregarMiembroEmpresaTabla } from '../../modelos/oea-tercerizacion-logistica-registro.model';
...
.subscribe();
  ...
  AgregarMiembroEmpresaInfoDatos(): void {
    ...
    if (
      ...
      this.tramite32617Store.establecerDatos({agregarMiembroEmpresa:this.agregarMiembroEmpresaList});
    } else {
