...
import {
  ...
  TercerosContratados,
  TransportistasTable,
} from '../modelos/oea-tercerizacion-logistica-registro.model';
...
export const FECHA_DE_MADALIDAD_IVVAAEIEPS = {
  labelNombre: '',
  required: false,
  habilitado: true,
};
...
/**
 * Configuración de columnas para la tabla de Terceros Contratados.
 */
export const TERCEROS_CONTRATADOS = [
    {
        encabezado: 'RFC',
        clave: (ele: TercerosContratados): string => ele.rfcTerceroContratado,
        orden: 1,
    },
    {
        encabezado: 'Nombre, denominación o razón social',
        clave: (ele: TercerosContratados): string => ele.denominacionRazonsocial,
        orden: 2,
    },
    {
        
        encabezado: 'Tipo de registro',
        clave: (ele: TercerosContratados): string => ele.tipoRegistro,
        orden: 3,
    }
];
...
export const PANELS2 = [
    { label: 'Terceros Contratados', isCollapsed: false }, 
];
