...
/**
 * Componente de oea-tercerizacion-logistica-registro.
 *
 * Este componente maneja el flujo de pasos para el proceso de oea-tercerizacion-logistica-registro.
 *
 * @selector 'app-oea-tercerizacion-logistica-registro'
 * @templateUrl './oea-tercerizacion-logistica-registro.component.html'
 * @styleUrl './oea-tercerizacion-logistica-registro.component.scss'
 */
@Component({
  selector: 'app-oea-tercerizacion-logistica-registro',
  templateUrl: './oea-tercerizacion-logistica-registro.component.html',
...
export class OeaTercerizacionLogisticaRegistroComponent {
  /**
