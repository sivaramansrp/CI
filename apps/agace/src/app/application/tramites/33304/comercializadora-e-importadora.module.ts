...
import { ComercializadoraEImportadoraRoutingModule } from './comercializadora-e-importadora-routing.module';
...
@NgModule({
  ...
  imports: [
    CommonModule,
    ComercializadoraEImportadoraRoutingModule,
...
export class ComercializadoraEImportadoraModule { }
