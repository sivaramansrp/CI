 ...
 * 
 * @returns {Solicitud33304State} El estado inicial de la solicitud.
 */
...
@StoreConfig({ name: 'solicitud33304State', resettable: true })
export class Solicitud33304Store extends Store<Solicitud33304State> {
  /**
   * Constructor de la clase Solicitud33304Store.
