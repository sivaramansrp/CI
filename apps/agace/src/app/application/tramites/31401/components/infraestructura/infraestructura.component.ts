...
/**
  * @Component
  * @selector infraestructura
  * @description
  * Componente `InfraestructuraComponent` que representa la sección del formulario relacionada con la infraestructura necesaria.
  * 
  * Detalles:
  ...
  * - Renderiza un formulario dinámico utilizando los componentes `FormasDinamicasComponent`, `InputRadioComponent`, y `AlertComponent`.
  * 
  * Propiedades:
  * - `selector`: Define el nombre del selector del componente como `infraestructura`.
  * - `standalone`: Indica que el componente es independiente.
  * - `imports`: Lista de módulos y componentes importados, como `CommonModule`, `ReactiveFormsModule`, `FormasDinamicasComponent`, `InputRadioComponent`, y `AlertComponent`.
...
export class InfraestructuraComponent implements OnInit, OnDestroy {
  /**
   * @property forma
   * @description
   * Representa el formulario reactivo utilizado en el componente `InfraestructuraComponent`.
   * @type {FormGroup}
   */
  public forma: FormGroup = new FormGroup({
    ninoFormGroup: new FormGroup({}),
    porcentaje: new FormControl({ value: '54', disabled: true }),
    monto: new FormControl({ value: '54', disabled: true }),
    manifiesteCuenta: new FormControl({ value: 1, disabled: true }),
    indiqueSi: new FormControl({ value: 1, disabled: true }),
    capture: new FormControl({ value: 434, disabled: true }),
  });
  ...
  /**
   * compo doc
   * @property infraetructuraFormData
   ...
   * `INFRAESTRUCTURA`, que define los detalles de cada campo, como su
   ...
   */
  public infraetructuraFormData = INFRAESTRUCTURA;
   ...
   *
   * @type {string}
   * @memberof InfraestructuraComponent
   */
  public infraestructuraAlert: string = INFRAESTRUCTURA_ALERTA.mensaje;

  /**
  * @constructor
  * @description
  * Constructor del componente `InfraestructuraComponent`.
  * 
  * Detalles:
  * - Inyecta el servicio `CancelacionGarantiaService` para gestionar la obtención de datos relacionados con la infraestructura.
  ...
  * @method ngOnInit
  * @description
  * Método de inicialización del componente `InfraestructuraComponent`.
  * 
  * Detalles:
