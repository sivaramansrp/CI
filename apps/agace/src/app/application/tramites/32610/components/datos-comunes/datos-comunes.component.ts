...
export class DatosComunesComponent implements OnInit, OnDestroy {
   ...
   * @param {Tramite32609Store} tramite32610Store - Store para gestionar el estado del trámite
   * @param {Tramite32609Query} tramite32610Query - Query para obtener datos del trámite
  ...
  if (this.forma && this.seccionState && this.esFormularioInicializado) {
    ...
    manejarCamposMutuamenteExcluyentes(
      ...
      if (VALOR) {
        ...
        this.tramite32610Store.actualizarEstado({ [campoAResetear]: null });
      }
    }  
