...
import { DOMICILIOS_RFC_SOLICITANTE_TABLA_DATOS, NOTA, OPCIONES_DE_BOTON_DE_RADIO } from '../../constants/oea-textil-registro.enum';
...
export class DomiciliosRfcSolicitanteComponent implements OnInit, OnDestroy, AfterViewInit {
 ...
 /**
  ...
  /**
   * @property {Solicitud32610State} seccionState
  ...
  crearFormulario(): void {
    ...
    this.registroDomiciliosRfcSolicitanteForm = this.fb.group({
      ...
      codigoPostal: ['', [Validators.pattern(REGEX_POSTAL)]],
 ...
 /**
  ...
  DomiciliosRfcSolicitanteInfoDatos(): void {
    ...
    this.tramite32610Store.actualizarEstado({DomiciliosRfcSolicitante: this.DomiciliosRfcSolicitanteList});
