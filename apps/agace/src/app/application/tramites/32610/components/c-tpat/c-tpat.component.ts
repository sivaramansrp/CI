...
export class CTPATComponent implements OnInit, OnDestroy {
  ...
  solicitud32610State: Solicitud32610State = {} as Solicitud32610State;
  ...
  constructor(
    ...
    public solicitud32610Query: Solicitud32610Query,
  ...
  /**
   * Inicializa el formulario `ctpatForm` con los valores actuales del estado `solicitud32610State`.
   *
  ...
  obtenerEstadoSolicitud(): void {
    this.solicitud32610Query.selectSolicitud$
  ...
  setValoresStore(form: FormGroup | null, campo: string): void {
    ...
    if (CONTROL && CONTROL.value !== null && CONTROL.value !== undefined) {
      this.solicitud32610Store.actualizarEstado({ [campo]: CONTROL.value });
    }
  }
  /**
