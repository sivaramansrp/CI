 ...
 */
export const TITULO_PASO_UNO = 'Solicitud de Registro en el Esquema de Certificación de Empresas Modalidad Socio Comercial Certificado, rubro Agente Aduanal';
/**
 * Constante que representa el título para el paso dos en el proceso.
 * Se utiliza para mostrar la etiqueta "Cargar archivos" en la interfaz de usuario.
 */
