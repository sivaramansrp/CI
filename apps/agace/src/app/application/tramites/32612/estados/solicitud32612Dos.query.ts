import { Solicitude32612DosState, Tramite32612DosStore } from './solicitud32612Dos.store';
...
export class Tramite32612DosQuery extends Query<Solicitude32612DosState> {
   ...
   */
  constructor(protected override store: Tramite32612DosStore) {
    super(store);
  }
}
