...
export const TEXTOS_ESTATICOS_PLANEACION = {
    paraca1: 'El Agente Aduanal debe elaborar políticas y procedimientos documentados para llevar a cabo un análisis que le permita la identificación de riesgos y debilidades en su cadena de suministros con el objeto de implementar estrategias que ayuden a mitigar el riesgo en sus operaciones.',
    encabezamiento1: '1.1 Análisis de riesgo.',
    paraca2: 'Asimismo, para construir un programa sólido de seguridad de la cadena de suministro, el Agente Aduanal debe de contar con un Comité de Seguridad que incorpore representantes de todos los departamentos relevantes, formando un equipo multifuncional que identifique áreas de oportunidad y proponga acciones de mejora continua a lo largo de la cadena de suministro e instalaciones del Agente Aduanal.',
    paraca3: 'De igual manera, el Agente Aduanal debe tener designados puntos de contacto para el Programa Operador Económico Autorizado, dicho personal debe involucrarse, conocer los requisitos del programa, pertenecer a la compañía y acreditar su relación con la misma, así como responder a su especialista en seguridad de la cadena de suministro (este es asignado una vez que la empresa ya cuenta con el Programa Operador Económico Autorizado).',
    paraca4: 'Si derivado del análisis de riesgo, surgen nuevas medidas de seguridad que el Agente Aduanal debe de incorporar, estas deben incluirse en los procedimientos existentes del Agente Aduanal y, en su caso, elaborar procedimientos nuevos, lo que crea una estructura más sostenible y enfatiza que la seguridad de la cadena de suministro es responsabilidad de todos.',
    paraca5: 'El Agente Aduanal debe tener medidas para identificar, analizar y mitigar los riesgos de seguridad a lo largo de la cadena de suministro, incluyendo sus instalaciones. Por lo anterior, debe contar con un procedimiento escrito y verificable para determinar el riesgo en todas sus operaciones, basado en el modelo de su organización (ejemplo: ubicación de las instalaciones, tipo de mercancía y país de origen, volumen, clientes, proveedores, rutas, contratación de personal, clasificación y manejo de documentos, Tecnologías de la Información, amenazas potenciales, etcétera) que le permita implementar y mantener medidas de seguridad apropiadas. Con base en lo anterior, el Agente Aduanal también debe tener un proceso escrito basado en su análisis de riesgo para seleccionar nuevos socios comerciales y monitorear a los socios con los que ya se encuentra trabajando.',
    paraca6: 'Este procedimiento debe ejecutarse por lo menos una vez al año, de manera que permita identificar de forma permanente otras amenazas o riesgos que se consideren en su operación y en la cadena de suministro, por el resultado de algún incidente o cuando se originen por cambios en las condiciones iniciales de las instalaciones y procesos del Agente Aduanal, así como para identificar que las políticas, procedimientos y otros mecanismos de control y seguridad se estén cumpliendo. Es importante señalar, que el Comité de Seguridad de la compa˜ía que el Agente Aduanal designe debe de participar en la elaboración y actualización del análisis de riesgo y el mantenimiento del Programa Operador Económico Autorizado.',
    paraca7: 'Se sugiere utilizar las técnicas de administración, gestión y evaluación de riesgos de acuerdo a las normas internacionales ISO 31000, ISO 31010 e ISO 28000 que, de acuerdo a su modelo de negocio deban implementar.',
    paraca8: 'Solicita y muestre el procedimiento donde se incluya el contenido de la nota explicativa siguiente:',
    paraca9: 'Anexe la matriz de riesgos, así como el procedimiento documentado para identificar riesgos en sus operaciones diarias a lo largo de la cadena de suministros y en sus instalaciones, el cual debe incluir como mínimo los siguientes puntos:',
    paraca10: 'Asimismo, deberá contemplar el proceso de apreciación y gestión del riesgo, e incluir los siguientes aspectos:',
