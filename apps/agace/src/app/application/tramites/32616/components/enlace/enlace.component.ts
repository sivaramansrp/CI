...
export class EnlaceComponent implements OnInit, OnDestroy {
   ...
   * @param tramite32616Store Store para modificar el estado del trámite.
   * @param tramite32616Query Query para consultar el estado del trámite.
   */
  constructor(
...
/**
   ...
   */
  public setValoresStore(form: FormGroup, campo: string, metodoNombre: keyof Tramite32616TercerosStore): void {
