...
export class ReprestantanteComponent implements OnInit, OnDestroy {
   ...
   *
   * @type {Solicitud32616TercerosState}
   * @memberof ReprestantanteComponent
   */
  public solicitudState!: Solicitud32616TercerosState;
   ...
   * @param {Tramite32616TercerosStore} tramite32616Store - Store encargado de manejar el estado de los datos del trámite.
   * @param {Tramite32616TercerosQuery} tramite32616Query - Query que permite consultar el estado del trámite.
   * @memberof ReprestantanteComponent
   */
  constructor(
   ...
   * @param {keyof Tramite32616TercerosStore} metodoNombre - Nombre del método en el store que se ejecutará.
   * @memberof ReprestantanteComponent
   */
  setValoresStore(
    form: FormGroup,
    campo: string,
    metodoNombre: keyof Tramite32616TercerosStore
  ): void {
