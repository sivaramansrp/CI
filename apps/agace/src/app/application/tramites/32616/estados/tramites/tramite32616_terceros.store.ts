 ...
 */
export interface Solicitud32616TercerosState {
    /**
...
/**
 * Función para crear el estado inicial de Solicitud32616Terceros.
 * @returns {Solicitud32616TercerosState} El estado inicial de Solicitud32616Terceros.
 */
export function createInitialState(): Solicitud32616TercerosState {
    return {
        /**
         * El valor de resigtro.
         */
 ...
 */
@StoreConfig({ name: 'tramite32616Terceros', resettable: true })

export class Tramite32616TercerosStore extends Store<Solicitud32616TercerosState>{
    /**
