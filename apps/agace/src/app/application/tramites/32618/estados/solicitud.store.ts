...
/**
 * Crea el estado inicial para `SolicitudState`.
 *
 * @returns El estado inicial con valores predeterminados.
 */
export function createInitialSolicitudState(): SolicitudState {
  return {
    idPersonaSolicitud: '',
    rfcTercero: '',
    rfc: '',
...
@StoreConfig({
  name: 'solicitud'})
/** Clase encargada de manejar el estado de 'Solicitud' mediante el uso de un store.
