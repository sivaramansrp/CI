...
export class PerfilesFerrovarioComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  /** Constructor que inyecta los servicios necesarios para gestionar el estado, las consultas y la creación de formularios en el trámite 32618. */
  constructor(
  ...
  textValorCambio(event: Event, campo: string, index?: number): void {
    ...
    if (typeof index === 'number') {
      ...
      this.tramite32618Store.setDynamicFieldValue('otrasCertificaciones', ARRAY_VALOR);
    }
  }
