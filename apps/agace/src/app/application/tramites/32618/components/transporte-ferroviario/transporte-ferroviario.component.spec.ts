...
describe('TransporteFerroviarioComponent', () => {
  ...
  let storeMock: Partial<Tramite32618Store>;
  let queryMock: Partial<Tramite32618Query>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        FormBuilder,
        { provide: Tramite32618Store, useValue: storeMock },
        { provide: Tramite32618Query, useValue: queryMock },
