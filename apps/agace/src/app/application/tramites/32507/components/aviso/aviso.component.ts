...
import { FECHA_INGRESO, TEXTOS, TIPACA, TIPAVI ,REGEX_ALFANUMERICO_CON_ESPACIOS_REEMPLAZAR, RADIO_OPCIONS} from "../../constants/avios-procesos.enum";
...
export class AvisoComponent implements OnInit, OnDestroy {
  ...
  */
   ...
   * @param {EntregaActaService} entregaActaService - Servicio para obtener datos relacionados con el aviso.
