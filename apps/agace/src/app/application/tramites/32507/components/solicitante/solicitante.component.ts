...
export class SolicitanteComponent implements OnInit, OnDestroy {
  ...
  /**
   * Estado actual del trámite 32507.
   * 
   ...
   * @param {Tramite32507Store} store - Store para gestionar el estado del trámite.
   * @param {Tramite32507Query} tramiteQuery - Query para obtener el estado del trámite.
   * @param {AvisoTrasladoService} entregaActaService - Servicio para obtener datos relacionados con el solicitante.
   */
  constructor(
  ...
  cargarDatosSolicitante(): void {
    this.entregaActaService.obtenerDatosSolicitante().pipe(
