 ...
 */
export interface Solicitud32615TercerosState {
    /**
...
/**
 * Función para crear el estado inicial de Solicitud32615Terceros.
 * @returns {Solicitud32615TercerosState} El estado inicial de Solicitud32615Terceros.
 */
export function createInitialState(): Solicitud32615TercerosState {
    return {
        /**
         * El valor de resigtro.
         */
 ...
 */
@StoreConfig({ name: 'tramite32615Terceros', resettable: true })

export class Tramite32615TercerosStore extends Store<Solicitud32615TercerosState>{
    /**
