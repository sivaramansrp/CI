import { ArchivoDocumentos, AvisoFormulario, DatosSolicitante, DomicilioFormulario, MercanciaFormulario, TipoDocumento } from '../../tramites/32507/models/aviso-traslado.model';
