...
/**
 * Representa el estado de CancelacionGarantia270101State.
 * Es un objeto dinámico donde las claves son cadenas y los valores pueden ser de cualquier tipo.
 *
 * @interface CancelacionGarantia270101State
 ...
 */
export interface CancelacionGarantia270101State {
  [key: string]: unknown;
}

/**
 * Crea el estado inicial para ExportarIlustraciones270101.
 * @returns {CancelacionGarantia270101State} Un objeto vacío que representa el estado inicial del estado de CancelacionGarantia270101State.
 */
export function createInitialState(): CancelacionGarantia270101State {
  return {};
}
 ...
 */
@StoreConfig({ name: 'tramite31401', resettable: true })
export class Tramite31401Store extends Store<CancelacionGarantia270101State> {
  /**
