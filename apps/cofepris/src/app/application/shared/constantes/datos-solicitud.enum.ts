 ...
 */
export const BANCO = [
  260104,260208, 260209, 260207, 260201, 260219, 260302, 260304, 260103, 260217, 260218, 260301
];
 ...
 */
export const MOSTRAR_NOTIFICACION = [260219,260302,260304, 260206, 260201,260103,260203, 260301];
