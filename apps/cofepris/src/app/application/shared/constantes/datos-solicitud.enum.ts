...
export const PROCEDIMIENTOS_NO_PARA_ELEMENTO_COLAPSABLE = [
  260214, 260216, 260205, 260217, 260218, 260102,260301, 260208,260207, 260209,260201, 260219,260302, 260304
];
 ...
 * }
 */
export const PROCEDIMIENTOS_NO_PARA_ELEMENTO_RFC_DEL_SANITARIO = [260301, 260208,260302, 260304];
 ...
 * }
 */
export const PROCEDIMIENTOS_NO_PARA_ELEMENTO_REGIMEN_Y_ADUNADEENTRADAS = [260301,260302, 260304];
 ...
 * }
 */
export const BANCO = [260208, 260209, 260207, 260201, 260219,260302, 260304];
 ...
 * }
 */
export const PROCEDIMIENTOS_PARA_DESHABILITAR_APELLIDO_MATERNO=[260301,260207,260201,260302, 260304]
 ...
 * }
 */
export const PROCEDIMIENTOS_PARA_DESHABILITAR_APELLIDO_PATERNO=[260301,260207,260201,260302, 260304]
 ...
 * }
 */
export const PROCEDIMIENTOS_PARA_DESHABILITAR_NOMBRE_RAZON_SOCIAL=[260301,260207,260201,260302, 260304]
