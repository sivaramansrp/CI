...
*/
  ...
  configurarGrupoForm(): void {
    this.datosSolicitudform = this.formBuilder.group({
      ...
      establecimientoDomicilioCodigoPostal: [this.solicitudState?.establecimientoDomicilioCodigoPostal, [Validators.required,Validators.pattern('^[0-9]{5}$')]],
    ...
    Validators.pattern(/^[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ\s.\-#]{2,}$/)
      ...
      lada: [this.solicitudState?.lada,[Validators.pattern('^[0-9]{2,3}$')]],
      telefono: [this.solicitudState?.telefono, Validators.required,Validators.pattern('^[0-9]{7,8}$')],
