 ...
 */
@Component({
  selector: 'app-agregar-proveedor-modificacion',
  standalone: true,
  imports: [
    CommonModule,
...
export class AgregarProveedorModificacionComponent implements OnDestroy, OnInit, OnChanges {
 /**
...
guardarProveedor(): void {
  ...
  const PAIS_OBJ = AgregarProveedorModificacionComponent.generarCatalogoObjeto(this.paisesDatos, PAIS_ID);
