...
/**
 * Crea el estado inicial para Solicitud260503State.
 * @returns {Solicitud260503State} Un objeto vacío que representa el estado inicial del estado de Solicitud260503State.
 */
export function createInitialState(): Solicitud260503State {
    return {
        idSolicitud: 0,
        formValidity: {},
    };
 ...
 */
@StoreConfig({ name: 'tramite260503', resettable: true })

/**
 * Clase que representa el store para Tramite260503.
 * Extiende la clase Store de Akita para gestionar el estado de Solicitud260503State.
 */
export class Tramite260503Store extends Store<Solicitud260503State> {

    /**
     * Constructor de la clase Tramite260503Store.
     * 
