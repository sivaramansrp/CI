 ...
 */
export interface Solicitud260508State {
    [key: string]: any;
    idSolicitud: number;
    formValidity?: {
...
/**
 * Crea el estado inicial para Solicitud260508State.
 * @returns {Solicitud260508State} Un objeto vacío que representa el estado inicial del estado de Solicitud260508State.
 */
export function createInitialState(): Solicitud260508State {
    return {
        idSolicitud: 0,
        formValidity: {},
    };
...
/**
 * Configuración del store para Tramite260508.
 * 
 ...
 */
@StoreConfig({ name: 'tramite260508', resettable: true })

/**
 * Clase que representa el store para Tramite260508.
 * Extiende la clase Store de Akita para gestionar el estado de Solicitud260508State.
 */
export class Tramite260508Store extends Store<Solicitud260508State> {

    /**
     * Constructor de la clase Tramite260508Store.
     * 
