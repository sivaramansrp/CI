...
/**
 * Interfaz que representa el estado de Solicitud2603.
 */
export interface Solicitud2603State {
    /**
...
/**
 * Función para crear el estado inicial de Solicitud2603State.
 * @returns {Solicitud2603State} El estado inicial de Solicitud260211State.
 */
export function createInitialState(): Solicitud2603State {
    return {
        denominacionRazon: '',
        codigoPostal: '',
        estado: '',
 ...
 */
@StoreConfig({ name: 'tramite2603', resettable: true })

export class Tramite2603Store extends Store<Solicitud2603State>{
    /**
     * Crea una instancia de Tramite2603Store.
