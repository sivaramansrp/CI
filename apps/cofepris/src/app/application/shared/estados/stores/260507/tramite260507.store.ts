 ...
 */
export interface Solicitud260507State {
    [key: string]: any;
    idSolicitud: number;
    formValidity?: {
...
/**
 * Crea el estado inicial para Solicitud260507State.
 * @returns {Solicitud260507State} Un objeto vacío que representa el estado inicial del estado de Solicitud260507State.
 */
export function createInitialState(): Solicitud260507State {
    return {
        idSolicitud: 0,
        formValidity: {},
    };
...
/**
 * Configuración del store para Tramite260507.
 * 
 ...
 */
@StoreConfig({ name: 'tramite260507', resettable: true })

/**
 * Clase que representa el store para Tramite260507.
 * Extiende la clase Store de Akita para gestionar el estado de Solicitud260507State.
 */
export class Tramite260507Store extends Store<Solicitud260507State> {

    /**
     * Constructor de la clase Tramite260507Store.
     * 
