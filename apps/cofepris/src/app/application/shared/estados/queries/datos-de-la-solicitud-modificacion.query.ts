import { DatosSolicitudState, DatosSolicitudStore } from '../stores/datos-de-la-solicitud-modificacion.store';
...
export class DatosSolicitudQuery extends Query<DatosSolicitudState> {
  /**
   ...
   */
  constructor(protected override store: DatosSolicitudStore) {
    super(store);
  }
}