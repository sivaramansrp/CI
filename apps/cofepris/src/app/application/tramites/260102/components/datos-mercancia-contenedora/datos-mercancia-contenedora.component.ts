...
export class DatosMercanciaContenedoraComponent implements OnInit {
  ...
  /**
   * @property {Tramite260102State} tramiteState
   ...
   *
   * @param Tramite260102Query - Servicio para observar el estado actual del trámite.
   * @param Tramite260102Store - Store que permite actualizar el estado del trámite.
   */
  constructor(
