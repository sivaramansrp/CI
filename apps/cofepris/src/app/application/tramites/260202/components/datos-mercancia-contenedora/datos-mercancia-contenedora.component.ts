...
export class DatosMercanciaContenedoraComponent implements OnInit {
   ...
   *
   * @param tramite260202Query - Servicio para observar el estado actual del trámite.
   * @param tramite260202Store - Store que permite actualizar el estado del trámite.
   */
  constructor(
