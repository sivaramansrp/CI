/**
 * Componente utilizado en el trámite 260214 para gestionar la funcionalidad del paso dos.
 *
 ...
 * @description
 * Componente que gestiona la funcionalidad del paso dos del trámite 260214.
