...
import { DestinatarioCapturarColumns } from '../../models/destinatario-datos.model';
  ...
  const mockFabricanteData: CapturarColumns[] = [
    {
      ...
      Colonia_o_equivalente: "---",
      Código_postal: "56979",
      Entidad_federativa: "MÉXICO",
      Estado_localidad: "---",
      Localidad: "LAS DELICIAS",
      Municipio_o_alcaldía: "ATLAUTLA",
      Nombre_denominación_o_razón_social: "AGRICOLA ALPE, S DE RL DE CV",
      País: "MEXICO(ESTADOS UNIDOS MEXICANOS)",
      calle: "Ok",
      correo_electrónico: "D@GMAIL.COM",
      curp: "---",
      número_exterior: 23,
      número_interior: 33,
      r_f_c: "AAL0409235E6",
