...
export class TercerosRelacionadosService {
  ...
  proveedorTableLink = 'assets/json/260904/proveedor-de-tabla.json'; // Updated path

  facturadorTableLink = 'assets/json/260904/facturador-de-tabla.json'; // Updated path
   ...
   * ```
   */
  obtenerInformacionDeTablaDeFabricantes(): Observable<any> {
