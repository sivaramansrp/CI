...
import { Tramite260217State } from '../estados/tramite260217Store.store';


@Injectable({
  providedIn: 'root'
})
export class GuardarAdapter_260217 {
  /**
   ...
   */
  static toFormPayload(state: Tramite260217State): unknown {
    return {
      "solicitante": {
        "rfc": "AAL0409235E6",
