...
export class DatosMercanciaContenedoraComponent implements OnInit, OnDestroy {
   ...
   *
   * @param tramite260217Query - Servicio para observar el estado actual del trámite.
   * @param tramite260217Store - Store que permite actualizar el estado del trámite.
   */
  constructor(
