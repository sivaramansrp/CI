...
describe('ModificacionPermisoSanitarioLaSaludComponent', () => {
  let componente: ModificacionPermisoSanitarioLaSaludComponent;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [ModificacionPermisoSanitarioLaSaludComponent, MockWizardComponent],
      schemas: [CUSTOM_ELEMENTS_SCHEMA],
    }).compileComponents();

    fixture = TestBed.createComponent(ModificacionPermisoSanitarioLaSaludComponent);
