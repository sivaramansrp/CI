...
/**
 * @service
 * @name ImportacionProductosService
 * @description
 * Servicio que proporciona métodos para realizar solicitudes HTTP relacionadas con el trámite 260101.
...
export class ImportacionProductosService {
  /**
   * Creates an instance of ImportacionProductosService.
   *
  ...
  getRegistroTomaMuestrasMercanciasData(): Observable<Tramite260101State> {
    return this.http.get<Tramite260101State>(
      'assets/json/260101/respuestaDeActualizacionDe.json'
    );
  }
  ...
  getDestinatarioTablaDatos(): Observable<Destinatario[]> {
    return this.http.get<Destinatario[]>(
      'assets/json/260101/destinatario-final.json'
    );
  }
  ...
  getProveedorTablaDatos(): Observable<Proveedor[]> {
    return this.http.get<Proveedor[]>('assets/json/260101/proveedor.json');
  }
  ...
  getFacturadorTablaDatos(): Observable<Facturador[]> {
    return this.http.get<Facturador[]>('assets/json/260101/facturador.json');
  }
}
