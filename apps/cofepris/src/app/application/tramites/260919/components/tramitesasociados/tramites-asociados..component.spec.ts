...
describe('TramitesAsociadosComponent', () => {
  ...
  it('should run #getTramitesAsociados()', async () => {
    ...
    component.importarDeRemediosHerbals.getTramitesAsociados = jest.fn().mockReturnValue(observableOf({}));
    component.getTramitesAsociados();
    expect(component.importarDeRemediosHerbals.getTramitesAsociados).toHaveBeenCalled();
  });
