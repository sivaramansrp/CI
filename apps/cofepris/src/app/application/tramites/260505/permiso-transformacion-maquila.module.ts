...
import { PermisoTransformacionMaquilaRoutingModule } from './permiso-transformacion-maquila-routing.module';
...
@NgModule({
  ...
  imports: [
    CommonModule,
    PermisoTransformacionMaquilaRoutingModule,
    AlertComponent,
    AnexarDocumentosComponent,
    BtnContinuarComponent,
    FirmaElectronicaComponent,
...
export class PermisoTransformacionMaquilaModule {}
