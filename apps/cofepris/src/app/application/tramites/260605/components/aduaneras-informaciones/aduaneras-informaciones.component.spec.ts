...
describe('AduanerasInformacionesComponent', () => {
  ...
  //   const spy = jest.spyOn(tramite260605Store, 'setNumeroDePermiso');
  //   component.setValoresStore(component.aduanerasInformacionesForm, 'numeroDePermiso', 'setNumeroDePermiso');
  //   expect(spy).toHaveBeenCalledWith(mockSolicitudState.numeroDePermiso);
  // });
