...
describe('PaginasComponent', () => {
  ...
  it('debería actualizar el índice y navegar hacia adelante cuando getValorIndice es llamado con "cont"', () => {
  ...
  it('debería actualizar el índice y navegar hacia atrás cuando getValorIndice es llamado con "atras"', () => {
    const mockWizardComponent = {
      siguiente: jest.fn(),
      atras: jest.fn(),
    };
  ...
  it('no debería actualizar el índice ni llamar métodos de navegación si el valor está fuera de rango', () => {
    const mockWizardComponent = {
      siguiente: jest.fn(),
      atras: jest.fn(),
    };
