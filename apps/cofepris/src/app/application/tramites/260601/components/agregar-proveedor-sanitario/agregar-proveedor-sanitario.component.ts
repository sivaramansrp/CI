 ...
 */
@Component({
  selector: 'app-agregar-proveedor-sanitario',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './agregar-proveedor-sanitario.component.html',
  styleUrl: './agregar-proveedor-sanitario.component.css',
})
export class AgregarProveedorSanitarioComponent implements OnInit, OnDestroy {
  /**
  ...
  updateProveedorTablaDatos(event: Proveedor[]): void {
      this.tramite260601Store.updateProveedorTablaDatos(event);
    }
