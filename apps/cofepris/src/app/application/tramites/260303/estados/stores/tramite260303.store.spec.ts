import { Solicitud260303State, Tramite260303Store, createInitialState } from './tramite260303.store';

describe('Tramite260303Store', () => {
  let store: Tramite260303Store;

  beforeEach(() => {
    store = new Tramite260303Store();
  });
...
describe('Solicitud260303State interface', () => {
	it('should create a valid state object', () => {
		const state: Solicitud260303State = {
