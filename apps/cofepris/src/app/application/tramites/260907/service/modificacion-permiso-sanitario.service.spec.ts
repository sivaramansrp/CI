...
import { ModificacionPermisoImportacionSanitario } from './modificacion-permiso.service';
import { HttpClient } from '@angular/common/http';
import { of } from 'rxjs';

describe('ModificacionPermisoImportacionSanitario', () => {
  let service: ModificacionPermisoImportacionSanitario;
  let httpMock: any;
  ...
  beforeEach(() => {
    ...
    service = new ModificacionPermisoImportacionSanitario(
      httpMock as any,
