...
describe('ModificacionPermisoImportacionTratamientosComponent', () => {
  let componente: ModificacionPermisoImportacionTratamientosComponent;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [ModificacionPermisoImportacionTratamientosComponent, MockWizardComponent],
