...
export interface Mercancia {
  ...
  /** Distintiva asociada al producto. */
  distintiva: string;

  /** Cientifico asociada al producto. */
  cientifico: string;
...
export interface MercanciaCatalogos {
  ...
  /** Catálogo de formas farmacéuticas disponibles. */
  farmaceuticaCatalogo: CatalogosSelect;

  /** Catálogo de estados físicos disponibles. */

  fisicoCatalogo: CatalogosSelect;
