...
describe('ModificarDestinatarioComponent', () => {
  ...
  it('should update store on setTipoPersona', () => {
    ...
    expect(solicitud260910Store.setTipoPersona).toHaveBeenCalledWith('fisica');
  });
  ...
  it('should update store on setModificarRFC', () => {
    ...
    expect(solicitud260910Store.setModificarRFC).toHaveBeenCalledWith('RFC123456');
  });
  ...
  it('should update store on setDenominacion', () => {
    ...
    expect(solicitud260910Store.setDenominacion).toHaveBeenCalledWith('Denominacion');
  });
  ...
  it('should not save if form is invalid', () => {
    ...
    expect(solicitud260910Store.addDestinatarioDato).not.toHaveBeenCalled();
  });
  ...
  it('should save if form is valid', () => {
    ...
    component.guardarDestinatario();
    expect(solicitud260910Store.addDestinatarioDato).toHaveBeenCalled();
  });
