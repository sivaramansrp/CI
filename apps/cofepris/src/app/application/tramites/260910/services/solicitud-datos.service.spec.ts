...
describe('SolicitudDatosService', () => {
  ...
  it('should fetch datos de solicitud', () => {
    const MOCK_DATA: DatosDeSolicitud = {
      ...
      "tipoOperacionOptions": [
        {
          "label": "Pr&ocute;rroga",
          "value": "PRO"
        },
        {
          "label": "Modificaci&oacute;n",
          "value": "MOD"
        },
        {
          "label": "Modificaci&oacute;n y pr&ocute;rroga",
          "value": "MOD"
        }
      ]
    };
  ...
  it('should fetch aduana listo', () => {
    ...
    const req = httpMock.expectOne('../../../assets/json/260910/aduana.json');
    expect(req.request.method).toBe('GET');
  ...
  it('should fetch mercancia listo', () => {
    ...
    const req = httpMock.expectOne(
      '../../../assets/json/260910/mercancia.json'
    );
    expect(req.request.method).toBe('GET');
  ...
  it('should fetch claves de lotes listo', () => {
    ...
    const req = httpMock.expectOne(
      '../../../assets/json/260910/claves-de-lotes.json'
    );
    expect(req.request.method).toBe('GET');
  ...
  it('should fetch destinatario listo', () => {
    ...
    const req = httpMock.expectOne(
      '../../../assets/json/260910/destinatario.json'
    );
    expect(req.request.method).toBe('GET');
  ...
  it('should fetch fabricante listo', () => {
    ...
    const req = httpMock.expectOne(
      '../../../assets/json/260910/fabricante.json'
    );
    expect(req.request.method).toBe('GET');
  ...
  it('should fetch pago derechos', () => {
    ...
    const req = httpMock.expectOne(
      '../../../assets/json/260910/pago-derechos.json'
    );
    expect(req.request.method).toBe('GET');
    req.flush(mockPago);
  });
