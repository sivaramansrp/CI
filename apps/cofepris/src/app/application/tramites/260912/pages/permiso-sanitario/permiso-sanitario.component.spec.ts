...
describe('PermisoSanitarioComponent', () => {
  ...
  beforeEach(() => {
    ...
    component = new PermisoSanitarioComponent(cdrMock, tramite260912StoreMock);
  ...
  describe('getPaymentFields', () => {
    it('should extract payment fields from state', () => {
      ...
      expect((PermisoSanitarioComponent as any).getPaymentFields(state)).toEqual(['a', 'b', 'c', 'd', 'e', 'f']);
    });
  });
});