...
describe('DomicilioDelEstablecimientoComponent', () => {
  ...
  let querySpy: jest.Mocked<Tramite260912Query>;
  let storeSpy: jest.Mocked<Tramite260912Store>;
  ...
  beforeEach(async () => {
    ...
    const dummyTramite260912$ = of({});
    querySpy = {
      selectTramite260912$: dummyTramite260912$,
    } as any;
    storeSpy = {
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        ...
        { provide: Tramite260912Query, useValue: querySpy },
        { provide: Tramite260912Store, useValue: storeSpy },
    ...
    // Set solicitudState before detectChanges to ensure ngOnInit logic runs as expected
  ...
  it('should handle onBuscarRepresentanteLegal logic', () => {
    ...
    (serviceSpy.buscarRepresentanteLegalPorRFC as jest.Mock).mockReturnValueOnce(of({ nombre: 'Test', rfc: 'validRFC' }));
  ...
  it('should set value in store with setValorStore', () => {
    ...
    expect(storeSpy.setTramite260912State).toHaveBeenCalledWith({ codigoPostal: '99999' });
  });
  ...
  it('should mark manifests as touched and update store on onManifestsChange', () => {
    ...
    expect(storeSpy.setTramite260912State).toHaveBeenCalled();
  });
