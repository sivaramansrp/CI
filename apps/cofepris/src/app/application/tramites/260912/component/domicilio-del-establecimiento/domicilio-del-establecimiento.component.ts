...
export class DomicilioDelEstablecimientoComponent implements OnInit, OnDestroy, AfterViewInit, OnChanges {
 ...
 /**
  ...
  constructor(
    ...
    private tramite260911Store: Tramite260912Store,
...
ngOnChanges(): void {
  ...
  setValorStore(FormGroup: FormGroup, control: string): void {
    ...
    this.tramite260911Store.setTramite260912State({
      [control]: VALOR
    });
  }
...
public markAllFieldsTouched(): void {
 if (this.form) {
   ...
   */
  private resetPrincipalForm(state: Tramites260912State): void {
    if (this.form) {
      this.form.reset({
   ...
   */
  private resetNicoTablaForm(state: Tramites260912State): void {
   ...
   */
  private resetRepresentanteLegalForm(state: Tramites260912State): void {
    if (this.representanteLegal) {
