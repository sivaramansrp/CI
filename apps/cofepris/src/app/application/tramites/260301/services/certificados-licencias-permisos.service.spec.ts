...
describe('CertificadosLicenciasPermisosService', () => {
    ...
    const endpoints = [
      {
        ...
        url: 'assets/json/260303/estado-catalog.json',
        type: 'EstadoCatalogResponse',
      },
      {
        method: 'getScianDatos',
        url: 'assets/json/260303/scian-tabla.json',
        type: 'ScianDatos[]',
      },
      {
        method: 'getClaveDatos',
        url: 'assets/json/260303/clave-catalog.json',
        type: 'EstadoCatalogResponse',
      },
      {
        method: 'getRegimenDatos',
        url: 'assets/json/260303/regimen-catalog.json',
        type: 'EstadoCatalogResponse',
      },
      {
        method: 'getMercanciasDatos',
        url: 'assets/json/260303/mercancias-tabla.json',
        type: 'MercanciasDatos[]',
      },
      {
        method: 'getTipoDeProductoDatos',
        url: 'assets/json/260303/tipo-de-producto-catalog.json',
        type: 'EstadoCatalogResponse',
      },
      {
        method: 'getPaisDeProcedenciaDatos',
        url: 'assets/json/260303/pais-de-procedencia-catalog.json',
        type: 'EstadoCatalogResponse',
      },
      {
        method: 'getFabricanteDatos',
        url: 'assets/json/260303/fabricante-tabla.json',
        type: 'Fabricante[]',
      },
      {
        method: 'getFacturadorDatos',
        url: 'assets/json/260303/facturador-tabla.json',
        type: 'Fabricante[]',
      },
      {
        method: 'getProveedorDatos',
        url: 'assets/json/260303/proveedor-tabla.json',
        type: 'Fabricante[]',
      },
      {
        method: 'getCertificadoDatos',
        url: 'assets/json/260303/certificado-analitico-tabla.json',
        type: 'Fabricante[]',
      },
      {
        method: 'getOtrosDatos',
        url: 'assets/json/260303/otros-tabla.json',
        type: 'Otros[]',
      },
      {
        method: 'getBancoDatos',
        url: 'assets/json/260303/banco-catalog.json',
        type: 'JSONResponse',
      },
      {
        method: 'getTipoDeDocumentoDatos',
        url: 'assets/json/260303/tipo-de-documento.json',
        type: 'JSONResponse',
      },
      {
        method: 'getFormularioData',
        url: 'assets/json/260303/inicializar-formulario.json',
        type: 'Solicitud260303State',
      },
    ];
  ...
  it('debe obtener datos correctamente para getPaisDatos', (done) => {
    ...
    service.getPaisDatos().subscribe((resp) => {
      expect(resp).toEqual(mockResponse);
      expect(httpMock.get).toHaveBeenCalledWith('assets/json/260303/pais.json');
      done();
    });
  });
