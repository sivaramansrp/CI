...
/**
 * Interfaz que representa el estado de Solicitud260301.
 */
 ...
 * @returns {Solicitud260301State} El estado inicial de Solicitud260211State.
 */
...
export class Tramite260301Store extends Store<Solicitud260301State>{
    /**
     * Crea una instancia de Tramite260301Store.
     ...
     * @param pagoDerechos - El nuevo estado del formulario de pago de derechos.
     */
    public updatePagoDerechos(pagoDerechos: PagoDerechosFormState): void {
        this.update((state) => ({
            ...state,
            pagoDerechos,
        }));
