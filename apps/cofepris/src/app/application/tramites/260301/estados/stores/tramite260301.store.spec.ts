import { Solicitud260301State, Tramite260301Store, createInitialState } from './tramite260301.store';

describe('Tramite260301Store', () => {
  let store: Tramite260301Store;

  beforeEach(() => {
    store = new Tramite260301Store();
  });
...
describe('Solicitud260301State interface', () => {
	it('should create a valid state object', () => {
		const state: Solicitud260301State = {
