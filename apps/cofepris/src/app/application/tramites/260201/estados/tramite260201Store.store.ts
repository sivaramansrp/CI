 ...
 * @description
 * Crea el estado inicial para la tienda del trámite 260201.
 * @returns {Tramite260201State} Estado inicial.
 */
export function createInitialState(): Tramite260201State {
  return {
    idSolicitud: 0,
...
@StoreConfig({ name: 'tramite260201', resettable: true })
/**
 * @class
 * @name Tramite260201Store
 * @description
 * Tienda para manejar el estado del trámite 260201. Proporciona métodos para actualizar
 * diferentes partes del estado.
 * @extends {Store<Tramite260201State>}
 */
export class Tramite260201Store extends Store<Tramite260201State> {
  constructor() {
