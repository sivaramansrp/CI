import {
  Tramite260201State,
  Tramite260201Store,
} from './tramite260201Store.store';
import { Injectable } from '@angular/core';
import { Query } from '@datorama/akita';

/**
 * @class
 * @name Tramite260201Query
 * @description
 ...
 *
 * @extends {Query<Tramite260201State>}
 */
@Injectable({ providedIn: 'root' })
export class Tramite260201Query extends Query<Tramite260201State> {
  /**
   * @constructor
   * @description
   * Inicializa la consulta con la tienda correspondiente.
   *
   * @param {Tramite260201Store} store - La tienda que contiene el estado del trámite 260201.
   */
  constructor(protected override store: Tramite260201Store) {
    super(store);
  }
  /**
   * @property {Observable<Tramite260201State>} selectTramiteState$
   * @description
