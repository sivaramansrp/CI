...
export class DatosMercanciaContenedoraComponent implements OnInit {
   ...
   *
   * @param tramite260201Query - Servicio para observar el estado actual del trámite.
   * @param tramite260201Store - Store que permite actualizar el estado del trámite.
   */
  constructor(
