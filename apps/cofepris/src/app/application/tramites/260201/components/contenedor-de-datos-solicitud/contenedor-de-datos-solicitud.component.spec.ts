...
describe('ContenedorDeDatosSolicitudComponent', () => {
  ...
  let mockTramite260201Query: jest.Mocked<Tramite260201Query>;
  let mockTramite260201Store: jest.Mocked<Tramite260201Store>;
  ...
  beforeEach(() => {
    ...
    } as unknown as jest.Mocked<Tramite260201Query>; // Cast to jest.Mocked type
    ...
    } as unknown as jest.Mocked<Tramite260201Store>; // Cast to jest.Mocked type
  ...
  it('opcionSeleccionado should call updateOpcionConfigDatos on the store', () => {
    ...
    expect(mockTramite260201Store.updateOpcionConfigDatos).toHaveBeenCalledWith(mockEvent);
  });
  ...
  it('scianSeleccionado should call updateScianConfigDatos on the store', () => {
    ...
    expect(mockTramite260201Store.updateScianConfigDatos).toHaveBeenCalledWith(mockEvent);
  });
  ...
  it('mercanciasSeleccionado should call updateTablaMercanciasConfigDatos on the store', () => {
    ...
    expect(mockTramite260201Store.updateTablaMercanciasConfigDatos).toHaveBeenCalledWith(mockEvent);
  });
  ...
  it('datasolicituActualizar should call updateDatosSolicitudFormState on the store', () => {
    ...
    expect(mockTramite260201Store.updateDatosSolicitudFormState).toHaveBeenCalledWith(mockEvent);
  });
  ...
  it('datosDeTablaSeleccionados should call update on the store with correct data', () => {
    ...
    expect(mockTramite260201Store.update).toHaveBeenCalled();
  });
