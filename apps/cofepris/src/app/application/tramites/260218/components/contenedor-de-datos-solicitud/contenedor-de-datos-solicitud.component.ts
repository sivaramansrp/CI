...
export class ContenedorDeDatosSolicitudComponent implements OnInit, OnDestroy{
  ...
  constructor(private tramite260218Query: Tramite260218Query,
   ...
   * 
   * Actualiza la configuración de datos en el store `tramite260218Store` 
   ...
   * 
   * Este método actualiza los datos de configuración SCIAN en el estado del trámite 260218
  ...
  /**
   * Actualiza el estado de la tienda `tramite260218Store` con los datos seleccionados
