 ...
 * Este componente utiliza el componente `AgregarFacturadorComponent` y se comunica con el estado del trámite 260218 a través del store `Tramite260218Store`.
 * 
...
export class AgregarsFacturadorContenedoraComponent {
   ...
   * 
   * @param {Facturador[]} event - Una lista de objetos de tipo `Facturador` que contiene los datos actualizados de los facturadores.
