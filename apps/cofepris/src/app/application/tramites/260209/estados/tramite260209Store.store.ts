...
/**
 * @interface
 * @name Tramite260209State
 * @description
 * Representa el estado de la tienda para el trámite 260209. Contiene datos relacionados
 * con destinatarios, facturadores, proveedores, fabricantes, formularios y configuraciones.
 */
export interface Tramite260209State {
 ...
 * @description
 * Crea el estado inicial para la tienda del trámite 260209.
 * @returns {Tramite260209State} Estado inicial.
 */
export function createInitialState(): Tramite260209State {
  return {
...
@StoreConfig({ name: 'tramite260209', resettable: true })
/**
 * @class
 * @name Tramite260209Store
 * @description
 * Tienda para manejar el estado del trámite 260209. Proporciona métodos para actualizar
 * diferentes partes del estado.
 * @extends {Store<Tramite260209State>}
 */
export class Tramite260209Store extends Store<Tramite260209State> {
  constructor() {
