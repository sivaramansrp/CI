...
import { ExportacionMateriasPrimasEstupefacientesRoutingModule } from './exportacion-materias-primas-estupefacientes-routing.module';
...
@NgModule({
  ...
  imports: [
    CommonModule,
    ExportacionMateriasPrimasEstupefacientesRoutingModule,
...
export class ExportacionMateriasPrimasEstupefacientesModule {}
