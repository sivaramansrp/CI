...
import { Tramite260302State, Tramite260302Store } from '../../estados/tramite260302Store.store';
...
export class DatosMercanciaContenedoraComponent implements OnInit, OnDestroy {
   ...
   *
   * @param tramite260302Query - Servicio para observar el estado actual del trámite.
   * @param tramite260302Store - Store que permite actualizar el estado del trámite.
   */
  constructor(
