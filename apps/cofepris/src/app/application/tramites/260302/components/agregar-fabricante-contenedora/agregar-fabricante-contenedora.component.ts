...
export class AgregarFabricanteContenedoraComponent {
   ...
   *
   * @param tramite260302Store - Store que administra el estado del trámite 260302.
   */
  constructor(public tramite260302Store: Tramite260302Store) {
  ...
  updateFabricanteTablaDatos(event: Fabricante[]): void {
    this.tramite260302Store.updateFabricanteTablaDatos(event);
  }
}
