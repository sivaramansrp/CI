...
describe('PasoUnoComponent', () => {
  ...
  it('should run #ngOnInit()', async () => {
    ...
    component.tramite260302Query.getTabSeleccionado$ = observableOf({});
    component.ngOnInit();
  ...
  it('should run #seleccionaTab()', async () => {
    ...
    component.tramite260302Store.updateTabSeleccionado = jest.fn();
    component.seleccionaTab({});
    expect(component.tramite260302Store.updateTabSeleccionado).toHaveBeenCalled();
  });
