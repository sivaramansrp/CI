...
@Component({
  selector: 'app-correccion-interna-de-la-cofepris',
  templateUrl: './correccion-interna-de-la-cofepris.component.html',
  styleUrls: ['./correccion-interna-de-la-cofepris.component.scss'],
 
})

export class CorreccionInternaDeLaCofeprisComponent {
  /**
