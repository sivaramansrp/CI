...
export class PasoUnoComponent implements OnDestroy, OnInit {
   ...
   */
   validarPasoUno(): boolean {
    const ES_TAB_VALIDO = this.contenedorDeDatosSolicitudComponent?.validarFormularioDatos() ?? false;
    // const ES_TERCEROS_VALIDO = this.tercerosRelacionadosVistaComponent.validarFormularioDatos() ?? false;
    const ES_TERCEROS_VALIDO = true;
    return (
