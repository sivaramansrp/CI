 ...
 */
  ...
  constructor(private tramite260604Query: Tramite260604Query, private tramite260604Store: Tramite260604Store, public registroSolicitudService: RegistroSolicitudService, private toastrService: ToastrService, public exportacionService: ExportacionService) {}
  ...
  getValorIndice(e: AccionBoton): void {
    ...
    if (e.accion === 'cont') {
      ...
      if(!this.pasoUnoComponent.contenedorDeDatosSolicitudComponent?.validarFormularioDatos() && this.requiresPaymentData) {
  ...
  postGuardarDatos(e: AccionBoton): void {
    const PAYLOAD = GuardarAdapter_260604.toFormPayload(this.storeData);
        ...
        if(shouldNavigate) {
          if(esValidObject(response) && esValidObject(response.datos)) {
            ...
            if(getValidDatos(DATOS.id_solicitud)) {
              this.tramite260604Store.setIdSolicitud(DATOS.id_solicitud ?? 0);
            } else {
