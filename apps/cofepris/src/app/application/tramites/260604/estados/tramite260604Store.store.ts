import { DatosSolicitudFormState } from '../../../shared/models/shared2606/datos-solicitud.model';
import { Destinatario } from '../../../shared/models/shared2606/terceros-relacionados.model';
import { Fabricante } from '../../../shared/models/shared2606/terceros-relacionados.model';
import { Facturador } from '../../../shared/models/shared2606/terceros-relacionados.model';
import { Injectable } from '@angular/core';
import { MercanciaForm } from '../../../shared/models/shared2606/datos-solicitud.model';
import { PagoDerechosFormState } from '../../../shared/models/shared2606/terceros-relacionados.model';
import { Proveedor } from '../../../shared/models/shared2606/terceros-relacionados.model';
...
import { TablaOpcionConfig } from '../../../shared/models/shared2606/datos-solicitud.model';
import { TablaScianConfig } from '../../../shared/models/shared2606/datos-solicitud.model';

/**
 * @interface
 * @name Tramite260604State
 * @description
 * Representa el estado de la tienda para el trámite 260604. Contiene datos relacionados
 * con destinatarios, facturadores, proveedores, fabricantes, formularios y configuraciones.
 */
/**
 * Representa el estado de la gestión del trámite 260604.
 */
...
/**
 * Crea el estado inicial para la gestión del trámite 260604.
 * 
 ...
 * 
 * @returns {Tramite260604State} El estado inicial del trámite 260604.
 * 
 ...
 * @description Clase que representa la tienda de estado para el trámite `260604`.
 * 
 * Esta clase extiende la funcionalidad de una tienda base (`Store`) y proporciona métodos
 * para actualizar diferentes partes del estado relacionado con el trámite `260604`.
 * 
 * @remarks
 * La clase Tramite260604Store es utilizada para gestionar el estado de la aplicación
 * en el contexto de los trámites específicos del módulo `260604`. Proporciona métodos
 * para actualizar formularios, tablas de datos y configuraciones relacionadas con el trámite.
 * 
 * @example
 * ```typescript
 * const store = new Tramite260604Store();
...
export class Tramite260604Store extends Store<Tramite260604State> {
  ...
  /**
   * Constructor de la clase `Tramite260604Store`.
   * 
   ...
   * en el contexto de los trámites relacionados con el módulo `260604`.
   * 
   * @example
   * ```typescript
   * const store = new Tramite260604Store();
