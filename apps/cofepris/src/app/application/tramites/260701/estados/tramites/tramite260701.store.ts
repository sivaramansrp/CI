...
export class Tramite260701Store extends Store<Solicitud260701State> {
  ...
  constructor() {
     ...
     */
    public setDenominacionORazonSocial(denominacionORazonSocial: string) {
        this.update((state) => ({
            ...state,
            denominacionORazonSocial,
        }));
     ...
     */
    public setMarcarEnCasoDeQueSea(marcarEnCasoDeQueSea: string) {
        this.update((state) => ({
            ...state,
            marcarEnCasoDeQueSea,
        }));
     ...
     */
    public setDenominacionSocial(denominacionSocial: string) {
        this.update((state) => ({
            ...state,
            denominacionSocial,
        }));
     ...
     */
    public setTerceroNombre(terceroNombre: string) {
        this.update((state) => ({
            ...state,
            terceroNombre,
        }));
     ...
     */
    public setNacional(nacional: string) {
        this.update((state) => ({
            ...state,
            nacional,
        }));
     ...
     */
    public setExtranjero(extranjero: string) {
        this.update((state) => ({
            ...state,
            extranjero,
        }));
     ...
     */
    public setTercerosRelacionadosMunicipio(tercerosRelacionadosMunicipio: string) {
        this.update((state) => ({
            ...state,
            tercerosRelacionadosMunicipio,
        }));
     ...
     */
    public setTercerosRelacionadosLocalidad(tercerosRelacionadosLocalidad: string) {
        this.update((state) => ({
            ...state,
            tercerosRelacionadosLocalidad,
        }));
     ...
     */
    public setTercerosRelacionadosColonia(tercerosRelacionadosColonia: string) {
        this.update((state) => ({
            ...state,
            tercerosRelacionadosColonia,
        }));
