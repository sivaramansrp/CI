...
import { PermisoNutrientesExportacionRoutingModule } from './permiso-nutrientes-exportacion-routing.module';
...
@NgModule({
  ...
  imports: [
    CommonModule,
    PermisoNutrientesExportacionRoutingModule,
    AlertComponent,
    AnexarDocumentosComponent,
    BtnContinuarComponent,
    FirmaElectronicaComponent,
...
export class PermisoNutrientesExportacionModule {}
