...
import { PASOS } from '../../models/permiso-sanitario-importacion-medicamentos-pruebas.model';
...
export class SolicitudPageComponent {
  ...
  static obtenerNombreDelTítulo(valor: number): string {
    switch (valor) {
      case 1:
        return 'Permiso sanitario de importación de medicamentos destinados a pruebas de laboratorio';
      case 2:
