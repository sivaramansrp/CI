...
describe('ContenedorDeDatosSolicitudComponent', () => {
  ...
  let mockTramite260210Query: jest.Mocked<Tramite260210Query>;
  let mockTramite260214Store: jest.Mocked<Tramite260214Store>;

  beforeEach(() => {
    mockTramite260210Query = {
      selectTramiteState$: of({
        opcionConfigDatos: [],
        scianConfigDatos: [],
        tablaMercanciasConfigDatos: [],
      }) as any, // Ensure compatibility with the expected type
    } as unknown as jest.Mocked<Tramite260210Query>; // Cast to jest.Mocked type
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        { provide: Tramite260210Query, useValue: mockTramite260210Query },
  ...
  it('opcionSeleccionado should call updateOpcionConfigDatos on the store', () => {
    ...
    expect(mockTramite260214Store.updateOpcionConfigDatos).toHaveBeenCalledWith(
      mockEvent
    );
  });
  ...
  it('mercanciasSeleccionado should call updateTablaMercanciasConfigDatos on the store', () => {
    ...
    expect(
      mockTramite260214Store.updateTablaMercanciasConfigDatos
  ...
  it('datasolicituActualizar should call updateDatosSolicitudFormState on the store', () => {
    ...
    expect(
      mockTramite260214Store.updateDatosSolicitudFormState
    ).toHaveBeenCalledWith(mockEvent);
  });
