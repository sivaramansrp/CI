/**
 * Servicio para la modificación de permisos sanitarios.
 * Este servicio se encarga de manejar la lógica relacionada con la modificación de permisos sanitarios,
 */
...
/**
 * ModificacionPermisoSanitarioService es un servicio que maneja la lógica de negocio
 * relacionada con la modificación de permisos sanitarios.
 */
...
/**
 * ModificacionPermisoSanitarioService
 * Este servicio se encarga de manejar la lógica relacionada con la modificación de permisos sanitarios,
 */
export class ModificacionPermisoSanitarioService {
  /**
