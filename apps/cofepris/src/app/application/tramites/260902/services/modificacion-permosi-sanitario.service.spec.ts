...
import { ModificacionPermisoSanitarioService } from './modificacion-permosi-sanitario.service';
import { HttpClient } from '@angular/common/http';
import { of } from 'rxjs';

describe('ModificacionPermisoSanitario', () => {
  let service: ModificacionPermisoSanitarioService;
  let httpMock: any;
  ...
  beforeEach(() => {
    ...
    service = new ModificacionPermisoSanitarioService(
      httpMock as any,
