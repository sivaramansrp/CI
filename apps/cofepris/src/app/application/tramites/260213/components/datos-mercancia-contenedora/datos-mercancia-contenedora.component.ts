...
export class DatosMercanciaContenedoraComponent implements OnInit {
   ...
   *
   * @param Tramite260213Query - Servicio para observar el estado actual del trámite.
   * @param Tramite260213Store - Store que permite actualizar el estado del trámite.
   */
  constructor(
