...
export class PagoDeDerechosContenedoraComponent implements OnDestroy {
   ...
   * Inicializa el store `Tramite260212Store` para gestionar el estado del trámite y el query `ConsultaioQuery`
   ...
   *
   * @param {Tramite260212Store} tramiteStore - Store que administra el estado del trámite 260214.
