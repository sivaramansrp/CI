...
export class TercerosRelacionadosVistaComponent implements OnInit {
   ...
   *
   * @param {Tramite260212Store} tramiteStore - Store que gestiona el estado global
   ...
   *
   * @param {Tramite260212Query} tramiteQuery - Servicio de consulta que expone
