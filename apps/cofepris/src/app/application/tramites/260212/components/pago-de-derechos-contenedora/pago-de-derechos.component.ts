...
import { ID_PROCEDIMIENTO } from '../../constantes/permiso-maquila.enum';
...
export class PagoDeDerechosContenedoraComponent implements OnDestroy{
  ...
  /**
   * @constructor
   * @description Constructor que inyecta el store `Tramite260212Store` para gestionar el estado del trámite.
   * Inicializa la propiedad `pagoDerechos` con el valor actual del store.
   *
   * @param tramiteStore - Store que administra el estado del trámite 260212.
   */
  /**
   ...
   */
  constructor(public tramiteStore: Tramite260212Store, public consultaQuery: ConsultaioQuery) {
