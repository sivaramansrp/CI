...
import { Otros260304 } from "@libs/shared/data-access-user/src/core/models/260304/certificados-licencias-permisos.model";
 ...
 * Cada elemento define el encabezado de la columna y la clave correspondiente del modelo Otros260304.
 * @type {Array<{encabezado: string, clave: keyof Otros260304}>}
 */
export const OTROS_TABLA:Array<{ encabezado: string; clave: keyof Otros260304 }> = [
