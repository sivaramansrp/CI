...
import { ExportacionMedicamentosContenganRoutingModule } from './exportacion-medicamentos-contengan-routing.module';
...
@NgModule({
  ...
  imports: [
    CommonModule,
    ExportacionMedicamentosContenganRoutingModule,
...
export class ExportacionMedicamentosContenganModule {}
