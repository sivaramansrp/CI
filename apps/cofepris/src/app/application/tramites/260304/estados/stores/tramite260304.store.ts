 ...
 */
export interface Solicitud260304State {
...
/**
 * Función para crear el estado inicial de Solicitud260304State.
 * @returns {Solicitud260304State} El estado inicial de Solicitud260211State.
 */
export function createInitialState(): Solicitud260304State {
    return {
...
export class Tramite260304Store extends Store<Solicitud260304State>{
    /**
