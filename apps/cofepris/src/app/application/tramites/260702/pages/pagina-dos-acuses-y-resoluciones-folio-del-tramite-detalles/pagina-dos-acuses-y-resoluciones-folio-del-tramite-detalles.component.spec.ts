...
import { PaginaDosAcusesYResolucionesFolioDelTramiteDetallesComponent } from './pagina-dos-acuses-y-resoluciones-folio-del-tramite-detalles.component';
...
describe('AcusesYResolucionesDetalles11105Component', () => {
  let component: PaginaDosAcusesYResolucionesFolioDelTramiteDetallesComponent;
  let fixture: any;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [
        ...
        PaginaDosAcusesYResolucionesFolioDelTramiteDetallesComponent,
      ],
      declarations: [],
    }).compileComponents();
