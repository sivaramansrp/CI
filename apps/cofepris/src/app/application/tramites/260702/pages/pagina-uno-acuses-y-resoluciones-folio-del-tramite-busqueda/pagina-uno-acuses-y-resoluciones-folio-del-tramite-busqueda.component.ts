 ...
 */
@Component({
  selector: 'pagina-uno-acuses-y-resoluciones-folio-del-tramite-busqueda',
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule,
  ...
  templateUrl: './pagina-uno-acuses-y-resoluciones-folio-del-tramite-busqueda.component.html',
  styleUrl: './pagina-uno-acuses-y-resoluciones-folio-del-tramite-busqueda.component.scss',
})
export class PaginaUnoAcusesYResolucionesFolioDelTramiteBusquedaComponent {
  /**
