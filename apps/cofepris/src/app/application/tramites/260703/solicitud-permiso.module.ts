...
import { AlertComponent, BtnContinuarComponent, CatalogoSelectComponent, InputRadioComponent, SolicitanteComponent, TablaDinamicaComponent, TituloComponent, WizardComponent } from '@ng-mf/data-access-user';
...
@NgModule({
  declarations: [PasoUnoComponent,DatosComponent, DatosSolitudeComponent,DatosDelEstablecimientoComponent, ManifiestosYDeclaracionesComponent,RepresentanteLegalComponent, TercerosRelacionadosComponent],
  imports: [
    CommonModule, 
