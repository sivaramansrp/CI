...
/**
 * ActualizacionImportacionService es un servicio que maneja la lógica de negocio
 *  relacionada con la actualización de importación de mercancías biológicas.
 * Este servicio se encarga de manejar la lógica relacionada con la actualización de importación de mercancías biológicas,
 */
...
/**
 * ActualizacionImportacionService
 * Este servicio se encarga de manejar la lógica relacionada con la actualización de importación de mercancías biológicas,
 */
export class ActualizacionImportacionService {
  /**
