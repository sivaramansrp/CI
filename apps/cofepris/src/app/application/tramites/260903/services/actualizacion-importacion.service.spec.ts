...
import { ActualizacionImportacionService } from './actualizacion-importacion.service';
import { HttpClient } from '@angular/common/http';
import { of } from 'rxjs';

describe('ModificacionPermisoSanitario', () => {
  let service: ActualizacionImportacionService;
  let httpMock: any;
  ...
  beforeEach(() => {
    ...
    service = new ActualizacionImportacionService(
      httpMock as any,
