...
export class Tramite260906Store extends Store<Solicitud260906State>{
     ...
     */
    public setTipoOperacionJustificacion(tipoOperacionJustificacion: string) {
        this.update((state) => ({
            ...state,
            tipoOperacionJustificacion,
        }));
    ...
    /**
     * Establece el estado de ormaFarmaceutica.
     * @param ormaFarmaceutica - El valor de ormaFarmaceutica.
     */
    public setFormaFarmaceutica(formaFarmaceutica: string) {
        this.update((state) => ({
            ...state,
            formaFarmaceutica,
        }));
