 ...
 */
export interface Solicitud260512State {
    [key: string]: any;
    idSolicitud: number;
    formValidity?: {
...
/**
 * Crea el estado inicial para Solicitud260512State.
 * @returns {Solicitud260512State} Un objeto vacío que representa el estado inicial del estado de Solicitud260512State.
 */
export function createInitialState(): Solicitud260512State {
    return {
        idSolicitud: 0,
        formValidity: {},
    };
...
export class Tramite260512Store extends Store<Solicitud260512State> {

    /**
     * Constructor de la clase Tramite260512Store.
     * 
