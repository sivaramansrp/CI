...
/**
 * Crea el estado inicial para Solicitud260514State.
 * @returns {Solicitud260514State} Un objeto vacío que representa el estado inicial del estado de Solicitud260514State.
 */
 ...
 */
@StoreConfig({ name: 'tramite260514', resettable: true })

export class Tramite260514Store extends Store<Solicitud260514State> {

    /**
     * Constructor de la clase Tramite260514Store.
     * 
