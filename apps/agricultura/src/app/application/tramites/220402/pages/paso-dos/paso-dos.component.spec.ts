...
import { AnexarDocumentosComponent, CatalogosService, TituloComponent } from '@ng-mf/data-access-user';
...
describe('PasoDosComponent', () => {
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      imports: [TituloComponent, AnexarDocumentosComponent, AlertComponent],
      providers: [
        ToastrService,
        provideToastr({
