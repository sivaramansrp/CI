...
/**
 * API para guardar la solicitud del tramite 220202.
 * @see https://api-v30.cloud-ultrasist.net/api/sat-t220202/swagger-ui/index.html#/Registro-Solicitud/guardar
 */
export const API_POST_SOLICITUD = 'sat-t220202/solicitud/guardar';

/**
 * API para iniciar el tramite 220202.
 * @see https://api-v30.cloud-ultrasist.net/api/sat-t220202/swagger-ui/index.html#/Registro-Solicitud/iniciar
 */
export const API_GET_INICIO = 'sat-t220202/solicitud/iniciar';
...
/**
 * API para obtener el estado de la solicitud del tramite 220202.
 * @see https://api-v30.cloud-ultrasist.net/api/sat-t220202/swagger-ui/index.html#/Registro-Solicitud/genera-cadena-original_1
 */
export const API_POST_CADENA_ORIGINAL = (IDSOLICITUD: string) : string => `sat-t220202/solicitud/${IDSOLICITUD}/genera-cadena-original`;

/**
 * API para firmar la solicitud del tramite 220202.
 * @see https://api-v30.cloud-ultrasist.net/api/sat-t220202/swagger-ui/index.html#/Registro-Solicitud/firmar
 */
export const API_POST_FIRMA = (IDSOLICITUD: string) : string => `sat-t220202/solicitud/${IDSOLICITUD}/firmar`;

/**
 * API para obtener el certificado de antigüedad máxima del tramite 220202.
 * @see https://api-v30.cloud-ultrasist.net/api/sat-t220202/swagger-ui/index.html#/Registro-Solicitud/certificado-antiguedad-maxima
 */
export const API_GET_CERTIFICADO_ANTIGUEDAD = `sat-t220202/certificado/antiguedad-maxima`;
 ...
 * @see https://api-v30.cloud-ultrasist.net/api/sat-t220202/swagger-ui/index.html#/Registro-Solicitud/habilitar-molino-acero
 */
export const API_GET_MOLINOS_ACERO_HABILITAR = (CVEFRACCION: string) : string => `sat-t220202/fraccion-arancelaria/${CVEFRACCION}/molinos-acero/habilitar`;

/**
 * API para obtener los molinos de acero activos.
 * @see https://api-v30.cloud-ultrasist.net/api/sat-t220202/swagger-ui/index.html#/Catalogos/consulta-molinos-acero
 */
export const API_GET_MOLINO_ACTIVOS = `sat-t220202/catalogo/molinos-acero`;
...
/**
 * API para obtener evaluar iniciar tramite 220202.
...
/**
 * API para prepar evaluacion tramite 220202.
 * @see https://api-v30.cloud-ultrasist.net/api/sat-t220202/swagger-ui/index.html#/Evaluar-Solicitud/getOpcionesEvaluacion
 */
...
/**
 * API para Consultar que tabs mostrar 220202.
 * @see https://api-v30.cloud-ultrasist.net/api/sat-t220202/swagger-ui/index.html#/Consulta-Solicitud/estado-consulta-solicitud
 */
...
/** 
 * API para consulta de envio digital 220202.
 * @see https://api-v30.cloud-ultrasist.net/api/sat-t220202/swagger-ui/index.html#/Consulta-Solicitud/get-detalle-estado
 */
