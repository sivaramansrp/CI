...
export class RegistroSolicitudService {
  ...
  /**
   * metodo para realizar un guardado parcial de la solicitud
   * @param tramite numero de tramite
   * @param solicitud objeto de tipo guardar solicitud
   * */
  guardarParcialSolicitud(
    ...
    const ENDPOINT =
      `${this.host}` + API_GET_SOLICITUDES_GUARDADO_PARCIAL(tramite.toString());
    return this.http
