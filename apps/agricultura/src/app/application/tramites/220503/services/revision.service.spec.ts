...
describe('RevisionService', () => {
  ...
  it('should get OficianaInspeccion', () => {
    const mockData: RespuestaCatalogos = { data: [], code: 200, message: '' };
  ...
  it('should get RegimenDestinaran', () => {
    const mockData: RespuestaCatalogos = { data: [], code: 200, message: '' };
  ...
  it('should get MovilizacionNacional', () => {
    const mockData: RespuestaCatalogos = { data: [], code: 200, message: '' };
  ...
  it('should get PuntoVerificacion', () => {
    const mockData: RespuestaCatalogos = { data: [], code: 200, message: '' };
  ...
  it('should get EmpresaTransportista', () => {
    const mockData: RespuestaCatalogos = { data: [], code: 200, message: '' };
  ...
  it('should get DatosDelaSolicitud', () => {
