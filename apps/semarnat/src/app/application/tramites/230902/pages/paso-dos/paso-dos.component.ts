...
export class PasoDosComponent implements OnInit, OnDestroy {
   ...
   * @param PermisoCitesService Servicio para gestionar las operaciones relacionadas con prestadores de servicio.
   */
  constructor(
  ...
  obtenerDocumentosSeleccionados(): void {
    this.permisoCitesService.obtenerDocumentosSeleccionados()
      .pipe(takeUntil(this.destruirNotificador$))
      .subscribe({
        next: (result) => {
