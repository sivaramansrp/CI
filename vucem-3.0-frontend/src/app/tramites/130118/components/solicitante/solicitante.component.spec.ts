...
it('should initialize form group with given config', () => {
  const config = [
    { campo: 'nombre', validators: ['required'], disabled: false, labelNombre: 'Nombre', class: 'form-control', tipo_input: 'text' },
    { campo: 'edad', validators: ['required', 'maxLength:3'], disabled: false, labelNombre: 'Edad', class: 'form-control', tipo_input: 'number' }
  ];
  component.crearFormulario();
