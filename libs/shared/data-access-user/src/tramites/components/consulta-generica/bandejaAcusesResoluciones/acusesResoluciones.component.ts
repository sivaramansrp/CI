...
export class AcusesResolucionesComponent implements OnChanges {
  ...
  verDetalleResolucion(id:number): void {
    this.router.navigate(['/lib-detalle-resolucion', id]); // Cambia la ruta según tu configuración de rutas
  }
  verDetalleAcuse(id: number): void {
    this.router.navigate(['/lib-detalle-acuse', id]); // Cambia la ruta según tu configuración de rutas
  }
}
