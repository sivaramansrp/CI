...
import { CatalogoSelectClaveComponent } from './catalogo-select.component';
import { FormBuilder, ReactiveFormsModule } from '@angular/forms';
import { Catalogo } from '../../../core/models/shared/catalogos.model';

describe('CatalogoSelectClaveComponent', () => {
  let component: CatalogoSelectClaveComponent;
  let fixture: ComponentFixture<CatalogoSelectClaveComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [CatalogoSelectClaveComponent, ReactiveFormsModule],
      providers: [FormBuilder],
    }).compileComponents();

    fixture = TestBed.createComponent(CatalogoSelectClaveComponent);
