...
@Component({
  selector: 'crosslist-new',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule],
  templateUrl: './crosslist-new.component.html',
  styleUrl: './crosslist-new.component.scss',
})
export class CrosslistNewComponent implements OnInit, OnChanges{
 @Input() botonField: any;
   ...
   * 
   * @description Este método se llama cuando uno o más valores de entrada cambian.
   * @param changes - Un objeto que contiene los cambios de los valores de entrada.
   */
