import { AccionBoton, DatosPasos, SeccionLibQuery, SeccionLibState, VistaEmergente, WizardService } from "../../../";
import { Component, EventEmitter, Input, OnInit, Output, inject } from "@angular/core";
import { Notificacion, NotificacionesComponent } from "../notificaciones/notificaciones.component";
import { Subject, map, takeUntil } from "rxjs";

@Component({
    selector: 'btn-continuar-pro',
    standalone: true,
    imports: [NotificacionesComponent],
    templateUrl: './btn-continuar-pro.component.html',
    styleUrl: './btn-continuar-pro.component.scss',
    host: {},
})
export class BtnContinuarProComponent implements OnInit {
    /**
