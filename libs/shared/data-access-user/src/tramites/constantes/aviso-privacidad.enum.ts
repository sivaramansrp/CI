...
export const AVISO = {
  ...
  export const ADVERTENCIA = {
    Advertencia: `<p style="text-align: center; font-weight: bold;">Aviso de privacidad simplificado</p>
  ...
  /**
   * Constante que contiene un mensaje relacionado con la firma de solicitudes.
   * 
   * @constant
   * @property {string} Firmar - Mensaje que indica que la solicitud ha sido guardada exitosamente,
   * y que el usuario tiene 15 días naturales para firmarla antes de que desaparezca del listado
