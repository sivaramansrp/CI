...
/**
 * Modelo para representar los datos de terceros en el trámite 260301.
 * Incluye información personal, dirección, nacionalidad, tipo de persona y otros campos relacionados.
 * Extiende la funcionalidad básica con campos específicos para el trámite 260301.
 */
export interface Otros260301 {
  /** Descripción del tipo de tercero relacionado */
  tercero?: string,
  /** Nombre completo o denominación social */
  nombre?: string,
