...
export class TipoPedimentoService {
  constructor(private http: HttpClient) {}

  /**
   * Obtiene el listado de tipos de pedimento
   * @param catalogo - Nombre del catálogo a obtener.
   * @returns Observable con la lista de respuestas del catálogo.
   */
  getListaTipoPedimento(): Observable<CatalogoLista> {
    const ENDPOINT = 'assets/json/5701/cat-tipo-pedimento.json';
