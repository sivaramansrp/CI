...
*/
  ...
  tratadoCatalogoPais(tramite: string): Observable<BaseResponse<Catalogo[]>> {
    if (tramite === '110214' || tramite === '110216' || tramite === '110207' || tramite === '110205' || tramite === '110211') {
