import { API_GET_ACUSES_RESOLUCION, API_GET_DICTAMENES, API_GET_ENVIO_DIGITAL, API_GET_OPINION, API_GET_REQUERIMIENTOS, API_GET_SOLICITUD_DOCUMENTOS, API_GET_TABS, API_GET_TAREAS_DOCUMENTOS } from "../servers/api-router";
import { AcusesResolucionResponse } from "../models/shared/consulta-acuses-response.model";
import { BaseResponse } from "../models/shared/base-response.model";
import { DictamenesResponse } from "../models/shared/dictamenes-response.model";
import { DocumentoSolicitud } from "../models/shared/consulta-documentos-response.model";
import { ENVIRONMENT } from "../../enviroments/enviroment";
import { EnvioDigitalResponse } from "../models/shared/envio-digital-response.model";
import { Injectable } from "@angular/core";
import { Observable } from "rxjs";
import { OpinionResponse } from "../models/shared/opinion-response.model";
import { RequerimientosResponse } from "../models/shared/requerimientos-response.model";
import { TabsResponse } from "../models/shared/consulta-tabs-response.model";
import { TareasSolicitud } from "../models/shared/consulta-tareas-response.model";
...
export class TabsSolicitudService {
    /**
